...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2026 at 12:01 PM
...
(2, 35, 'Kigali City', 'Gasabo', 0, '[\"Kimironko\",\"Gikomero\",\"Jabana\",\"Remera\",\"Ndera\"]', '12005008765435426', 'Male', '2005-06-02', '2026-04-02 19:57:07', '2026-04-02 19:57:07');
...
INSERT INTO `services` (`id`, `service_code`, `name`, `category`, `description`, `short_tagline`, `icon_url`, `academic_year`, `eligibility_levels`, `default_pricing_type`, `validity_start`, `validity_end`, `redemption_method`, `delivery_method`, `stock_quantity`, `payment_rules`, `terms_conditions`, `status`, `created_at`, `updated_at`) VALUES
(1, 'SHOUSE2026', 'Shoes Voucher', 'Voucher', 'This is Shoes Of students from Nursary to Advanced Level', 'This is Shoes of Students', '/uploads/service-icons/svc-1-(2)-1775205661684-247826917.jpeg', '2026-2027', '[\"Primary\",\"O\'Level\",\"Nursery\",\"A\'Level\"]', 'by_level', '2026-04-02', '2026-04-10', 'School pickup', 'School pickup', NULL, '', '', 'active', '2026-04-03 10:41:01', '2026-04-03 11:34:12');
...
(1, 'SA-706896305', 'ishimwetheo488@gmail.com', NULL, '+250798699601', '$2b$10$HBOIRb/fyVghQrzqSpIeIeFrcXRLfM3WI/zVKJgvD2b2ni6S0wyG2', 'Ishimwe', 'Theoneste', NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-03 10:36:40', '::1', NULL, NULL, NULL, '2026-03-06 06:18:26', '2026-04-03 10:36:40', NULL, NULL),
...
(28, 'SM-947204499', 'ishimwetheonest937@gmail.com', 'ishimwetheonest937_sm3', NULL, '$2b$10$Y1XneVm/DqTlCKKQSOPAKeQysb57phsflZMVQZcDmFifTOH8aFuVi', 'UWAMAHORO', 'Claudine', NULL, NULL, 2, 3, 'Gasabo', 'Kigali City', 'Remera', 1, 1, 0, NULL, 0, 0, '2026-04-06 10:34:57', '::1', NULL, NULL, NULL, '2026-03-22 19:35:47', '2026-04-06 10:34:57', NULL, NULL),
...
(35, 'AG-59827311042', 'agentgasabo@gmail.com', NULL, '0785645342', '$2b$10$1LRQLt4iOza.CGNHs43wsuXWGDPUb02zffgSVuJnD2w8f6MMeeEzy', 'Cyizere', 'Pierre', NULL, NULL, 15, NULL, 'Gasabo', 'Kigali City', NULL, 1, 1, 0, NULL, 0, 0, '2026-04-02 21:57:33', '::1', NULL, NULL, NULL, '2026-04-02 21:57:07', '2026-04-02 21:57:33', NULL, NULL),
...
--
ALTER TABLE `service_orders`
  ADD CONSTRAINT `fk_so_service` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`);

--
-- Constraints for table `service_payments`
--
ALTER TABLE `service_payments`
  ADD CONSTRAINT `fk_pay_order` FOREIGN KEY (`order_id`) REFERENCES `service_orders` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `vouchers`
  ADD CONSTRAINT `fk_v_order` FOREIGN KEY (`order_id`) REFERENCES `service_orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_v_service` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`);

...
export default function HodLayout() {
  ...
  return (
    ...
    >
      ...
      <aside
        className="hod-scroll hidden lg:fixed lg:left-0 lg:top-0 lg:z-30 lg:flex lg:h-full lg:w-60 lg:flex-col xl:w-64"
        style={{
      ...
      <aside
        className={[
          "hod-scroll fixed left-0 top-0 z-50 flex h-full w-[min(100vw-2rem,18rem)] flex-col shadow-2xl transition-transform duration-300 ease-out lg:hidden",
      ...
      >
        <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center gap-3 border-b border-slate-200/80 bg-white/95 px-3 backdrop-blur-md shadow-sm lg:hidden">
          ...
          <div
            ...
            style={{ background: `linear-gradient(135deg, ${C.dark}, ${C.darkMid})` }}
          >
            <Shield className="h-4 w-4 text-[#FEBF10]" />
          </div>
        </header>

        <main className="hod-scroll flex-1 px-3 py-4 sm:px-5 sm:py-6 lg:px-8 lg:py-8">

...
export default function LiteTichaDealsPage() {
    ...
    <div className="min-h-screen bg-[#f0f2f9] pb-28 font-sans">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#000435] to-[#0a116b] px-5 pt-10 pb-16 rounded-b-[36px] shadow-[0_12px_40px_rgba(0,4,53,0.18)]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <button
            type="button"
            onClick={() => navigate('/lite/shule-avance')}
      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 -mt-8 relative z-20">
        ...
        {featuredProduct && (
          <div
            onClick={() => navigate(`/lite/shule-avance/deals/${featuredProduct.id}`)}
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex-1 p-5 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between gap-3 mt-4 pt-4 border-t border-slate-100">
                  ...
                  <button className="flex items-center gap-2 px-5 py-3 bg-[#000435] text-white text-[11px] font-black uppercase tracking-widest rounded-xl shadow-lg shadow-[#000435]/20 group-hover:bg-[#0a116b] transition-colors whitespace-nowrap active:scale-[0.97]">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {popularDeals.map((p) => (
                <div
                  key={p.id}
                  onClick={() => navigate(`/lite/shule-avance/deals/${p.id}`)}

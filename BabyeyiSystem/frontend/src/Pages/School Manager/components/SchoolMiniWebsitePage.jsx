...
import {
  ...
  Phone, Mail, Facebook, Twitter, Instagram, Check, Download,
          ...
          <div className="space-y-4">
            ...
            {(school.facebook || school.twitter || school.instagram) && (
              <div className="flex gap-3 pt-2">
                {school.facebook  && <a href={school.facebook}  target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-2xl flex items-center justify-center hover:scale-110 transition-transform" style={{ background: "#1877F2" }}><Facebook size={18} className="text-white" /></a>}
                {school.twitter   && <a href={school.twitter}   target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-2xl flex items-center justify-center hover:scale-110 transition-transform" style={{ background: "#1DA1F2" }}><Twitter size={18} className="text-white" /></a>}
                {school.instagram && <a href={school.instagram} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-2xl flex items-center justify-center hover:scale-110 transition-transform" style={{ background: "#E4405F" }}><Instagram size={18} className="text-white" /></a>}
              </div>
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 mb-6">
          ...
          <div className="flex flex-col items-center sm:items-end gap-2">
            {(school.facebook || school.twitter || school.instagram) && (
              <div className="flex gap-2">
                {school.facebook  && <a href={school.facebook}  target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20"><Facebook size={15} className="text-white" /></a>}
                {school.twitter   && <a href={school.twitter}   target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20"><Twitter size={15} className="text-white" /></a>}
                {school.instagram && <a href={school.instagram} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center hover:bg-white/20"><Instagram size={15} className="text-white" /></a>}
              </div>
            )}

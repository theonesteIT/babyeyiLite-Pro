...
import {
  ...
  Facebook, Twitter, Instagram, Award, Layers, Camera, X, Info,
    ...
    <div className="space-y-5">
      ...
      <div className="pt-2 border-t border-gray-100">
        ...
        <div className="space-y-3">
          {[
            { icon: <Facebook size={14} className="text-blue-500 flex-shrink-0" />, key: "facebook", placeholder: "https://facebook.com/yourschool" },
            { icon: <Twitter  size={14} className="text-sky-500  flex-shrink-0" />, key: "twitter",  placeholder: "https://twitter.com/yourschool" },
            { icon: <Instagram size={14} className="text-pink-500 flex-shrink-0" />, key: "instagram", placeholder: "https://instagram.com/yourschool" },

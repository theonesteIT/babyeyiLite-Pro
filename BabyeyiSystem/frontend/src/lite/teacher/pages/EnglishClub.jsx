        ...
        <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-8 md:pt-12 pb-10 md:pb-16">
          <div className="space-y-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-[9px] font-bold text-white/65 uppercase tracking-widest">Professional Excellence</p>
            </div>
            <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tighter leading-none mb-1 mt-1">English <span className="text-re-orange">Club</span></h1>
            <p className="text-[10px] md:text-sm font-medium text-white/55 max-w-lg leading-relaxed italic">Sharpening Pedagogy through Linguistic Mastery</p>
          </div>
        </div>
      </div>

      {/* ── Main Content Grid ── */}
      <div className="max-w-[1600px] mx-auto px-0 md:px-12 mt-0 md:-mt-12 relative z-20 pb-20">

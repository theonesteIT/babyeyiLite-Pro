...
const Dashboard = () => {
  ...
  const quickTools = [
    { title: 'Ticha AI', desc: 'Get help with lesson planning', icon: <MessageSquare size={20} />, color: 'text-re-purple', path: h('/ticha-ai') },
    { title: 'Ticha Avance', desc: 'Apply for teacher credit', icon: <Wallet size={20} />, color: 'text-re-orange', path: h('/shule-avance') },
    { title: 'Ticha Deals', desc: 'Get discounts on goods & services', icon: <Gift size={20} />, color: 'text-amber-600', path: h('/ticha-deals') },
    { title: 'English Club', desc: 'Professional development', icon: <BookOpen size={20} />, color: 'text-re-blue', path: h('/english-club') },
  ];
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="md:hidden mt-8 px-1">
              <div className="bg-white border border-black/5 divide-x divide-gray-300 rounded-xl p-3 flex items-center justify-between shadow-xl">
                <Link to={h('/students')} className="flex-1 flex flex-col items-center justify-center gap-1.5">
                  <Users size={25} className="text-re-orange/70" />
                  <span className='text-xs'> Student list</span>
                </Link>
                <Link to={h('/attendance')} className="flex-1 flex flex-col items-center justify-center gap-1.5">
                  <CheckSquare size={25} className="text-re-orange/70" />
                  <span className='text-xs'> Attendance</span>
                </Link>
                <Link to={h('/payroll')} className="flex-1 flex flex-col items-center justify-center gap-1.5">
          ...
          <div className="space-y-5 lg:sticky lg:top-20 h-fit">
            ...
            <div className="bg-white rounded-xl md:rounded-[24px] shadow-lg md:shadow-2xl border border-black/5 p-0 md:p-5">
              ...
              <div className="p-4 md:p-0 md:mt-4 text-center border-t md:border-t-0 border-black/5">
                <Link to={h('/timetable')} className="text-re-orange  text-[13px] font-bold text-[10px] hover:underline opacity-80 block w-full">
                  View Full Timetable
                </Link>
              </div>
            </div>

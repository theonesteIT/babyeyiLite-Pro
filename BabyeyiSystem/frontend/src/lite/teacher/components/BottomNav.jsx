...
const BottomNav = () => {
    const navItems = [
        ...
        { icon: Users, name: 'Students', path: h('/students') },
        { icon: Calendar, name: 'Timetable', path: h('/timetable') },
        { icon: ClipboardCheck, name: 'Attendance', path: h('/attendance') },
        { icon: DollarSign, name: 'Payroll', path: h('/payroll') },
    ];

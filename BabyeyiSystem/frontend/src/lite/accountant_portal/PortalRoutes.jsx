...
function ProtectedRoute({ children, title }) {
  ...
  if (!staff) return <Navigate to={LITE_LOGIN} replace />
...
function AccountantRoutesInner() {
  return (
    <Routes>
      ...
      <Route path="school-calendar" element={<ProtectedRoute title="School Calendar"><SchoolCalendarPage api={accountantApi} HeroComponent={AccountantOchreHero} heroProps={{ title: 'School calendar' }} /></ProtectedRoute>} />

                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                            ...
                            {READ_ONLY && (
                                <span className="inline-flex items-center gap-1 rounded-full bg-white/15 px-2 py-0.5 text-[9px] font-medium uppercase tracking-widest text-white">
                                    <Lock size={10} /> Read-only
                                </span>
                            )}
                        </div>
                        <h1 className="text-2xl md:text-5xl font-medium text-white tracking-tight">
            ...
            <div className="acct-shell-timetable">
                <div className="bg-white rounded-t-[2.5rem] shadow-sm border border-black/5 overflow-hidden flex flex-col">
                    <div className="px-4 md:px-8 pt-6 pb-2 border-b border-black/5 bg-amber-50/50">
                        <p className="text-[9px] font-medium uppercase tracking-widest text-amber-900/80 mb-2">
                            {READ_ONLY ? 'How this connects to school data' : 'Why this matches the teacher portal'}
                        </p>
                        <p className="text-[11px] md:text-xs font-medium text-amber-950/95 leading-relaxed max-w-4xl">
                            {PORTAL.copy?.attendanceExplainer}
                        </p>
                        <Link
                            to="/permissions"
                            className="inline-block mt-3 text-[10px] font-medium uppercase tracking-widest text-amber-900 underline underline-offset-2"
                        >
                    ...
                    >
                        {statItems.map((s, i) => (
                            ...
                            >
                                ...
                                <div className="text-sm sm:text-2xl font-medium text-re-text tracking-tighter group-hover:text-re-orange">
                                    {s.value}
                                </div>
                                <div className="text-[6px] sm:text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] mt-0.5 opacity-60">
                                    {s.label}
                                </div>
                            </div>
                        ))}
                    ...
                    {READ_ONLY && isClassSelected && selectedLesson && (
                        <div className="px-4 md:px-8 py-3 border-b border-black/5 bg-re-bg/30 flex flex-wrap items-center gap-3 text-[10px] font-medium text-re-text-muted">
                            <span className="font-medium uppercase tracking-widest text-re-text">Saved roll</span>
                            {rollMeta.logId ? (
                                <span className="rounded-full bg-emerald-50 text-emerald-800 px-2 py-0.5 font-medium uppercase tracking-tighter">
                                    On file ({rollMeta.recordCount} learners)
                                </span>
                            ) : (
                                <span className="rounded-full bg-white text-[#000435] px-2 py-0.5 font-medium uppercase tracking-tighter">
                        ...
                        <div className="flex items-center gap-3 w-full lg:w-auto">
                            <div className="relative hidden lg:block flex-1 lg:w-64 group">
                                ...
                                <select
                                    ...
                                    className="w-full pl-9 pr-8 h-10 bg-white border border-black/5 rounded-xl text-[10px] sm:text-xs font-medium uppercase tracking-widest text-re-text appearance-none focus:outline-none focus:border-re-orange/20 shadow-sm"
                                >
                        ...
                        >
                            <div className="relative w-full lg:w-48">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 h-10 bg-white border border-black/5 rounded-xl text-[10px] sm:text-xs font-medium uppercase tracking-widest text-re-text focus:outline-none focus:border-re-orange/20"
                                />
                            </div>
                    ...
                    {!isClassSelected && (
                        <div className="lg:hidden p-6 bg-re-bg/20 flex flex-col items-center justify-center text-center py-12 animate-in fade-in zoom-in-95 duration-500">
                            ...
                            <h2 className="text-xl font-medium text-re-text tracking-tighter uppercase mb-2">Select a period</h2>
                            <p className="text-[10px] text-re-text-muted font-medium uppercase tracking-widest leading-relaxed mb-8 max-w-[260px]">
                                    ...
                                    lessons.map((lesson) => (
                                        ...
                                        >
                                            <div className="flex flex-col items-start gap-1">
                                                <span className="text-[10px] font-medium text-re-text group-hover:text-re-orange uppercase">
                                                    {lesson.subject}
                                                </span>
                                                <div className="flex items-center gap-2">
                                                    <span className="text-[8px] font-medium text-re-text px-1.5 py-0.5 bg-re-bg rounded uppercase opacity-60 tracking-tighter">
                                                        {lesson.group}
                                                    </span>
                    ...
                    {isClassSelected && !READ_ONLY && (
                        <div className="lg:hidden px-4 py-2 border-b border-black/5 bg-white">
                            <button
                                ...
                                className="w-full flex justify-between items-center gap-2 text-[10px] font-medium uppercase tracking-widest transition-all"
                            >
                                <div className="flex items-center gap-2">
                    ...
                    {!READ_ONLY && (
                        ...
                        >
                            <div className="flex items-center gap-2 text-[10px] font-medium uppercase tracking-widest text-re-text-muted shrink-0">
                                <Filter size={12} /> Bulk Actions
                            </div>
                            <div className="flex items-center gap-2 shrink-0">
                                <button
                                    onClick={() => handleMarkAll('present')}
                                    className="px-3 py-1.5 rounded-lg text-[9px] font-medium uppercase tracking-widest bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors"
                                >
                                    Mark All Present
                                </button>
                                <button
                                    onClick={() => handleMarkAll('absent')}
                                    className="px-3 py-1.5 rounded-lg text-[9px] font-medium uppercase tracking-widest bg-red-50 text-red-600 hover:bg-red-100 transition-colors"
                                >
                                    Mark All Absent
                                </button>
                                <button
                                    onClick={() => handleMarkAll('present')}
                                    className="px-3 py-1.5 rounded-lg text-[9px] font-medium uppercase tracking-widest bg-gray-50 text-[#000435] hover:bg-gray-100 transition-colors"
                                >
                                    Reset to present
                                </button>
                            </div>
                    ...
                    <div className={`${!isClassSelected ? 'hidden lg:block' : 'block'} bg-white overflow-x-auto custom-scrollbar`}>
                        {isClassSelected && (
                            <div className="lg:hidden px-6 py-3 bg-white border-b border-black/5 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[9px] font-medium text-re-text uppercase tracking-widest">
                                        {selectedLesson
                        ...
                        <table className="w-full text-left border-collapse min-w-full sm:min-w-[800px]">
                            <thead>
                                <tr>
                                    <th className="border-b border-r border-black/5 bg-re-bg/50 px-2 py-3 text-center text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-8 sm:w-12">
                                        #
                                    </th>
                                    <th className="border-b border-r border-black/5 bg-re-bg/50 px-4 py-3 text-left text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-24 hidden sm:table-cell">
                                        Roll No
                                    </th>
                                    <th className="border-b border-r border-black/5 bg-re-bg/50 px-4 py-3 text-left text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted">
                                        Student Details
                                    </th>
                                    <th className="border-b border-black/5 bg-re-bg/50 px-4 py-3 text-center text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-[180px] sm:w-[280px]">
                                    ...
                                    <>
                                        {filteredRoster.map((student, idx) => (
                                            <tr key={student.id} className="hover:bg-re-bg/30 transition-colors">
                                                <td className="border-r border-b border-black/5 px-2 py-3 text-center text-[10px] font-medium text-[#000435]">
                                                    {idx + 1}
                                                </td>
                                                <td className="border-r border-b border-black/5 px-2 py-3 text-[10px] font-medium text-[#000435] uppercase tracking-widest hidden sm:table-cell">
                                                    {student.adm}
                                                </td>
                                                <td className="border-r border-b border-black/5 px-2 py-3 flex items-center gap-2 sm:gap-3 min-w-0 overflow-hidden">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <h4 className="text-[11px] sm:text-xs font-medium tracking-tight text-re-text truncate block">
                                                            {student.name}
                                                        </h4>
                                                        <div className="flex items-center gap-2 flex-wrap">
                                                            <span className="text-[8px] sm:text-[9px] font-medium text-re-text-muted uppercase tracking-widest">
                                                                {student.gender}
                                                            </span>
                                                            {student.active_permission && (
                                                                <span className="text-[7px] px-1.5 py-0.5 bg-blue-50 text-blue-600 rounded-md font-medium uppercase tracking-tighter border border-blue-100 flex items-center gap-1">
                                                                    <FileText size={8} /> Leave approved
                                                                </span>
                                                            )}
                                                            <span
                                                                className={`text-[7px] px-1.5 py-0.5 rounded-md font-medium uppercase tracking-tighter ${
                                        ...
                                        {filteredRoster.length === 0 && (
                                            <tr>
                                                <td colSpan="4" className="p-8 text-center text-sm font-medium text-re-text-muted">
                ...
                {isClassSelected && !READ_ONLY && (
                    <div className="lg:hidden p-4 bg-re-bg/20 border-t border-black/5 flex flex-col gap-3">
                        ...
                        <div className="text-[7px] font-medium text-re-text-muted text-center uppercase tracking-widest opacity-40">
...
function OversightStatusPill({ status }) {
    ...
    return (
        <div className="flex justify-center">
            <span
                className={`inline-flex items-center rounded-full px-2.5 py-1 text-[9px] font-medium uppercase tracking-wider ring-1 ${m.className}`}
            >
                {m.label}
            </span>
        </div>
    ...
    return (
        <button
            ...
            className={`
                ...
                h-7 w-7 sm:w-auto sm:h-8 px-1.5 sm:px-2 rounded-full xl:rounded-lg border text-[8px] font-medium uppercase tracking-widest

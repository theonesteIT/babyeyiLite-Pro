...
const LearnersConduct = () => {
    ...
    const sortBadge = (key) => {
        ...
        return (
            <span className="ml-1 inline-flex items-center text-[9px] font-medium text-[#000435]/70">
                {sortBy.dir === 'asc' ? '↑' : '↓'}
            </span>
        );
    };
    ...
    return (
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24 flex items-center gap-8">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[10px] font-medium uppercase tracking-[0.3em]" style={{ color: "#FEBF10" }}>Behavioral Insight</p>
                        </div>
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-medium text-white tracking-tighter leading-none mb-2 mt-2 uppercase">Learner <span style={{ color: "#FEBF10" }}>Conduct</span></h1>
                        <p className="text-[8px] sm:text-[10px] md:text-xs font-medium text-white/40 max-w-lg leading-relaxed uppercase tracking-widest italic opacity-60">Active Incident Logs & Institutional Conduct Metrics</p>
                    </div>
                </div>
            </div>
                ...
                <div className="acct-panel-sheet overflow-hidden flex flex-col min-h-[500px]">
                    ...
                    <div className="lg:hidden flex flex-col bg-white border-b border-black/5 divide-y divide-black/5">
                        <div className="flex items-center justify-between px-6 py-3">
                            <span className="text-[10px] font-medium text-[#000435] uppercase tracking-widest">{selectedClass}</span>
                            <button
                                onClick={() => setShowMobileClassModal(true)}
                                className="text-[9px] font-medium text-red-500 uppercase tracking-widest hover:underline"
                            >
                                Change Class
                            </button>
                        </div>
                        <div className="flex items-center justify-between px-6 py-3">
                            <span className="text-[10px] font-medium text-[#000435] uppercase tracking-widest">{selectedTerm}</span>
                            <button
                        ...
                        <div className="px-6 py-3 bg-re-bg/20">
                            <div className="relative w-full group">
                                ...
                                <input
                                    ...
                                    className="w-full h-10 bg-white rounded-lg outline-none border border-black/5 focus:border-[#000435]/20 text-[#000435] text-[10px] font-medium uppercase tracking-tight pl-10 pr-4 shadow-[inset_0_2px_8px_rgba(15,23,42,0.04)]"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hidden lg:flex px-4 py-4 lg:px-3 lg:py-2 border-b border-black/5 flex-nowrap items-center justify-start gap-2 bg-re-bg/20 transition-all">
                        <div className="flex flex-nowrap items-center gap-2">
                            ...
                            <div className="relative w-[10.5rem] shrink-0 group">
                                ...
                                <span className="absolute left-7 top-1/2 -translate-y-1/2 text-[8px] font-medium uppercase text-re-text-muted tracking-[0.2em] pointer-events-none z-[1]">Class</span>
                                <select 
                                    className="w-full h-8 bg-white/80 rounded-lg outline-none border border-black/5 focus:border-[#000435]/20 focus:bg-white transition-all text-[#000435] text-[9px] font-medium uppercase tracking-widest shadow-[inset_0_2px_8px_rgba(15,23,42,0.06),inset_0_-1px_0_rgba(255,255,255,0.5)] cursor-pointer appearance-none !pl-[4.5rem] pr-8"
                                    value={selectedClass}
                            ...
                            <div className="relative w-[7.5rem] shrink-0">
                                <select
                                    ...
                                    className="w-full h-8 bg-white/80 rounded-lg outline-none border border-black/5 focus:border-[#000435]/20 focus:bg-white transition-all text-[#000435] text-[9px] font-medium uppercase tracking-widest shadow-[inset_0_2px_8px_rgba(15,23,42,0.06),inset_0_-1px_0_rgba(255,255,255,0.5)] cursor-pointer appearance-none pl-3 pr-8"
                                    style={{ backgroundImage: `url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%236b7280%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'right 0.5rem center', backgroundSize: '10px' }}
                                >
                                    {YEARS.map(year => (
                    ...
                    {error && (
                        <div className="mx-6 md:mx-8 mt-4 flex items-center gap-3 px-4 py-3 bg-red-50 border border-red-100 rounded-xl">
                            ...
                            <p className="text-[10px] font-medium text-red-700 uppercase tracking-widest">{error}</p>
                            <button onClick={fetchData} className="ml-auto text-[9px] font-medium text-red-500 hover:underline uppercase tracking-widest">Retry</button>
                        </div>
                    )}
                            ...
                            <thead>
                                <tr className="bg-re-bg/20 border-b border-black/5">
                                    <th
                                        ...
                                        className="px-4 sm:px-8 py-3 sm:py-4 text-[7px] sm:text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] opacity-40 border-r border-black/5 cursor-pointer select-none hover:opacity-70"
                                    ...
                                    <th
                                        ...
                                        className="hidden md:table-cell px-8 py-4 text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] opacity-40 border-r border-black/5 cursor-pointer select-none hover:opacity-70"
                                        title="Sort by class"
                                    >
                                    ...
                                    <th
                                        ...
                                        className="px-3 sm:px-8 py-3 sm:py-4 text-[7px] sm:text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] opacity-40 border-r border-black/5 text-center cursor-pointer select-none hover:opacity-70 md:hidden"
                                        title="Sort by remaining score"
                                    >
                                        Score {sortBadge('score')}
                                    </th>
                                    <th className="px-4 sm:px-8 py-3 sm:py-4 text-[7px] sm:text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] opacity-40 text-right">Action</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        <td colSpan="5" className="p-12 text-center">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <p className="text-[10px] font-medium text-re-text-muted uppercase tracking-widest">Loading Learners...</p>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colSpan="5" className="p-12 text-center">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <p className="text-[10px] font-medium text-re-text-muted uppercase tracking-widest">
                                            ...
                                            <tr key={s.id} onClick={() => setDetailsStudent(s)} className="hover:bg-re-bg/60 even:bg-re-bg/20 transition-colors group cursor-pointer">
                                                ...
                                                <td className="px-4 sm:px-8 py-3 sm:py-5 border-r border-black/5">
                                                    <div className="flex items-center gap-3 sm:gap-4">
                                                        ...
                                                        <div>
                                                            <p className="text-xs sm:text-sm font-medium text-re-text tracking-tight uppercase leading-none mb-1 group-hover:text-[#000435] transition-colors">
                                                                {studentName}
                                                            ...
                                                            <p className="text-[7px] sm:text-[9px] font-medium text-re-text-muted opacity-80 uppercase tracking-widest leading-none truncate max-w-[220px]">
                                                                {uid}
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <td className="hidden md:table-cell px-8 py-5 border-r border-black/5">
                                                    <p className="text-[10px] font-medium text-[#000435] px-3 py-1 bg-[#000435]/5 rounded-lg w-fit transition-colors group-hover:bg-[#000435]/10">{s.class_name || 'Unassigned'}</p>
                                                </td>

                                                {/* Standing */}
                                                <td className="hidden md:table-cell px-8 py-5 border-r border-black/5">
                                                    <div className="flex flex-col gap-1">
                                                        <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg ring-1 ring-inset tracking-widest text-[8px] font-medium uppercase w-fit ${
                                                        ...
                                                        {s.discipline_deducted > 0 && (
                                                            <p className="text-[7px] font-medium text-re-text-muted opacity-50 uppercase tracking-widest mt-0.5">
                                                ...
                                                <td className="px-3 sm:px-8 py-3 sm:py-5 border-r border-black/5 text-center md:hidden">
                                                    <div className="flex flex-col items-center justify-center">
                                                        <span className="text-sm sm:text-base font-medium text-[#000435] tracking-tighter leading-none">{Number(s.discipline_remaining).toFixed(0)}</span>
                                                        <span className="text-[6px] sm:text-[7px] font-medium text-re-text-muted uppercase tracking-widest opacity-40 leading-none mt-0.5">/ {s.discipline_total}</span>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-4 sm:px-8 py-3 sm:py-5 text-right">
                                                    <button
                                                        ...
                                                        className="h-8 px-3 sm:px-4 rounded-xl flex items-center justify-center gap-1 sm:gap-2 bg-white border border-black/5 text-re-text font-medium text-[9px] uppercase tracking-widest shadow-sm hover:bg-re-bg hover:text-[#000435] transition-all ml-auto"
                                                    >
                                                        <Activity size={12} className="hidden sm:block" />
                                                        <span className="sm:hidden font-medium text-[12px] leading-none tracking-tighter mb-0.5">+ / -</span>
                    ...
                    <div className="flex px-4 sm:px-8 py-5 bg-re-bg/20 border-t border-black/5 flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-3 sm:gap-4">
                            <div className="hidden xs:flex items-center gap-2">
                                ...
                                <p className="text-[6px] sm:text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] opacity-40 italic whitespace-nowrap">
            ...
            <div className="fixed lg:hidden inset-0 z-[200] bg-black/50 flex flex-col justify-end backdrop-blur-sm animate-in fade-in duration-200">
                <div className="bg-white w-full rounded-t-3xl max-h-[80vh] flex flex-col animate-in slide-in-from-bottom-8 duration-300">
                    <div className="p-4 border-b border-black/5 flex items-center justify-between">
                        <span className="text-[10px] font-medium uppercase tracking-widest text-[#000435]">Select Class</span>
                        <button onClick={() => setShowMobileClassModal(false)} className="w-8 h-8 flex items-center justify-center bg-re-bg border border-black/5 rounded-full text-[#000435] font-medium text-xs hover:bg-white shadow-sm transition-all">X</button>
                    </div>
                    <div className="overflow-y-auto p-4 flex flex-col gap-2">
                        {uniqueClasses.map(cls => (
                            <button
                                ...
                                className={`p-4 rounded-xl text-[10px] font-medium tracking-widest text-left border ${selectedClass === cls ? 'bg-[#000435] text-white border-[#000435]' : 'bg-white border-black/5 text-[#000435] hover:bg-re-bg'}`}
                            >
                                {cls}
                            </button>
                        ))}
        ...
        {showMobileTermModal && (
            <div className="fixed lg:hidden inset-0 z-[200] bg-black/50 flex flex-col justify-end backdrop-blur-sm animate-in fade-in duration-200">
                <div className="bg-white w-full rounded-t-3xl max-h-[80vh] flex flex-col animate-in slide-in-from-bottom-8 duration-300">
                    <div className="p-4 border-b border-black/5 flex items-center justify-between">
                        <span className="text-[10px] font-medium uppercase tracking-widest text-[#000435]">Select Term</span>
                        <button onClick={() => setShowMobileTermModal(false)} className="w-8 h-8 flex items-center justify-center bg-re-bg border border-black/5 rounded-full text-[#000435] font-medium text-xs hover:bg-white shadow-sm transition-all">X</button>
                    </div>
                    <div className="overflow-y-auto p-4 flex flex-col gap-2">
                        {TERMS.map(term => (
                            <button
                                ...
                                className={`p-4 rounded-xl text-[10px] font-medium tracking-widest text-left border ${selectedTerm === term ? 'bg-[#000435] text-white border-[#000435]' : 'bg-white border-black/5 text-[#000435] hover:bg-re-bg'}`}
                            >
                                {term}
                            </button>
                        ))}

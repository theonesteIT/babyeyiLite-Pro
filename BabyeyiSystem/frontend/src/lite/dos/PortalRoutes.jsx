...
/** Lite DOS: full Pro UI — no subscription gate on individual modules. */
...
function DosRoutesInner() {
  return (
    <Routes>
      ...
      <Route path="school-calendar" element={<ProtectedRoute title="School calendar"><SchoolCalendarPage api={dosApi} HeroComponent={DosOchreHero} heroProps={{ title: 'School calendar' }} /></ProtectedRoute>} />

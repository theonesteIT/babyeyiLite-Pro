    ...
    <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-4 sm:p-5">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-emerald-200 bg-emerald-50 text-[11px] font-bold text-emerald-800 hover:bg-emerald-100 transition-all min-h-[44px] touch-manipulation"
        >

        ...
        <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-8 md:pt-12 pb-10 md:pb-16">
          <div className="space-y-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-[9px] font-semibold text-white/50 uppercase tracking-[0.3em]">Professional Excellence</p>
            </div>
            <h1 className="text-2xl md:text-3xl font-semibold text-white tracking-tight leading-none mb-1 mt-1 uppercase" style={{ fontFamily: "'Montserrat', sans-serif" }}>English Club</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {loading ? (
                ...
                filteredResources.map((res) => (
                  <div key={res.id} className="bg-white rounded-[24px] border border-black/5 flex flex-col group overflow-hidden hover:shadow-re-deep transition-all relative">
                    ...
                    <div className="h-36 relative bg-re-bg overflow-hidden">
                      {res.thumbnail_url ? (
                        <img src={res.thumbnail_url} alt={res.title} className="w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700" />
                      ) : (
                      ...
                      {/* Micro Label Type */}
                      <div className="absolute top-3 right-3 px-2 py-1 rounded-lg bg-white/90 backdrop-blur-md shadow-sm text-[7px] font-semibold uppercase tracking-widest text-re-text-muted">
                        {res.content_type}
                      </div>
                    ...
                    <div className="p-5 flex flex-col flex-1 bg-white">
                      <div className="flex-1 space-y-1.5 mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-[8px] font-semibold text-re-purple uppercase tracking-widest opacity-60">Verified Content</p>
                        </div>
                        <h4 className="text-sm font-semibold text-re-text tracking-tight uppercase leading-tight line-clamp-1">{res.title}</h4>
                ...
                <div className="col-span-full py-20 text-center space-y-5 bg-white rounded-[24px] border border-black/5 flex flex-col items-center">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-base font-semibold text-re-text uppercase tracking-tight">Zero trace of activity</h3>
          ...
          <div className="hidden lg:flex flex-col space-y-6 lg:sticky lg:top-8 h-fit">
            ...
            <div className="bg-white rounded-[24px] shadow-sm border border-black/5 p-5 pt-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-[9px] font-semibold text-re-text uppercase tracking-widest opacity-40">Mastery Stats</h3>
              </div>

              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-re-bg/50 border border-black/5">
                  <p className="text-[8px] font-semibold text-re-text-muted uppercase tracking-[0.2em] mb-1">Weekly Goals</p>
                  <div className="flex items-end justify-between">
                    <p className="text-xl font-semibold text-re-text tracking-tighter">12 / 20</p>
                ...
                <button className="w-full py-3 rounded-xl border border-dashed border-re-purple/20 text-[9px] font-semibold text-re-purple uppercase tracking-widest hover:bg-re-purple/5 transition-all">
            ...
            <div className="relative rounded-[24px] p-5 text-white shadow-re-premium-purple overflow-hidden group cursor-pointer bg-re-grad-orange">
              <div className="relative z-10 flex flex-col gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-[10px] tracking-widest uppercase opacity-90">Expert Webinar</h4>
            ...
            <p className="text-center text-[7px] text-re-text-muted font-semibold uppercase tracking-[0.2em] opacity-30 italic">Continuous Professional Development System</p>
          </div>

...
} from '../../lite/discipline/utils/parentNotifySummary';
...
export default function ConductMarksModal({ isOpen, onClose, initialStudent = null, academicYear = '', term = '', onSuccess = null }) {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(async () => {
            ...
            try {
                const res = await studentService.getStudents({ q: pickerSearch, limit: 50 });
        ...
        <div className="flex flex-col flex-1 min-h-0 bg-white">
            <div className="px-4 pt-4 pb-2 shrink-0 relative" ref={searchRef}>
                <div className="flex gap-2">
                    {/* Search input */}
                    <div className="flex-1 flex items-center bg-white border border-black/5 rounded-xl overflow-hidden shadow-inner focus-within:ring-2 focus-within:ring-re-gold/20 transition">
                        <div className="w-1 h-full bg-re-gold shrink-0" />
                    ...
                    <button
                        ...
                        className="w-10 h-10 shrink-0 flex items-center justify-center bg-re-bg border border-black/5 text-re-gold rounded-xl hover:bg-re-gold/10 transition"
                    >
                        <ListChecks size={16} />
                    </button>
                </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-3">
                {rows.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full py-10 text-center gap-3">
                        ...
                        <button
                            onClick={() => setShowBrowser(true)}
                            className="mt-2 flex items-center justify-center gap-2 px-6 py-2.5 bg-re-gold/10 text-[#1E3A5F] rounded-xl text-xs font-bold hover:bg-re-gold/20 transition-all border border-re-gold/20"
                        >
                    ...
                    <>
                        ...
                        <button
                            onClick={() => setShowBrowser(true)}
                            className="w-full mt-3 flex items-center justify-center gap-2 py-3 border-2 border-dashed border-black/10 rounded-xl text-gray-400 hover:text-re-gold hover:border-re-gold/30 hover:bg-re-gold/5 transition-all font-bold text-xs"
                        >
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
                ...
                <div>
                    ...
                    <div
                        ...
                        className={`w-full flex items-center gap-0 bg-white border border-black/5 rounded-xl overflow-hidden shadow-inner ${!initialStudent ? 'hover:border-re-gold/30 cursor-pointer' : 'opacity-90 cursor-default'} transition focus:ring-2 focus:ring-re-gold/50 focus:outline-none`}
                    >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-lg rounded-2xl shadow-sm overflow-hidden max-h-[80vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2">
                    {CATALOGUE.map(c => (
                        <button key={c.id} onClick={() => { addCriteria(c); setShowBrowser(false); }} className="w-full flex items-center justify-between px-4 py-3 border border-black/5 rounded-xl hover:bg-re-bg hover:border-re-gold/20 transition-all text-left">
                            <div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-md rounded-2xl shadow-sm overflow-hidden max-h-[80vh] flex flex-col">
                ...
                <div className="px-5 py-4 border-b border-black/5 flex items-center justify-between relative z-10 bg-re-grad-navy">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-re-gold">
                            <Users size={16} />
                        </div>
                        <div>
                    ...
                    <button onClick={() => setShowStudents(false)} className="p-1.5 bg-white/5 hover:bg-white/10 rounded-xl transition-all text-white/40 hover:text-re-gold group">
        ...
        <>
                ...
                <div className="flex items-center justify-between px-4 py-3 shrink-0 bg-re-grad-navy shadow-md">
                    <div className="flex items-center gap-2">
                        {mobileStep === 'summary' ? (
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center text-re-gold shadow-md">
                                    <Activity size={15} />
                                </div>
                                <div>
            ...
            <div className="hidden md:flex fixed inset-0 z-[90] items-center justify-center p-6">
                <div className="bg-re-bg rounded-3xl shadow-[0_32px_128px_-15px_rgba(30,58,95,0.4)] w-full max-w-4xl min-h-[500px] flex flex-col max-h-[90vh] overflow-hidden border border-white/20">
                    <div className="flex items-center justify-between px-6 py-5 shrink-0 bg-re-grad-navy relative z-10 shadow-md">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-white/10 rounded-xl border border-white/20 flex items-center justify-center text-re-gold shadow-md shadow-re-gold/10">
                                <Activity size={18} />
                            </div>
                            <div>

...
import StudentMorningAttendance from './pages/StudentMorningAttendance'
...
function ManagerRoutesInner() {
  return (
    <Routes>
      ...
      <Route path="attendance/morning/students" element={<ProtectedRoute title="Student Morning Attendance"><StudentMorningAttendance /></ProtectedRoute>} />
      <Route path="attendance/morning/staff" element={<ProtectedRoute title="Staff Daily Attendance"><StaffDailyAttendance /></ProtectedRoute>} />

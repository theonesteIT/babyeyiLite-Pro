...
import LiteOrangePageHero from '../../lite/shared/components/LiteOrangePageHero'
import LiteOchreHero from '../../lite/shared/components/LiteOchreHero'
...
export default function TichaDeals({ api, basePath, dealsHeroVariant = 'orange', staffUser }) {
  ...
  const isOchreHero = isAccountantHero || dealsHeroVariant === 'storekeeper'
  ...
  return (
    ...
    >
      ...
      <div
        className={
          isOchreHero
            ? 'relative z-20 -mt-10 pb-20 max-w-[1000px] mx-auto px-4 sm:px-6'

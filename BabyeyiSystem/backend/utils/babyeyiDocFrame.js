...
const BABYEYI_DOC_FRAME_PRINT_CSS = `
...
function buildBabyeyiDocFrameDecorHtml() {
  return `
...
function wrapBabyeyiDocHtml(innerHtml) {
...
module.exports = {
  BABYEYI_DOC_ROOT_STYLE,
  BABYEYI_DOC_FRAME_PRINT_CSS,
  buildBabyeyiDocFrameDecorHtml,
  wrapBabyeyiDocHtml,
};

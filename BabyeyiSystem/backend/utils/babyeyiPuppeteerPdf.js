 ...
 * Falls back gracefully when Chrome/Chromium is not available.
 */
const fs = require("fs");
...
async function renderHtmlToPdfFile(html, pdfDir, docId) {
  ...
  if (!executablePath) {
    throw new Error("Chrome/Chromium not found — set PUPPETEER_EXECUTABLE_PATH or install Google Chrome");
  }

...
/** Simple interest: total interest = P × (monthlyRate/100) × months */
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-[10px] font-bold leading-relaxed text-re-text-muted/90">
        Illustrative only. Simple interest model: principal × monthly rate × number of months. Final terms follow
        school approval.
      </p>
    </div>
  );

...
INSERT INTO `academic_assessments` (`id`, `school_id`, `class_name`, `subject_name`, `assessment_name`, `max_score`, `assessment_type`, `column_slug`, `created_by_user_id`, `created_at`) VALUES
(1, 11, 'Senior 3A', 'Mathematics', 'Term 1 Final Exam', 100.00, 'DOS_STANDARD', NULL, 56, '2026-04-08 12:42:17');
...
INSERT INTO `academic_marks` (`id`, `school_id`, `assessment_id`, `student_id`, `score_obtained`, `recorded_by_user_id`, `created_at`) VALUES
(1, 11, 1, 163, 89.00, 56, '2026-04-08 12:42:17'),
(2, 11, 1, 164, 73.00, 56, '2026-04-08 12:42:17'),
(3, 11, 1, 165, 86.00, 56, '2026-04-08 12:42:17'),
(4, 11, 1, 166, 82.00, 56, '2026-04-08 12:42:17'),
(5, 11, 1, 167, 93.00, 56, '2026-04-08 12:42:17'),
(6, 11, 1, 168, 76.00, 56, '2026-04-08 12:42:17'),
(7, 11, 1, 169, 88.00, 56, '2026-04-08 12:42:17'),
(8, 11, 1, 170, 80.00, 56, '2026-04-08 12:42:17'),
(9, 11, 1, 171, 76.00, 56, '2026-04-08 12:42:17'),
(10, 11, 1, 172, 67.00, 56, '2026-04-08 12:42:17');
...
--
-- Dumping data for table `academic_timetables`
--

INSERT INTO `academic_timetables` (`id`, `school_id`, `class_name`, `subject_name`, `staff_id`, `day_of_week`, `start_time`, `end_time`, `room`, `created_at`) VALUES
(10, 11, 'P1 A', 'Mathematics', 15, 'Monday', '08:00', '08:40', 'P1-Room', '2026-04-10 20:26:25'),
(11, 11, 'P1 A', 'Mathematics', 15, 'Monday', '08:40', '09:20', 'P1-Room', '2026-04-10 20:26:25'),
(12, 11, 'S1 A', 'Physics', 15, 'Monday', '11:10', '11:50', 'Lab 1', '2026-04-10 20:26:25'),
(13, 11, 'P1 A', 'English', 16, 'Monday', '09:20', '10:00', 'P1-Room', '2026-04-10 20:26:25'),
(14, 11, 'S1 A', 'Mathematics', 16, 'Monday', '11:50', '12:30', 'Room 5', '2026-04-10 20:26:25'),
(15, 11, 'S1 A', 'Mathematics', 16, 'Tuesday', '08:00', '08:40', 'Room 5', '2026-04-10 20:26:25'),
(16, 11, 'S4 A', 'Mathematics', 57, 'Monday', '08:00', '09:00', NULL, '2026-04-11 15:52:07'),
(17, 11, 'P6 A', 'English', 58, 'Monday', '09:00', '10:00', NULL, '2026-04-11 15:52:07');
...
('B86E5VrhvyCg7FLFZTLBRcEeUoAJMd85', 1776353102, '{\"cookie\":{\"originalMaxAge\":28800000,\"expires\":\"2026-04-16T15:20:45.280Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"userId\":55,\"roleCode\":\"SCHOOL_ADMIN\",\"loginTime\":1776324045269,\"school_id\":11,\"user\":{\"id\":55,\"user_uid\":\"SC-934616676\",\"email\":\"manager_999@seed.local\",\"first_name\":\"School\",\"last_name\":\"Manager\",\"full_name\":\"School Manager\",\"photo\":null,\"role\":{\"code\":\"SCHOOL_ADMIN\",\"name\":\"School Admin\"},\"district\":null,\"province\":null,\"sector\":null,\"school\":{\"id\":11,\"name\":\"test  Academy\",\"code\":\"999\",\"email\":\"info_999@seed.local\",\"phone\":\"0788999000\",\"district\":\"Kicukiro\",\"province\":\"Kigali City\"},\"school_id\":11,\"force_password_change\":false,\"agent\":null}}');
...
CREATE TABLE `attendance_events` (
  ...
  `days_active` varchar(100) DEFAULT 'Mon,Tue,Wed,Thu,Fri',
  `is_active` tinyint(1) DEFAULT 1,
  `created_at` datetime DEFAULT current_timestamp(),
...
INSERT INTO `attendance_events` (`id`, `school_id`, `event_name`, `start_time`, `end_time`, `late_threshold`, `target_group`, `residency_filter`, `days_active`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 11, 'Morning Arrival', '06:00:00', '08:30:00', '07:45:00', 'STUDENTS', 'ALL', 'Mon,Tue,Wed,Thu,Fri', 1, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(2, 11, 'Morning Assembly', '08:00:00', '08:30:00', '08:10:00', 'BOTH', 'ALL', 'Mon,Wed,Fri', 1, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(3, 11, 'Lunch Session', '12:30:00', '13:45:00', '12:45:00', 'BOTH', 'ALL', 'Mon,Tue,Wed,Thu,Fri', 1, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(4, 11, 'Student Evening Prep', '18:30:00', '20:30:00', '18:45:00', 'STUDENTS', 'BOARDING', 'Mon,Tue,Wed,Thu,Fri', 1, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(5, 11, 'Saturday Academy', '09:00:00', '12:00:00', '09:15:00', 'STUDENTS', 'ALL', 'Sat', 1, '2026-04-11 15:32:55', '2026-04-11 15:32:55');
...
(7, 'BY-2025-00004', 4, '2026-04-08 18:39:41');
...
(7, 4, 'Tuition Fee', 57.00, 0),
(8, 4, 'Activity Fee', 9.00, 1);
...
(4, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '/uploads/babyeyi/qrcodes/qr-BY-2025-00004-1775666383578.png', 'qr-BY-2025-00004-1775666383578.png', 'http://localhost:5174/babyeyi/verify/BY-2025-00004');
...
(30, 4, 'School ID card', NULL, NULL, NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `biometric_logs_raw`
--

CREATE TABLE `biometric_logs_raw` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  ...
  `is_manual_correction` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `class_subject_configuration`
--

CREATE TABLE `class_subject_configuration` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `class_name` varchar(120) NOT NULL,
  `subject_id` int(10) UNSIGNED NOT NULL,
  `subject_code` varchar(32) DEFAULT NULL,
  `periods_per_week` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
  `credits` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
  `priority_level` tinyint(3) UNSIGNED DEFAULT 0,
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `class_subject_configuration`
--

INSERT INTO `class_subject_configuration` (`id`, `school_id`, `class_name`, `subject_id`, `subject_code`, `periods_per_week`, `credits`, `priority_level`, `created_at`, `updated_at`) VALUES
(1, 11, 'P1 A', 1, 'MAT', 7, 5, 0, '2026-04-10 20:10:08', '2026-04-10 20:10:08'),
(2, 11, 'P1 A', 2, 'ENG', 5, 4, 0, '2026-04-10 20:10:08', '2026-04-10 20:10:08'),
(3, 11, 'S1 A', 5, 'PHY', 4, 3, 0, '2026-04-10 20:10:08', '2026-04-10 20:10:08'),
(4, 11, 'S1 A', 1, 'MAT', 6, 5, 0, '2026-04-10 20:10:08', '2026-04-10 20:10:08'),
(5, 11, 'S4 A', 1, 'MCB-MAT', 8, 7, 0, '2026-04-10 20:10:08', '2026-04-10 20:10:08');
...
INSERT INTO `daily_attendance_summary` (`id`, `school_id`, `person_id`, `person_type`, `attendance_date`, `first_in`, `last_out`, `status`, `remarks`, `created_at`, `updated_at`) VALUES
(1, 11, 163, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(2, 11, 164, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(3, 11, 165, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(4, 11, 166, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(5, 11, 167, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(6, 11, 168, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(7, 11, 169, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(8, 11, 170, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(9, 11, 171, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(10, 11, 172, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(11, 11, 173, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(12, 11, 174, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(13, 11, 175, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(14, 11, 176, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(15, 11, 177, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(16, 11, 178, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(17, 11, 179, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(18, 11, 180, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(19, 11, 181, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(20, 11, 182, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(21, 11, 183, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(22, 11, 184, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(23, 11, 185, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(24, 11, 186, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(25, 11, 187, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(26, 11, 188, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(27, 11, 189, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(28, 11, 190, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(29, 11, 191, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(30, 11, 192, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(31, 11, 193, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(32, 11, 194, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(33, 11, 195, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(34, 11, 196, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(35, 11, 197, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(36, 11, 198, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(37, 11, 199, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(38, 11, 200, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(39, 11, 201, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(40, 11, 202, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(41, 11, 203, 'STUDENT', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(42, 11, 14, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(43, 11, 15, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(44, 11, 16, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(45, 11, 17, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(46, 11, 18, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(47, 11, 19, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(48, 11, 21, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51'),
(49, 11, 22, 'STAFF', '2026-04-14', NULL, NULL, 'Absent', '', '2026-04-16 01:02:51', '2026-04-16 01:02:51');
...
(5, 11, 203, '2025-2026', 'Term 1', 'S4 A PCB', 'Late Arrival', 'Automated conduct update: Late Arrival', 2.00, 98.00, 55, '2026-04-10 17:13:17'),
(6, 11, 163, '2025-2026', 'Term 1', 'Senior 3A', 'Late Arrival', NULL, 2.00, 98.00, 59, '2026-04-13 01:58:07'),
(7, 11, 165, '2025-2026', 'Term 2', 'Senior 3A', 'No Uniform', NULL, 3.00, 97.00, 59, '2026-04-13 02:09:43'),
(8, 11, 198, '2025-2026', 'Term 2', NULL, 'No Uniform', NULL, 3.00, 97.00, 59, '2026-04-13 09:24:14');
...
--
-- Table structure for table `english_club_resources`
--

CREATE TABLE `english_club_resources` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL,
  `content_type` enum('video','pdf','article','quiz') NOT NULL DEFAULT 'article',
...
(25, NULL, 11, 'P1', 4, 'Term 1', '2025-2026', 2400.00, '2026-04-08 16:39:42', '2026-04-08 16:39:42', 30);
...
(15, 'Field Agent', 'AGENT', 'Regional field coverage for schools and fees', '[]', 1, 0, '2026-04-04 20:26:31', '2026-04-04 20:26:31');
...
INSERT INTO `schools` (`id`, `school_name`, `school_code`, `education_levels`, `school_category`, `school_status`, `ownership_type`, `year_established`, `province`, `district`, `sector`, `cell`, `village`, `full_address`, `map_url`, `phone`, `email`, `postal_address`, `website`, `head_teacher_name`, `head_teacher_phone`, `head_teacher_email`, `deputy_head_name`, `logo_url`, `head_signature_url`, `school_stamp_url`, `manager_user_id`, `admin_id`, `status`, `is_active`, `created_at`, `updated_at`, `deleted_at`, `district_code`, `a_level_combinations`, `is_skeleton`, `boarding_type`, `vision`) VALUES
(1, 'Test Academy', '001', '[\"nursery\",\"primary\",\"o_level\",\"a_level\",\"tvet\"]', '', NULL, 'Government', '1985', 'Kigali City', 'Gasabo', 'Kimironko', 'Kimironko', 'Kimironko', 'Kimironko, Gasabo, Kigali City', NULL, '0788876345', 'gskimironko@gmail.com', 'P.O.BOX 2013', NULL, 'Kamana Eric', '0788876345', 'head@gmail.com', NULL, '/uploads/school-logos/school-logo2-1774185677949-907804191.jpg', '/uploads/school-signatures/signature-1774185677951-407363694.png', '/uploads/school-stamps/stamp1-1774185677951-797177589.png', 26, NULL, 'active', 1, '2026-03-22 15:21:17', '2026-04-09 15:54:27', NULL, '04', '[\"PCM\",\"PCB\"]', 0, 'Mixed', NULL),
(2, 'GS REMERA', '002', '[\"primary\",\"o_level\"]', 'Day', NULL, 'Government', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '000000000', 'pending+002@school.babyeyi.local', '', NULL, 'Pending registration', '000000000', 'pending+002@school.babyeyi.local', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', 1, '2026-03-22 15:44:39', '2026-03-22 15:44:39', NULL, '04', NULL, 1, NULL, NULL),
(3, 'ECOLE NOTRE DAME DES ANGES', '003', '[\"nursery\",\"primary\"]', 'Day', NULL, 'Private', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '0796785674', 'notredame@gmail.com', NULL, NULL, 'UWAMAHORO Claudine', '07887656745', 'ishimwetheonest937@gmail.com', NULL, '/uploads/school-logos/ECOLE-NOTRE-DAME-DES-ANGES-1774200946224-984041302.png', '/uploads/school-signatures/signature-1774200946273-221115521.png', '/uploads/school-stamps/stamp2-1774200946274-618896051.jpg', 28, NULL, 'active', 1, '2026-03-22 15:45:22', '2026-03-22 19:36:46', NULL, '04', NULL, 0, NULL, NULL),
(4, 'KIGALI MUSTARD SEED SCHOOL', '004', '[\"nursery\",\"primary\"]', 'Day', NULL, 'Private', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '000000000', 'pending+004@school.babyeyi.local', '', NULL, 'Pending registration', '000000000', 'pending+004@school.babyeyi.local', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', 1, '2026-03-22 15:45:49', '2026-03-22 15:45:49', NULL, '04', NULL, 1, NULL, NULL),
(5, 'GOOD SHEPHERED NURSERY AND PRIMARY SCHOOL', '005', '[\"nursery\",\"primary\"]', 'Day', NULL, 'Private', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '000000000', 'pending+005@school.babyeyi.local', '', NULL, 'Pending registration', '000000000', 'pending+005@school.babyeyi.local', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', 1, '2026-03-22 15:46:06', '2026-03-22 15:46:06', NULL, '04', NULL, 1, NULL, NULL),
(6, 'SANA ACADEMY', '006', '[\"primary\",\"nursery\"]', 'Day', NULL, 'Private', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '0798123456', 'sanaacdemy@gmail.com', NULL, NULL, 'NIIYONKURU Marcell', '0789456354', 'head@gmail.com', NULL, '/uploads/school-logos/sana-academy-1774436389339-122491190.png', '/uploads/school-signatures/signature3-1774436389399-807144783.png', '/uploads/school-stamps/stamp3-1774436389400-635442668.png', 32, NULL, 'active', 1, '2026-03-22 15:46:18', '2026-03-25 13:00:57', NULL, '04', NULL, 0, NULL, NULL),
(7, 'MERE DU VERBE', '007', '[\"nursery\",\"primary\"]', 'Day', NULL, 'Private', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '000000000', 'pending+007@school.babyeyi.local', '', NULL, 'Pending registration', '000000000', 'pending+007@school.babyeyi.local', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', 1, '2026-03-22 15:46:38', '2026-03-22 15:46:38', NULL, '04', NULL, 1, NULL, NULL),
(8, 'APAPER', '008', '[\"nursery\",\"primary\"]', 'Day', NULL, 'Private', '2026', 'Kigali City', 'Gasabo', 'Remera', 'Remera', 'Remera', 'Remera, Gasabo, Kigali City', NULL, '0796898894', 'apaper@gmail.com', NULL, NULL, 'MUGABO Claude', '0789678565', 'ishimwetheoneste937@gmail.com', NULL, NULL, '/uploads/school-signatures/signature3-1774192835906-710658783.png', '/uploads/school-stamps/stamp1-1774192835908-231950259.png', 27, NULL, 'active', 1, '2026-03-22 15:46:54', '2026-03-22 17:24:30', NULL, '04', NULL, 0, NULL, NULL),
(11, 'test  Academy', '999', '[\"o_level\",\"a_level\",\"nursery\",\"pre_primary\",\"primary\"]', '', NULL, 'Private', '2010', 'Kigali City', 'Kicukiro', 'Niboye', 'Niboye', 'Niboye', 'Niboye, Kicukiro, Kigali City', NULL, '0788999000', 'info_999@seed.local', NULL, 'https://www.lanari.rw/', 'Dr. Seed Headmaster', '0788999001', '', NULL, '/uploads/school-logos/image-removebg-preview-1775752485048-944746682.png', NULL, NULL, NULL, NULL, 'active', 1, '2026-04-08 12:42:14', '2026-04-10 09:16:03', NULL, '12', '[\"PCM\",\"PCB\"]', 0, 'Day School', 'null');

-- --------------------------------------------------------

--
-- Table structure for table `school_active_academic_context`
--

CREATE TABLE `school_active_academic_context` (
  `school_id` int(10) UNSIGNED NOT NULL,
  `academic_year` varchar(32) NOT NULL,
  `term` varchar(32) NOT NULL,
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
...
--
-- Dumping data for table `school_active_academic_context`
--

INSERT INTO `school_active_academic_context` (`school_id`, `academic_year`, `term`, `updated_at`) VALUES
(11, '2023-2024', 'Term 2', '2026-04-10 20:44:17');
...
(3, 'BY-2025-00003', 3, 'ECOLE NOTRE DAME DES ANGES', '003', 'Remera', 'Gasabo', 'Kigali City', 'P2', '[\"P2\",\"P3\",\"P4\"]', 'Term 1', '2025-2026', 'Primary', 'Private', NULL, '[{\"name\":\"Tuition Fee\",\"amount\":\"120000\"},{\"name\":\"Transport Fee\",\"amount\":\"80000\"}]', 'Dear Parents and Guardians,\r\n\r\nWe are pleased to inform you of the school fees for the upcoming term. Please find the detailed breakdown below.\r\n\r\nThank you for your continued support.', 200000.00, 'Umwalimu SACCO', '0008778767656767', NULL, NULL, 'efb9770b3d3fafa2', NULL, NULL, NULL, NULL, NULL, 'approved', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-27 12:35:31', '2026-03-27 12:35:32', NULL, 1, 0, 200000.00, NULL, '/uploads/babyeyi/qrcodes/qr-BY-2025-00003-1774607731368.png', 'http://localhost:5174/babyeyi/verify/BY-2025-00003', '/uploads/babyeyi/pdfs/babyeyi-BY-2025-00003-1774607731621.pdf', 'babyeyi-BY-2025-00003-1774607731621.pdf', '[{\"bankName\":\"Umwalimu SACCO\",\"accountNumber\":\"0008778767656767\",\"accountName\":\"ECOLE NOTRE DAME DES ANGES\",\"isPrimary\":true}]', NULL),
(4, 'BY-2025-00004', 11, 'Babyeyi Seed Academy', '999', 'Niboye', 'Kicukiro', 'Kigali City', 'P1', '[\"P1\"]', 'Term 1', '2025-2026', 'Primary', 'Private', NULL, '[{\"name\":\"Tuition Fee\",\"amount\":\"57\"},{\"name\":\"Activity Fee\",\"amount\":\"9\"}]', 'Dear Parents and Guardians,\r\n\r\nWe are pleased to inform you of the school fees for the upcoming term. Please find the detailed breakdown below.\r\n\r\nThank you for your continued support.', 66.00, 'Bank of Kigali (BK)', '005093750', NULL, NULL, 'a593f4852f36c386', NULL, NULL, NULL, NULL, NULL, 'approved', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-08 18:39:41', '2026-04-08 18:39:44', NULL, 1, 0, 66.00, NULL, '/uploads/babyeyi/qrcodes/qr-BY-2025-00004-1775666383578.png', 'http://localhost:5174/babyeyi/verify/BY-2025-00004', '/uploads/babyeyi/pdfs/babyeyi-BY-2025-00004-1775666383939.pdf', 'babyeyi-BY-2025-00004-1775666383939.pdf', '[{\"bankName\":\"Bank of Kigali (BK)\",\"accountNumber\":\"005093750\",\"accountName\":\"Babyeyi Seed Academy\",\"isPrimary\":true}]', '{\"v\":1,\"source\":\"en\",\"generatedAt\":\"2026-04-08T16:39:42.039Z\",\"freeTier\":true,\"translationEngine\":\"mymemory\",\"en\":{\"parentMessage\":\"Dear Parents and Guardians,\\r\\n\\r\\nWe are pleased to inform you of the school fees for the upcoming term. Please find the detailed breakdown below.\\r\\n\\r\\nThank you for your continued support.\",\"paymentNames\":[\"Tuition Fee\",\"Activity Fee\"],\"reqItems\":[\"\",\"School ID card\"],\"reqDescs\":[\"\",\"\"],\"noteItems\":[\"\"],\"noteDetails\":[\"\"],\"otherItems\":[\"\"],\"otherDetails\":[\"\"],\"leaderNames\":[],\"leaderRoles\":[],\"counts\":{\"payments\":2,\"reqs\":2,\"notes\":1,\"others\":1,\"leaders\":0}},\"rw\":{\"parentMessage\":\"Dear Parents and Guardians,\\r\\n\\r\\nWe are pleased to inform you of the school fees for the upcoming term. Please find the detailed breakdown below.\\r\\n\\r\\nThank you for your continued support.\",\"paymentNames\":[\"Tuition Fee\",\"Activity Fee\"],\"reqItems\":[\"\",\"School ID card\"],\"reqDescs\":[\"\",\"\"],\"noteItems\":[\"\"],\"noteDetails\":[\"\"],\"otherItems\":[\"\"],\"otherDetails\":[\"\"],\"leaderNames\":[],\"leaderRoles\":[],\"counts\":{\"payments\":2,\"reqs\":2,\"notes\":1,\"others\":1,\"leaders\":0}},\"fr\":{\"parentMessage\":\"Dear Parents and Guardians,\\r\\n\\r\\nWe are pleased to inform you of the school fees for the upcoming term. Please find the detailed breakdown below.\\r\\n\\r\\nThank you for your continued support.\",\"paymentNames\":[\"Tuition Fee\",\"Activity Fee\"],\"reqItems\":[\"\",\"School ID card\"],\"reqDescs\":[\"\",\"\"],\"noteItems\":[\"\"],\"noteDetails\":[\"\"],\"otherItems\":[\"\"],\"otherDetails\":[\"\"],\"leaderNames\":[],\"leaderRoles\":[],\"counts\":{\"payments\":2,\"reqs\":2,\"notes\":1,\"others\":1,\"leaders\":0}}}');
...
INSERT INTO `school_classes` (`id`, `school_id`, `group_name`, `stream_name`, `created_at`, `category`, `combination`) VALUES
(313, 1, 'S4', 'A', '2026-04-09 16:26:05', 'a_level', 'PCM'),
(362, 11, 'Baby Class', 'A', '2026-04-10 09:16:03', 'nursery', NULL),
(363, 11, 'Middle Class', 'A', '2026-04-10 09:16:03', 'nursery', NULL),
(364, 11, 'P1', 'A', '2026-04-10 09:16:03', 'pre_primary', NULL),
(365, 11, 'P2', 'A', '2026-04-10 09:16:03', 'pre_primary', NULL),
(366, 11, 'P3', 'A', '2026-04-10 09:16:03', 'pre_primary', NULL),
(367, 11, 'P4', 'A', '2026-04-10 09:16:03', 'primary', NULL),
(368, 11, 'P5', 'A', '2026-04-10 09:16:03', 'primary', NULL),
(369, 11, 'P6', 'A', '2026-04-10 09:16:03', 'primary', NULL),
(370, 11, 'S1', 'A', '2026-04-10 09:16:03', 'o_level', NULL),
(371, 11, 'S2', 'A', '2026-04-10 09:16:03', 'o_level', NULL),
(372, 11, 'S3', 'A', '2026-04-10 09:16:03', 'o_level', NULL),
(373, 11, 'S4', 'A', '2026-04-10 09:16:03', 'a_level', 'PCB'),
(374, 11, 'S4', 'B', '2026-04-10 09:16:03', 'a_level', 'PCB'),
(375, 11, 'S5', 'A', '2026-04-10 09:16:03', 'a_level', 'PCM'),
(376, 11, 'S6', 'A', '2026-04-10 09:16:03', 'a_level', 'PCM'),
(377, 11, 'Top Class', 'A', '2026-04-10 09:16:03', 'nursery', NULL);
...
INSERT INTO `school_discipline_settings` (`school_id`, `total_marks`, `starting_marks`, `permissions_enabled`, `cases_book_status`, `updated_at`, `updated_by_user_id`) VALUES
(3, 40.00, 100.00, 1, 'ACTIVE', '2026-03-25 08:00:18', 30);
...
--
-- Table structure for table `school_expense_payments`
--

CREATE TABLE `school_expense_payments` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `expense_id` int(10) UNSIGNED NOT NULL,
  `amount` decimal(14,2) NOT NULL DEFAULT 0.00,
  `method` varchar(60) DEFAULT NULL,
  `method_ref` varchar(120) DEFAULT NULL,
...
--
-- Table structure for table `school_finance_pay_methods`
--

CREATE TABLE `school_finance_pay_methods` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `school_gradebook_columns`
--

INSERT INTO `school_gradebook_columns` (`id`, `school_id`, `slug`, `label`, `sort_order`, `default_max_score`, `created_at`) VALUES
(1, 11, 'cat1', 'CAT 1', 1, 30.00, '2026-04-12 10:35:54'),
(2, 11, 'cat2', 'CAT 2', 2, 30.00, '2026-04-12 10:35:54'),
(3, 11, 'exam', 'Examination', 3, 40.00, '2026-04-12 10:35:54');
...
CREATE TABLE `school_holidays` (
  ...
  `holiday_type` enum('Public Holiday','Academic Break','National Event','Other') NOT NULL DEFAULT 'Public Holiday',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `school_holidays` (`id`, `school_id`, `name`, `start_date`, `end_date`, `holiday_type`, `created_at`, `deleted_at`) VALUES
(7, 11, 'New Year', '2025-01-01', '2025-01-02', 'Public Holiday', '2026-04-10 18:39:01', NULL),
(8, 11, 'Heroes Day', '2025-02-01', '2025-02-01', 'Public Holiday', '2026-04-10 18:39:01', NULL),
(9, 11, 'Genocide Memorial Day', '2025-04-07', '2025-04-07', 'National Event', '2026-04-10 18:39:01', NULL),
(10, 11, 'Labor Day', '2025-05-01', '2025-05-01', 'Public Holiday', '2026-04-10 18:39:01', NULL),
(11, 11, 'Independence Day', '2025-07-01', '2025-07-01', 'Public Holiday', '2026-04-10 18:39:01', NULL),
(12, 11, 'Liberation Day', '2025-07-04', '2025-07-04', 'National Event', '2026-04-10 18:39:01', NULL),
(13, 11, 'Christmas Day', '2025-12-25', '2025-12-25', 'Public Holiday', '2026-04-10 18:39:01', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `school_iot_devices`
--

CREATE TABLE `school_iot_devices` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `device_uid` varchar(120) NOT NULL,
  ...
  `is_active` tinyint(1) DEFAULT 1,
  `mapped_event_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `school_iot_devices`
--

INSERT INTO `school_iot_devices` (`id`, `school_id`, `device_uid`, `device_label`, `device_type`, `status`, `last_heartbeat`, `purpose`, `is_active`, `mapped_event_id`, `mapped_class_id`, `created_at`, `updated_at`) VALUES
(1, 11, 'GT-MAIN-11', 'Main Pedestrian Gate', 'GATE_SCANNER', 'Online', NULL, NULL, 1, 1, NULL, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(2, 11, 'HL-GH-11', 'Great Hall Entrance', 'CLASS_READER', 'Online', NULL, NULL, 1, 2, NULL, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(3, 11, 'DH-NORTH-11', 'Dining Hall North', 'GATE_SCANNER', 'Online', NULL, NULL, 1, 3, NULL, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(4, 11, 'LB-BLOCKB-11', 'Library Block B', 'CLASS_READER', 'Online', NULL, NULL, 1, 4, NULL, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(5, 11, 'GT-SIDE-11', 'Side Entrance Gate', 'GATE_SCANNER', 'Online', NULL, NULL, 1, 5, NULL, '2026-04-11 15:32:55', '2026-04-11 15:32:55'),
(6, 11, 'RD-S4A-11', 'Senior 4A Reader', 'CLASS_READER', 'Online', NULL, 'Class Attendance: S4 A', 1, NULL, 373, '2026-04-11 15:52:07', '2026-04-11 15:52:07'),
(7, 11, 'RD-P6A-11', 'Primary 6A Reader', 'CLASS_READER', 'Online', NULL, 'Class Attendance: P6 A', 1, NULL, 369, '2026-04-11 15:52:07', '2026-04-11 15:52:07');
...
--
-- Table structure for table `school_payroll_rates`
--

CREATE TABLE `school_payroll_rates` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `role_label` varchar(120) NOT NULL,
  `role_code` varchar(64) DEFAULT NULL,
  `base_amount` decimal(14,2) NOT NULL DEFAULT 0.00,
  `allowance_amount` decimal(14,2) NOT NULL DEFAULT 0.00,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `school_payroll_rates`
--

INSERT INTO `school_payroll_rates` (`id`, `school_id`, `role_label`, `role_code`, `base_amount`, `allowance_amount`, `created_at`, `updated_at`) VALUES
(1, 11, 'New role', NULL, 0.00, 0.00, '2026-04-15 21:04:52', '2026-04-15 21:04:52'),
(2, 11, 'teacher', NULL, 100000.00, 0.00, '2026-04-15 21:04:52', '2026-04-15 21:04:52');

-- --------------------------------------------------------

--
-- Table structure for table `school_payroll_runs`
--
...
--
-- Dumping data for table `school_payroll_runs`
--

INSERT INTO `school_payroll_runs` (`id`, `school_id`, `run_code`, `period_label`, `period_key`, `status`, `staff_count`, `gross_total`, `created_by_user_id`, `created_at`) VALUES
(1, 11, 'RUN-202604-MO0FJNL9', 'Apr 2026', '2026-04', 'processed', 8, 500000.00, 60, '2026-04-15 21:14:57');

-- --------------------------------------------------------

--
-- Table structure for table `school_payroll_run_lines`
--

CREATE TABLE `school_payroll_run_lines` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `run_id` int(10) UNSIGNED NOT NULL,
  `staff_user_id` int(10) UNSIGNED NOT NULL,
  `staff_name` varchar(255) NOT NULL,
  `dept_label` varchar(120) DEFAULT NULL,
  `role_label` varchar(120) DEFAULT NULL,
  `gross_amount` decimal(14,2) NOT NULL DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `school_payroll_run_lines`
--

INSERT INTO `school_payroll_run_lines` (`id`, `school_id`, `run_id`, `staff_user_id`, `staff_name`, `dept_label`, `role_label`, `gross_amount`) VALUES
(1, 11, 1, 56, 'Director Studies', 'Head of Study', 'Head of Study', 0.00),
(2, 11, 1, 57, 'Alice Uwase', 'Teacher', 'Teacher', 100000.00),
(3, 11, 1, 58, 'Bob Mugisha', 'Teacher', 'Teacher', 100000.00),
(4, 11, 1, 59, 'Head Department', 'Head of Discipline', 'Head of Discipline', 0.00),
(5, 11, 1, 60, 'Finance Officer', 'Accountant', 'Accountant', 0.00),
(6, 11, 1, 61, 'Hozana Dusabimana', 'Teacher', 'Teacher', 100000.00),
(7, 11, 1, 57, 'Alice Uwase', 'Teacher', 'Teacher', 100000.00),
(8, 11, 1, 58, 'Bob Mugisha', 'Teacher', 'Teacher', 100000.00);

-- --------------------------------------------------------

--
-- Table structure for table `school_payroll_staff_assignments`
--

CREATE TABLE `school_payroll_staff_assignments` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `staff_user_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `school_payroll_staff_assignments`
--

INSERT INTO `school_payroll_staff_assignments` (`id`, `school_id`, `staff_user_id`, `rate_id`, `is_active`, `updated_at`) VALUES
(1, 11, 57, 2, 1, '2026-04-15 21:11:59');
...
INSERT INTO `school_periods` (`id`, `school_id`, `period_name`, `start_time`, `end_time`, `is_break`, `sort_order`, `created_at`) VALUES
(1, 11, 'Period 1', '08:00', '08:40', 0, 0, '2026-04-10 20:26:25'),
(2, 11, 'Period 2', '08:40', '09:20', 0, 1, '2026-04-10 20:26:25'),
(3, 11, 'Period 3', '09:20', '10:00', 0, 2, '2026-04-10 20:26:25'),
(4, 11, 'Morning Break', '10:00', '10:30', 1, 3, '2026-04-10 20:26:25'),
(5, 11, 'Period 4', '10:30', '11:10', 0, 4, '2026-04-10 20:26:25'),
(6, 11, 'Period 5', '11:10', '11:50', 0, 5, '2026-04-10 20:26:25'),
(7, 11, 'Period 6', '11:50', '12:30', 0, 6, '2026-04-10 20:26:25'),
(8, 11, 'Lunch Break', '12:30', '13:30', 1, 7, '2026-04-10 20:26:25'),
(9, 11, 'Period 7', '13:30', '14:10', 0, 8, '2026-04-10 20:26:25'),
(10, 11, 'Period 8', '14:10', '14:50', 0, 9, '2026-04-10 20:26:25'),
(11, 11, 'Period 9', '14:50', '15:30', 0, 10, '2026-04-10 20:26:25'),
(12, 11, 'Extra Curricular', '15:30', '16:10', 0, 11, '2026-04-10 20:26:25');

-- --------------------------------------------------------

--
-- Table structure for table `school_requisitions`
--

CREATE TABLE `school_requisitions` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `school_store_items` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `school_store_movements`
--

CREATE TABLE `school_store_movements` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `school_store_suppliers`
--

CREATE TABLE `school_store_suppliers` (
  `id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
...
INSERT INTO `school_subjects` (`id`, `school_id`, `name`, `subject_code`, `category`, `is_active`, `created_at`) VALUES
(25, 11, 'Mathematics', 'GENAT038', 'Science', 1, '2026-04-10 20:26:25'),
(26, 11, 'English', 'LIT201', 'Languages', 1, '2026-04-10 20:26:25'),
(27, 11, 'Kinyarwanda', 'KIN101', 'Languages', 1, '2026-04-10 20:26:25'),
(28, 11, 'Physics', 'PHY304', 'Science', 1, '2026-04-10 20:26:25'),
(29, 11, 'Chemistry', 'CHE302', 'Science', 1, '2026-04-10 20:26:25'),
(30, 11, 'Biology', 'BIO301', 'Science', 1, '2026-04-10 20:26:25'),
(31, 11, 'Entrepreneurship', 'ENT405', 'Technical', 1, '2026-04-10 20:26:25'),
(32, 11, 'Geography', 'GEO202', 'Arts', 1, '2026-04-10 20:26:25'),
(33, 11, 'History', 'HIS201', 'Arts', 1, '2026-04-10 20:26:25');
...
INSERT INTO `school_terms` (`id`, `school_id`, `academic_year`, `term_number`, `name`, `start_date`, `end_date`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(5, 11, '2026', 0, 'Term 1 2025', '2025-01-06', '2025-03-28', 'Pending', '2026-04-10 18:26:25', '2026-04-10 18:26:25', NULL),
(6, 11, '2026', 0, 'Term 2 2025', '2025-04-14', '2025-07-04', 'Pending', '2026-04-10 18:26:25', '2026-04-10 18:26:25', NULL),
(7, 11, '2026', 0, 'Term 3 2025', '2025-08-04', '2025-10-31', 'Pending', '2026-04-10 18:26:25', '2026-04-10 18:26:25', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `school_term_milestones`
--

CREATE TABLE `school_term_milestones` (
  `id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `school_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(120) NOT NULL,
  `timing` varchar(60) NOT NULL DEFAULT 'Week ?',
  `sort_order` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `school_term_milestones`
--

INSERT INTO `school_term_milestones` (`id`, `term_id`, `school_id`, `name`, `timing`, `sort_order`, `created_at`, `deleted_at`) VALUES
(7, 5, 11, 'Term Commencement & Registration', 'Week 1', 1, '2026-04-10 18:39:01', NULL),
(8, 5, 11, 'First Continuous Assessment', 'Week 4', 2, '2026-04-10 18:39:01', NULL),
(9, 5, 11, 'Mid-term Examinations', 'Week 6-7', 3, '2026-04-10 18:39:01', NULL),
(10, 5, 11, 'Academic Reports Draft', 'Week 9', 4, '2026-04-10 18:39:01', NULL),
(11, 5, 11, 'End-term Examinations', 'Week 10-11', 5, '2026-04-10 18:39:01', NULL),
(12, 5, 11, 'Term Closure & Report Distribution', 'Week 12', 6, '2026-04-10 18:39:01', NULL),
(13, 6, 11, 'Term Commencement & Registration', 'Week 1', 1, '2026-04-10 18:39:01', NULL),
(14, 6, 11, 'First Continuous Assessment', 'Week 4', 2, '2026-04-10 18:39:01', NULL),
(15, 6, 11, 'Mid-term Examinations', 'Week 6-7', 3, '2026-04-10 18:39:01', NULL),
(16, 6, 11, 'Academic Reports Draft', 'Week 9', 4, '2026-04-10 18:39:01', NULL),
(17, 6, 11, 'End-term Examinations', 'Week 10-11', 5, '2026-04-10 18:39:01', NULL),
(18, 6, 11, 'Term Closure & Report Distribution', 'Week 12', 6, '2026-04-10 18:39:01', NULL),
(19, 7, 11, 'Term Commencement & Registration', 'Week 1', 1, '2026-04-10 18:39:01', NULL),
(20, 7, 11, 'First Continuous Assessment', 'Week 4', 2, '2026-04-10 18:39:01', NULL),
(21, 7, 11, 'Mid-term Examinations', 'Week 6-7', 3, '2026-04-10 18:39:01', NULL),
(22, 7, 11, 'Academic Reports Draft', 'Week 9', 4, '2026-04-10 18:39:01', NULL),
(23, 7, 11, 'End-term Examinations', 'Week 10-11', 5, '2026-04-10 18:39:01', NULL),
(24, 7, 11, 'Term Closure & Report Distribution', 'Week 12', 6, '2026-04-10 18:39:01', NULL);
...
INSERT INTO `staff` (`id`, `user_id`, `school_id`, `staff_id`, `username`, `created_at`, `rfid_uid`, `fingerprint_id`, `identity_remarks`) VALUES
(1, 29, 3, NULL, 'notredameaccountant', '2026-03-25 07:10:08', NULL, NULL, NULL),
(2, 30, 3, NULL, 'notredamehod', '2026-03-25 07:59:29', NULL, NULL, NULL),
(3, 31, 3, NULL, 'notredanedos', '2026-03-25 12:14:23', NULL, NULL, NULL),
(14, 56, 11, 'DOS-999', 'staff_56', '2026-04-08 12:42:14', NULL, NULL, NULL),
(15, 57, 11, 'TCH-999-01', 'staff_57', '2026-04-08 12:42:15', NULL, NULL, NULL),
(16, 58, 11, 'TCH-999-02', 'staff_58', '2026-04-08 12:42:16', NULL, NULL, NULL),
(17, 59, 11, 'HOD-999', 'staff_59', '2026-04-08 12:42:16', NULL, NULL, NULL),
(18, 60, 11, 'ACC-999', 'staff_60', '2026-04-08 12:42:16', NULL, NULL, NULL),
(19, 61, 11, 'ST-317222194', 'hozanadusabimana', '2026-04-10 08:41:58', NULL, NULL, NULL),
(20, 62, 1, 'ST-001-TEST', 'test.teacher', '2026-04-10 08:59:27', NULL, NULL, NULL),
(21, 57, 11, NULL, NULL, '2026-04-11 15:52:07', 'T-ALICE-11', NULL, NULL),
(22, 58, 11, NULL, NULL, '2026-04-11 15:52:07', 'T-BOB-11', NULL, NULL);
...
CREATE TABLE `students` (
  ...
  `class_name` varchar(120) DEFAULT NULL,
  `residency_status` enum('DAY','BOARDING') DEFAULT 'DAY',
...
INSERT INTO `students` (`id`, `student_uid`, `school_id`, `first_name`, `last_name`, `gender`, `birth_year`, `nationality`, `province`, `district`, `sector`, `cell`, `village`, `father_full_name`, `father_phone`, `father_email`, `mother_full_name`, `mother_phone`, `mother_email`, `created_at`, `updated_at`, `import_missing_fields`, `source_row_json`, `class_name`, `residency_status`, `academic_year`, `student_code`, `sdm_code`, `student_photo`, `rfid_uid`, `fingerprint_id`, `identity_remarks`, `class_id`) VALUES
(1, '040080001', 8, 'Manirakiza', 'Jean Pierre', 'Male', 2008, 'Rwandan', 'Kigali City', 'Gasabo', 'Remera', 'Nyabisindu', 'Amarembo II', 'Muneza Peter', '0789867856', NULL, 'Muhoracyeye Veneranda', '0789678567', NULL, '2026-03-22 19:13:27', '2026-03-22 19:14:09', NULL, NULL, 'S1', 'DAY', '2025-2026', '040080001', '12004', NULL, NULL, NULL, NULL, NULL),
(2, '040080002', 8, 'KAMANA', 'Eric', 'Male', 2006, 'Rwandan', 'Kigali City', 'Gasabo', 'Remera', 'Nyabisindu', 'Kinunga', 'Maniriho Peter', '0796787656', NULL, 'Mahoro Jeanne', '0789665746', NULL, '2026-03-22 19:15:45', '2026-03-22 20:05:18', NULL, NULL, 'S1', 'DAY', '2025-2026', '040080002', '12008', NULL, NULL, NULL, NULL, NULL),
(3, '040080003', 8, 'IRADUKUNDA', 'Ange Pascaline', 'Female', 2007, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Ruhengeli', 'Burera', 'uwiragiye Clement', '0788823273', NULL, 'iyakaremye M. Faina', '0788478648', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526266468,\"IRADUKUNDA\",\"Ange Pascaline\",\"Female\",2007,\"uwiragiye Clement\",788823273,\"\",\"iyakaremye M. Faina\",788478648,\"\",\"Rwandan\",\"North\",\"Musanze\",\"Muhoza\",\"Ruhengeli\",\"Burera\"]', 'S2', 'DAY', '2025-2026', '040080003', NULL, NULL, NULL, NULL, NULL, NULL),
(4, '040080004', 8, 'MUGWANEZA', 'Iyabes', NULL, 2004, 'Rwandan', 'South', 'NYANZA', 'KIGOMA', 'MURINJA', 'AKINTARE', 'BIZIMANA Jeadedie', '0722740517', NULL, 'NYICUMI Goltha', '0788275628', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269460,\"MUGWANEZA\",\"Iyabes\",\"DUHIRWE KAGABO MUNANA\",2004,\"BIZIMANA Jeadedie\",722740517,\"\",\"NYICUMI Goltha\",788275628,\"\",\"Rwandan\",\"South\",\"NYANZA\",\"KIGOMA\",\"MURINJA\",\"AKINTARE\"]', 'S2', 'DAY', '2025-2026', '040080004', NULL, NULL, NULL, NULL, NULL, NULL),
(5, '040080005', 8, 'SHIMWA', 'Grace Graine', 'Female', 2007, 'Rwandan', 'Kigali', 'GASABO', 'JALI', NULL, NULL, 'CYPRIEN', '0783551793', NULL, 'PERPETURE', '0785131123', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Cell\",\"Village\"]', '[202526266476,\"SHIMWA\",\"Grace Graine\",\"FEMALE\",2007,\"CYPRIEN\",783551793,\"\",\"PERPETURE\",785131123,\"\",\"Rwandan\",\"KIGALI\",\"GASABO\",\"JALI\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080005', NULL, NULL, NULL, NULL, NULL, NULL),
(6, '040080006', 8, 'TUMUKUNDE', 'Linker', 'Female', 2008, 'Rwandan', 'Kigali', 'NYARUGENGE', 'KIGALI', 'RURIBA', NULL, 'ngamije', '0788457962', NULL, 'Gloria', '0788351921', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Village\"]', '[202526266480,\"TUMUKUNDE\",\"Linker\",\"Female\",2008,\"ngamije\",788457962,\"\",\"Gloria\",788351921,\"\",\"Rwandan\",\"KIGALI\",\"NYARUGENGE\",\"KIGALI\",\"RURIBA\",\"\"]', 'S2', 'DAY', '2025-2026', '040080006', NULL, NULL, NULL, NULL, NULL, NULL),
(7, '040080007', 8, 'UMUHOZA', 'Micheline', 'Female', 2005, 'Rwandan', 'North', 'Burera', 'kivuye', 'Bukwashuri', 'Buhita', 'Maniraguha micheli', '0789917958', NULL, 'Mukasafari marie luise', '0783162958', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526266488,\"UMUHOZA\",\"Micheline\",\"female\",2005,\"Maniraguha micheli\",789917958,\"\",\"Mukasafari marie luise\",783162958,\"\",\"Rwandan\",\"north\",\"Burera\",\"kivuye\",\"Bukwashuri\",\"Buhita\"]', 'S2', 'DAY', '2025-2026', '040080007', NULL, NULL, NULL, NULL, NULL, NULL),
(8, '040080008', 8, 'UWERA TUYISHIMIRE', 'Daniella', 'Female', 2006, 'Rwandan', 'North', 'Gakenke', 'Ruli', 'Gikingo', 'Rumasa', 'Nsanzimana Epa Phorodite', '0785700907', NULL, 'Uwera Mukareta Beatrice', '0785074193', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526266484,\"UWERA TUYISHIMIRE\",\"Daniella\",\"female\",2006,\"Nsanzimana Epa Phorodite\",785700907,\"\",\"Uwera Mukareta Beatrice\",785074193,\"\",\"Rwandan\",\"North\",\"Gakenke\",\"Ruli\",\"Gikingo\",\"Rumasa\"]', 'S2', 'DAY', '2025-2026', '040080008', NULL, NULL, NULL, NULL, NULL, NULL),
(9, '040080009', 8, 'UWIMANA', 'Marie Claire', 'Female', 2006, 'Rwandan', 'Kigali', 'kicukiro', 'NYARUGUNGA', 'kamashashi', 'uruhongore', NULL, NULL, NULL, 'UMWALI ROSE', '0798600056', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526266492,\"UWIMANA\",\"Marie Claire\",\"female\",2006,\"\",\"\",\"\",\"UMWALI ROSE\",798600056,\"\",\"Rwandan\",\"kigali\",\"kicukiro\",\"NYARUGUNGA\",\"kamashashi\",\"uruhongore\"]', 'S2', 'DAY', '2025-2026', '040080009', NULL, NULL, NULL, NULL, NULL, NULL),
(10, '040080010', 8, 'Cadette', 'Sandrine', 'Female', 2005, 'Rwandan', 'East', 'Bugesera', 'Mayange', 'Kabeza', 'Kibirizi', 'Twagirimana Theoneste', '0788633129', NULL, 'Tugirumurinda Therese', '0783088593', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269272,\"Cadette\",\"Sandrine\",\"Female\",2005,\"Twagirimana Theoneste\",788633129,\"\",\"Tugirumurinda Therese\",783088593,\"\",\"Rwandan\",\"Eastern\",\"Bugesera\",\"Mayange\",\"Kabeza\",\"Kibirizi\"]', 'S2', 'DAY', '2025-2026', '040080010', NULL, NULL, NULL, NULL, NULL, NULL),
(11, '040080011', 8, 'HIRWA UMUNYANA', 'Benita', 'Female', 2007, 'Rwandan', 'Kigali', 'Kicukiro', 'Kanombe', 'Rubirizi', 'Beninka', 'Twahirwa Theogene', '0782466295', 'tteo104@gmail.com', 'Niyonambaza Aline', '0788559621', 'niyonambaaline@', '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269276,\"HIRWA UMUNYANA\",\"Benita\",\"Female\",2007,\"Twahirwa Theogene\",782466295,\"tteo104@gmail.com\",\"Niyonambaza Aline\",788559621,\"niyonambaaline@\",\"Rwandan\",\"Kigali city\",\"Kicukiro\",\"Kanombe\",\"Rubirizi\",\"Beninka\"]', 'S2', 'DAY', '2025-2026', '040080011', NULL, NULL, NULL, NULL, NULL, NULL),
(12, '040080012', 8, 'MUSHIMIYIMANA', 'Jimmy', 'Male', 2008, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Kivumu', 'Ubukerarugendo', 'Mporwiki narcise', '0785719204', NULL, 'Uzamukunda Cartas', '0790027126', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269280,\"MUSHIMIYIMANA\",\"Jimmy\",\"Male\",2008,\"Mporwiki narcise\",785719204,\"\",\"Uzamukunda Cartas\",790027126,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Kivumu\",\"Ubukerarugendo\"]', 'S2', 'DAY', '2025-2026', '040080012', NULL, NULL, NULL, NULL, NULL, NULL),
(13, '040080013', 8, 'NIYOGISUBIZO', 'Gaston', 'Male', 2005, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Rwambogo', 'gakoro', 'HAKIZIMANA Anastase', '0783552273', NULL, 'NIYONSABA Emmaculee\'', '0782539558', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269284,\"NIYOGISUBIZO\",\"Gaston\",\"male\",2005,\"HAKIZIMANA Anastase\",783552273,\"\",\"NIYONSABA Emmaculee\'\",782539558,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Musanze\",\"Rwambogo\",\"gakoro\"]', 'S2', 'DAY', '2025-2026', '040080013', NULL, NULL, NULL, NULL, NULL, NULL),
(14, '040080014', 8, 'MURANGIRA', 'Adiru', 'Male', 2007, 'Rwandan', 'Kigali City', 'Kicukiro', 'Kicukiro', 'Kicukiro', 'Rwinanka', 'Murangira Fazil', '0788784098', NULL, 'Mukase Chadia', '0788784098', NULL, '2026-03-22 20:25:59', '2026-03-22 20:26:54', '[]', '[202526269356,\"MURANGIRA\",\"Adiru\",\"Male\",2007,\"Murangira Fazil\",788784098,\"\",\"Mukase Chadia\",788784098,\"\",\"Rwandan\",\"Kigali city\",\"kicukiro\",\"kicukiro\",\"kicukiro\",\"Rwinanka\"]', 'S2', 'DAY', '2025-2026', '040080014', NULL, NULL, NULL, NULL, NULL, NULL),
(15, '040080015', 8, 'SHEMA', 'Charles', 'Male', 2007, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Amataba', 'bugoyi', 'Gasana damascene', '0788558382', NULL, 'Mukashyaka ngabo', '0788265818', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269360,\"SHEMA\",\"Charles\",\"Male\",2007,\"Gasana damascene\",788558382,\"\",\"Mukashyaka ngabo\",788265818,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Amataba\",\"bugoyi\"]', 'S2', 'DAY', '2025-2026', '040080015', NULL, NULL, NULL, NULL, NULL, NULL),
(16, '040080016', 8, 'ISANGE', 'Placide', 'Male', 2008, 'Rwandan', 'North', 'Burera', 'cyanika', 'nkiliza', 'cyidaho', 'NDABANANIYE Janvier', '0788424789', NULL, 'NDIMUBANDI Emmeraude', '0788606955', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269288,\"ISANGE\",\"Placide\",\"Male\",2008,\"NDABANANIYE Janvier\",788424789,\"\",\"NDIMUBANDI Emmeraude\",788606955,\"\",\"Rwandan\",\"Northern\",\"Burera\",\"cyanika\",\"nkiliza\",\"cyidaho\"]', 'S2', 'DAY', '2025-2026', '040080016', NULL, NULL, NULL, NULL, NULL, NULL),
(17, '040080017', 8, 'Mugisha', 'Kenny Frank', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736137668', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269292,\"Mugisha\",\"Kenny Frank\",\"Male\",\"\",\"\",789387011,\"\",\"\",736137668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080017', NULL, NULL, NULL, NULL, NULL, NULL),
(18, '040080018', 8, 'DUSENGIMANA', 'Olivier', 'Male', 2005, 'Rwandan', 'North', 'Burera', 'kinoni', 'nkenke', 'kigina', 'Turinumukiza john', '0789387012', 'olivierdusengimana31@gmail.com', 'nyirantungane candide', '0736276680', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269304,\"DUSENGIMANA\",\"Olivier\",\"Male\",2005,\"Turinumukiza john\",789387012,\"olivierdusengimana31@gmail.com\",\"nyirantungane candide\",736276680,\"\",\"Rwandan\",\"Northern\",\"Burera\",\"kinoni\",\"nkenke\",\"kigina\"]', 'S2', 'DAY', '2025-2026', '040080018', NULL, NULL, NULL, NULL, NULL, NULL),
(19, '040080019', 8, 'MUGISHA', 'Obed', 'Male', 2005, 'Rwandan', NULL, NULL, NULL, NULL, NULL, 'Gatera Pascal', NULL, NULL, 'Mukamurigo illumine', '0788411306', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269308,\"MUGISHA\",\"Obed\",\"Male\",2005,\"Gatera Pascal\",\"\",\"\",\"Mukamurigo illumine\",788411306,\"\",\"Rwandan\",\"\",\"\",\"\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080019', NULL, NULL, NULL, NULL, NULL, NULL),
(20, '040080020', 8, 'URAYENEZA', 'Nabil Saidi', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387012', NULL, NULL, NULL, NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269312,\"URAYENEZA\",\"Nabil Saidi\",\"Male\",\"\",\"\",789387012,\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080020', NULL, NULL, NULL, NULL, NULL, NULL),
(21, '040080021', 8, 'IYAKARE KALINDA', 'Liza', 'Female', 2006, 'Rwandan', 'Kigali', 'Gasabo', 'Kibagabaga', 'Kibagabaga', NULL, 'KALINDA Heritier', '0788617976', NULL, 'MUKASHYAKA Marie Claire', '0788759262', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Village\"]', '[202526269316,\"IYAKARE KALINDA\",\"Liza\",\"Female\",2006,\"KALINDA Heritier\",788617976,\"\",\"MUKASHYAKA Marie Claire\",788759262,\"\",\"Rwandan\",\"kigali city\",\"Gasabo\",\"Kibagabaga\",\"Kibagabaga\",\"\"]', 'S2', 'DAY', '2025-2026', '040080021', NULL, NULL, NULL, NULL, NULL, NULL),
(22, '040080022', 8, 'JABO MAKOMA', 'Rock', 'Male', 2008, 'Rwandan', 'Kigali', 'kicukiro', 'Nyarugunga', NULL, NULL, 'NOHELI Sam', '0788635907', 'sambensolo@gmail.com', 'TUYIZERE Petronille', '0736107668', 'tuyipety@gmail.com', '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Cell\",\"Village\"]', '[202526269320,\"JABO MAKOMA\",\"Rock\",\"Male\",2008,\"NOHELI Sam\",788635907,\"sambensolo@gmail.com\",\"TUYIZERE Petronille\",736107668,\"tuyipety@gmail.com\",\"Rwandan\",\"kigali city\",\"kicukiro\",\"Nyarugunga\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080022', NULL, NULL, NULL, NULL, NULL, NULL),
(23, '040080023', 8, 'KWIZERA NTWARI', 'Jyvan', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736107668', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269324,\"KWIZERA NTWARI\",\"Jyvan\",\"Male\",\"\",\"\",789387011,\"\",\"\",736107668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080023', NULL, NULL, NULL, NULL, NULL, NULL),
(24, '040080024', 8, 'MANZI', 'Benjamin', 'Male', 2008, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Ruhengeri', 'Muhe', 'MUNYANEZA Methode', '0785582700', NULL, 'MUTAMURIZA Liberatha', '0788415830', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269328,\"MANZI\",\"Benjamin\",\"Male\",2008,\"MUNYANEZA Methode\",785582700,\"\",\"MUTAMURIZA Liberatha\",788415830,\"\",\"Rwandan\",\"Nothern\",\"Musanze\",\"Muhoza\",\"Ruhengeri\",\"Muhe\"]', 'S2', 'DAY', '2025-2026', '040080024', NULL, NULL, NULL, NULL, NULL, NULL),
(25, '040080025', 8, 'MAOMBI', 'Patrick', 'Male', 2005, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Kivumu', 'Urumuri', 'Mbanziriza Aphrodis', '0788668288', NULL, 'Murekatete Meghan', '0783708041', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269332,\"MAOMBI\",\"Patrick\",\"Male\",2005,\"Mbanziriza Aphrodis\",788668288,\"\",\"Murekatete Meghan\",783708041,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Kivumu\",\"Urumuri\"]', 'S2', 'DAY', '2025-2026', '040080025', NULL, NULL, NULL, NULL, NULL, NULL),
(26, '040080026', 8, 'NIWEMUGENI', 'ISABELLE', 'Female', 2002, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Nengo', 'Urubyiruko', 'BAJENEZA JEAN PAUL', '0788451571', NULL, 'MUKABAGARA VEREN', '0783801088', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[20252666796,\"NIWEMUGENI\",\"ISABELLE\",\"F\",37338,\"BAJENEZA JEAN PAUL\",788451571,\"\",\"MUKABAGARA VEREN\",783801088,\"\",\"\",\"West\",\"Rubavu\",\"Gisenyi\",\"Nengo\",\"Urubyiruko\"]', 'S2', 'DAY', '2025-2026', '040080026', NULL, NULL, NULL, NULL, NULL, NULL),
(27, '040080027', 8, 'NIWEMUGENI', 'Isabelle', 'Female', 2004, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Ntengo', 'Urubyiruko', 'Bajeneza jean paul', '0788451571', NULL, 'Mukantagara verena', '0783801088', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269336,\"NIWEMUGENI\",\"Isabelle\",\"Female\",2004,\"Bajeneza jean paul\",788451571,\"\",\"Mukantagara verena\",783801088,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Ntengo\",\"Urubyiruko\"]', 'S2', 'DAY', '2025-2026', '040080027', NULL, NULL, NULL, NULL, NULL, NULL),
(28, '040080028', 8, 'NTWARI', 'Davis', 'Male', 2006, 'Rwandan', 'Kigali', 'Gasabo', 'Rusororo', NULL, NULL, 'NDATSIKIRA GILBERT', '0788550156', NULL, 'UWIMANA NATACHA', '0788623723', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Cell\",\"Village\"]', '[202526269340,\"NTWARI\",\"Davis\",\"Male\",2006,\"NDATSIKIRA GILBERT\",788550156,\"\",\"UWIMANA NATACHA\",788623723,\"\",\"Rwandan\",\"Kigali\",\"Gasabo\",\"Rusororo\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080028', NULL, NULL, NULL, NULL, NULL, NULL),
(29, '040080029', 8, 'NGIRABAKUNZI', 'Thierry', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736177668', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269388,\"NGIRABAKUNZI\",\"Thierry\",\"Male\",\"\",\"\",789387011,\"\",\"\",736177668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080029', NULL, NULL, NULL, NULL, NULL, NULL),
(30, '040080030', 8, 'NIZEYIMANA', 'Bertin', 'Male', 2006, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Cyabagarura', 'Gaturo', 'MUGIRANEZA Abrahum', '0788536153', NULL, 'MUTEGARUGORI Bernadette', '0789361318', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269392,\"NIZEYIMANA\",\"Bertin\",\"Male\",2006,\"MUGIRANEZA Abrahum\",788536153,\"\",\"MUTEGARUGORI Bernadette\",789361318,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Musanze\",\"Cyabagarura\",\"Gaturo\"]', 'S2', 'DAY', '2025-2026', '040080030', NULL, NULL, NULL, NULL, NULL, NULL),
(31, '040080031', 8, 'NIZEYIMENA', 'BERTIN', 'Male', 2005, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Cyabagarura', 'Bukane', 'MUGIRANEZA ABRAHAM', '0788536153', NULL, 'MUTEGARUGORI BERNADETTE', '0789361318', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[20252665816,\"NIZEYIMENA\",\"BERTIN\",\"M\",38358,\"MUGIRANEZA ABRAHAM\",788536153,\"\",\"MUTEGARUGORI BERNADETTE\",789361318,\"\",\"\",\"North\",\"Musanze\",\"Musanze\",\"Cyabagarura\",\"Bukane\"]', 'S2', 'DAY', '2025-2026', '040080031', NULL, NULL, NULL, NULL, NULL, NULL),
(32, '040080032', 8, 'UMURERWA', 'Agape', 'Female', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387012', NULL, NULL, NULL, NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269396,\"UMURERWA\",\"Agape\",\"Female\",\"\",\"\",789387012,\"\",\"\",7362376680,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'S2', 'DAY', '2025-2026', '040080032', NULL, NULL, NULL, NULL, NULL, NULL),
(33, '040080033', 8, 'IMANISHIMWE', 'Xavio', 'Male', 2006, 'Rwandan', 'North', 'Musanze', 'Nyarubande', 'rwebeya', 'Nyarubande', 'BITONDERUBUSA Jean', '0788223827', NULL, 'MUKESHIMANA Beatha', '0785116318', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269368,\"IMANISHIMWE\",\"Xavio\",\"Male\",2006,\"BITONDERUBUSA Jean\",788223827,\"\",\"MUKESHIMANA Beatha\",785116318,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Nyarubande\",\"rwebeya\",\"Nyarubande\"]', 'S2', 'DAY', '2025-2026', '040080033', NULL, NULL, NULL, NULL, NULL, NULL),
(34, '040080034', 8, 'KANYANA', 'Kenia', 'Female', 2007, 'Rwandan', 'Kigali', 'kicukiro', 'Masaka', 'Kabuga', 'Kabeza', 'BIZIMANA Alphonse', '0789387011', 'bazimyaa@gmail.com', 'NYIRABEZA Perprtue', '0788258853', 'nyirabezaperpetua@gmail.com', '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269372,\"KANYANA\",\"Kenia\",\"Female\",2007,\"BIZIMANA Alphonse\",789387011,\"bazimyaa@gmail.com\",\"NYIRABEZA Perprtue\",788258853,\"nyirabezaperpetua@gmail.com\",\"Rwandan\",\"kigali city\",\"kicukiro\",\"Masaka\",\"Kabuga\",\"Kabeza\"]', 'S2', 'DAY', '2025-2026', '040080034', NULL, NULL, NULL, NULL, NULL, NULL),
(35, '040080035', 8, 'KANZIRA', 'Abigael', 'Female', 2005, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Mpenge', 'Gikwege', 'Matabaro Mporana Jonas', '0788539578', NULL, 'Nantebuka Anne', '0780321240', NULL, '2026-03-22 20:25:59', '2026-03-22 20:25:59', '[]', '[202526269376,\"KANZIRA\",\"Abigael\",\"Female\",2005,\"Matabaro Mporana Jonas\",788539578,\"\",\"Nantebuka Anne\",780321240,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Muhoza\",\"Mpenge\",\"Gikwege\"]', 'S2', 'DAY', '2025-2026', '040080035', NULL, NULL, NULL, NULL, NULL, NULL),
(36, '040030001', 6, 'Feza', 'Esther', 'Female', 2007, 'Rwandan', 'Kigali City', 'Gasabo', 'Remera', 'Nyabisindu', 'Nyabisindu', 'Mugabo Irene', '0796898894', NULL, 'Maneza Aline', '0798567456', NULL, '2026-03-23 16:31:18', '2026-03-25 13:25:37', NULL, NULL, 'P2', 'DAY', '2025-2026', '040030001', '2025003454', NULL, NULL, NULL, NULL, NULL),
(37, '040030002', 3, 'Teta', 'Christella', 'Female', 2016, 'Rwandan', 'Kigali City', 'Gasabo', 'Rusororo', 'Nyagahinga', 'Nyarucundura', 'Mugabo Irene', '0796898894', NULL, 'Maneza Aline', '0799889989', NULL, '2026-03-23 16:44:57', '2026-04-05 13:24:48', NULL, NULL, 'P2', 'DAY', '2025-2026', '040030002', NULL, 'student-1775388288281-aa0bd98707961a71.jpg', NULL, NULL, NULL, NULL),
(71, '040030003', 3, 'Mahoro', 'Alice', 'Female', 2020, 'Rwandan', 'Northern Province', 'Gakenke', 'Nemba', 'Buranga', 'Butare', 'KARACYE Evode', '0790786709', NULL, 'MARITA Aneth', '0789090909', NULL, '2026-03-23 18:31:55', '2026-03-23 18:31:55', NULL, NULL, 'P1', 'DAY', '2025-2026', '040030003', NULL, NULL, NULL, NULL, NULL, NULL),
(72, '040030004', 3, 'Manzi Ineza', 'Karebu', 'Male', 2019, 'Rwandan', 'Northern Province', 'Gakenke', 'Muyongwe', 'Bumba', 'Gitwe', 'KARACYE Evode', '0789090909', NULL, 'MARITA Aneth', '0798090909', NULL, '2026-03-23 18:47:02', '2026-03-23 18:47:02', NULL, NULL, 'P1', 'DAY', '2025-2026', '040030004', NULL, NULL, NULL, NULL, NULL, NULL),
(73, '040030005', 3, 'IRADUKUNDA', 'Ange Pascaline', 'Female', 2007, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Ruhengeli', 'Burera', 'uwiragiye Clement', '0788823273', NULL, 'iyakaremye M. Faina', '0788478648', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526266468,\"IRADUKUNDA\",\"Ange Pascaline\",\"Female\",2007,\"uwiragiye Clement\",788823273,\"\",\"iyakaremye M. Faina\",788478648,\"\",\"Rwandan\",\"North\",\"Musanze\",\"Muhoza\",\"Ruhengeli\",\"Burera\"]', 'P3', 'DAY', '2025-2026', '040030005', NULL, NULL, NULL, NULL, NULL, NULL),
(74, '040030006', 3, 'MUGWANEZA', 'Iyabes', NULL, 2004, 'Rwandan', 'South', 'NYANZA', 'KIGOMA', 'MURINJA', 'AKINTARE', 'BIZIMANA Jeadedie', '0722740517', NULL, 'NYICUMI Goltha', '0788275628', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269460,\"MUGWANEZA\",\"Iyabes\",\"DUHIRWE KAGABO MUNANA\",2004,\"BIZIMANA Jeadedie\",722740517,\"\",\"NYICUMI Goltha\",788275628,\"\",\"Rwandan\",\"South\",\"NYANZA\",\"KIGOMA\",\"MURINJA\",\"AKINTARE\"]', 'P3', 'DAY', '2025-2026', '040030006', NULL, NULL, NULL, NULL, NULL, NULL),
(75, '040030007', 3, 'SHIMWA', 'Grace Graine', 'Female', 2007, 'Rwandan', 'Kigali', 'GASABO', 'JALI', NULL, NULL, 'CYPRIEN', '0783551793', NULL, 'PERPETURE', '0785131123', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Cell\",\"Village\"]', '[202526266476,\"SHIMWA\",\"Grace Graine\",\"FEMALE\",2007,\"CYPRIEN\",783551793,\"\",\"PERPETURE\",785131123,\"\",\"Rwandan\",\"KIGALI\",\"GASABO\",\"JALI\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030007', NULL, NULL, NULL, NULL, NULL, NULL),
(76, '040030008', 3, 'TUMUKUNDE', 'Linker', 'Female', 2008, 'Rwandan', 'Kigali City', 'Nyarugenge', 'Kigali', 'Ruriba', 'Ruriba', 'ngamije', '0788457962', 'ndayishimiyej431@gmail.com', 'Gloria', '0788351921', NULL, '2026-03-25 07:34:51', '2026-03-29 08:06:20', '[\"Village\"]', '[202526266480,\"TUMUKUNDE\",\"Linker\",\"Female\",2008,\"ngamije\",788457962,\"\",\"Gloria\",788351921,\"\",\"Rwandan\",\"KIGALI\",\"NYARUGENGE\",\"KIGALI\",\"RURIBA\",\"\"]', 'P3', 'DAY', '2025-2026', '040030008', '20250204', NULL, NULL, NULL, NULL, NULL),
(77, '040030009', 3, 'UMUHOZA', 'Micheline', 'Female', 2005, 'Rwandan', 'North', 'Burera', 'kivuye', 'Bukwashuri', 'Buhita', 'Maniraguha micheli', '0789917958', NULL, 'Mukasafari marie luise', '0783162958', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526266488,\"UMUHOZA\",\"Micheline\",\"female\",2005,\"Maniraguha micheli\",789917958,\"\",\"Mukasafari marie luise\",783162958,\"\",\"Rwandan\",\"north\",\"Burera\",\"kivuye\",\"Bukwashuri\",\"Buhita\"]', 'P3', 'DAY', '2025-2026', '040030009', NULL, NULL, NULL, NULL, NULL, NULL),
(78, '040030010', 3, 'UWERA TUYISHIMIRE', 'Daniella', 'Female', 2006, 'Rwandan', 'Northern Province', 'Gakenke', 'Ruli', 'Gikingo', 'Rumasa', 'Nsanzimana Epa Phorodite', '0785700907', 'ishimwetheo488@gmail.com', 'Uwera Mukareta Beatrice', '0785074193', NULL, '2026-03-25 07:34:51', '2026-03-29 07:35:15', '[]', '[202526266484,\"UWERA TUYISHIMIRE\",\"Daniella\",\"female\",2006,\"Nsanzimana Epa Phorodite\",785700907,\"\",\"Uwera Mukareta Beatrice\",785074193,\"\",\"Rwandan\",\"North\",\"Gakenke\",\"Ruli\",\"Gikingo\",\"Rumasa\"]', 'P3', 'DAY', '2025-2026', '040030010', '2025001', NULL, NULL, NULL, NULL, NULL),
(79, '040030011', 3, 'UWIMANA', 'Marie Claire', 'Female', 2006, 'Rwandan', 'Kigali City', 'Kicukiro', 'Nyarugunga', 'Kamashashi', 'Uruhongore', 'Karacye Eric', '0790425535', NULL, 'UMWALI ROSE', '0798600056', NULL, '2026-03-25 07:34:51', '2026-03-29 14:34:20', '[]', '[202526266492,\"UWIMANA\",\"Marie Claire\",\"female\",2006,\"\",\"\",\"\",\"UMWALI ROSE\",798600056,\"\",\"Rwandan\",\"kigali\",\"kicukiro\",\"NYARUGUNGA\",\"kamashashi\",\"uruhongore\"]', 'P3', 'DAY', '2025-2026', '040030011', '2025002', NULL, NULL, NULL, NULL, NULL),
(80, '040030012', 3, 'Cadette', 'Sandrine', 'Female', 2005, 'Rwandan', 'East', 'Bugesera', 'Mayange', 'Kabeza', 'Kibirizi', 'Twagirimana Theoneste', '0788633129', NULL, 'Tugirumurinda Therese', '0783088593', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269272,\"Cadette\",\"Sandrine\",\"Female\",2005,\"Twagirimana Theoneste\",788633129,\"\",\"Tugirumurinda Therese\",783088593,\"\",\"Rwandan\",\"Eastern\",\"Bugesera\",\"Mayange\",\"Kabeza\",\"Kibirizi\"]', 'P3', 'DAY', '2025-2026', '040030012', NULL, NULL, NULL, NULL, NULL, NULL),
(81, '040030013', 3, 'HIRWA UMUNYANA', 'Benita', 'Female', 2007, 'Rwandan', 'Kigali', 'Kicukiro', 'Kanombe', 'Rubirizi', 'Beninka', 'Twahirwa Theogene', '0782466295', 'tteo104@gmail.com', 'Niyonambaza Aline', '0788559621', 'niyonambaaline@', '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269276,\"HIRWA UMUNYANA\",\"Benita\",\"Female\",2007,\"Twahirwa Theogene\",782466295,\"tteo104@gmail.com\",\"Niyonambaza Aline\",788559621,\"niyonambaaline@\",\"Rwandan\",\"Kigali city\",\"Kicukiro\",\"Kanombe\",\"Rubirizi\",\"Beninka\"]', 'P3', 'DAY', '2025-2026', '040030013', NULL, NULL, NULL, NULL, NULL, NULL),
(82, '040030014', 3, 'MUSHIMIYIMANA', 'Jimmy', 'Male', 2008, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Kivumu', 'Ubukerarugendo', 'Mporwiki narcise', '0785719204', NULL, 'Uzamukunda Cartas', '0790027126', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269280,\"MUSHIMIYIMANA\",\"Jimmy\",\"Male\",2008,\"Mporwiki narcise\",785719204,\"\",\"Uzamukunda Cartas\",790027126,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Kivumu\",\"Ubukerarugendo\"]', 'P3', 'DAY', '2025-2026', '040030014', NULL, NULL, NULL, NULL, NULL, NULL),
(83, '040030015', 3, 'NIYOGISUBIZO', 'Gaston', 'Male', 2005, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Rwambogo', 'gakoro', 'HAKIZIMANA Anastase', '0783552273', NULL, 'NIYONSABA Emmaculee\'', '0782539558', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269284,\"NIYOGISUBIZO\",\"Gaston\",\"male\",2005,\"HAKIZIMANA Anastase\",783552273,\"\",\"NIYONSABA Emmaculee\'\",782539558,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Musanze\",\"Rwambogo\",\"gakoro\"]', 'P3', 'DAY', '2025-2026', '040030015', NULL, NULL, NULL, NULL, NULL, NULL),
(84, '040030016', 3, 'MURANGIRA', 'Adiru', 'Male', 2007, 'Rwandan', 'Kigali', 'kicukiro', 'kicukiro', 'kicukiro', 'Rwinanka', 'Murangira Fazil', '0788784098', NULL, 'Mukase Chadia', '0788784098', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269356,\"MURANGIRA\",\"Adiru\",\"Male\",2007,\"Murangira Fazil\",788784098,\"\",\"Mukase Chadia\",788784098,\"\",\"Rwandan\",\"Kigali city\",\"kicukiro\",\"kicukiro\",\"kicukiro\",\"Rwinanka\"]', 'P3', 'DAY', '2025-2026', '040030016', NULL, NULL, NULL, NULL, NULL, NULL),
(85, '040030017', 3, 'SHEMA', 'Charles', 'Male', 2007, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Amataba', 'bugoyi', 'Gasana damascene', '0788558382', NULL, 'Mukashyaka ngabo', '0788265818', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269360,\"SHEMA\",\"Charles\",\"Male\",2007,\"Gasana damascene\",788558382,\"\",\"Mukashyaka ngabo\",788265818,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Amataba\",\"bugoyi\"]', 'P3', 'DAY', '2025-2026', '040030017', NULL, NULL, NULL, NULL, NULL, NULL),
(86, '040030018', 3, 'ISANGE', 'Placide', 'Male', 2008, 'Rwandan', 'North', 'Burera', 'cyanika', 'nkiliza', 'cyidaho', 'NDABANANIYE Janvier', '0788424789', NULL, 'NDIMUBANDI Emmeraude', '0788606955', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269288,\"ISANGE\",\"Placide\",\"Male\",2008,\"NDABANANIYE Janvier\",788424789,\"\",\"NDIMUBANDI Emmeraude\",788606955,\"\",\"Rwandan\",\"Northern\",\"Burera\",\"cyanika\",\"nkiliza\",\"cyidaho\"]', 'P3', 'DAY', '2025-2026', '040030018', NULL, NULL, NULL, NULL, NULL, NULL),
(87, '040030019', 3, 'Mugisha', 'Kenny Frank', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736137668', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269292,\"Mugisha\",\"Kenny Frank\",\"Male\",\"\",\"\",789387011,\"\",\"\",736137668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030019', NULL, NULL, NULL, NULL, NULL, NULL),
(88, '040030020', 3, 'DUSENGIMANA', 'Olivier', 'Male', 2005, 'Rwandan', 'North', 'Burera', 'kinoni', 'nkenke', 'kigina', 'Turinumukiza john', '0789387012', 'olivierdusengimana31@gmail.com', 'nyirantungane candide', '0736276680', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269304,\"DUSENGIMANA\",\"Olivier\",\"Male\",2005,\"Turinumukiza john\",789387012,\"olivierdusengimana31@gmail.com\",\"nyirantungane candide\",736276680,\"\",\"Rwandan\",\"Northern\",\"Burera\",\"kinoni\",\"nkenke\",\"kigina\"]', 'P3', 'DAY', '2025-2026', '040030020', NULL, NULL, NULL, NULL, NULL, NULL),
(89, '040030021', 3, 'MUGISHA', 'Obed', 'Male', 2005, 'Rwandan', NULL, NULL, NULL, NULL, NULL, 'Gatera Pascal', NULL, NULL, 'Mukamurigo illumine', '0788411306', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269308,\"MUGISHA\",\"Obed\",\"Male\",2005,\"Gatera Pascal\",\"\",\"\",\"Mukamurigo illumine\",788411306,\"\",\"Rwandan\",\"\",\"\",\"\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030021', NULL, NULL, NULL, NULL, NULL, NULL),
(90, '040030022', 3, 'URAYENEZA', 'Nabil Saidi', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387012', NULL, NULL, NULL, NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269312,\"URAYENEZA\",\"Nabil Saidi\",\"Male\",\"\",\"\",789387012,\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030022', NULL, NULL, NULL, NULL, NULL, NULL),
(91, '040030023', 3, 'IYAKARE KALINDA', 'Liza', 'Female', 2006, 'Rwandan', 'Kigali', 'Gasabo', 'Kibagabaga', 'Kibagabaga', NULL, 'KALINDA Heritier', '0788617976', NULL, 'MUKASHYAKA Marie Claire', '0788759262', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Village\"]', '[202526269316,\"IYAKARE KALINDA\",\"Liza\",\"Female\",2006,\"KALINDA Heritier\",788617976,\"\",\"MUKASHYAKA Marie Claire\",788759262,\"\",\"Rwandan\",\"kigali city\",\"Gasabo\",\"Kibagabaga\",\"Kibagabaga\",\"\"]', 'P3', 'DAY', '2025-2026', '040030023', NULL, NULL, NULL, NULL, NULL, NULL),
(92, '040030024', 3, 'JABO MAKOMA', 'Rock', 'Male', 2008, 'Rwandan', 'Kigali', 'kicukiro', 'Nyarugunga', NULL, NULL, 'NOHELI Sam', '0788635907', 'sambensolo@gmail.com', 'TUYIZERE Petronille', '0736107668', 'tuyipety@gmail.com', '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Cell\",\"Village\"]', '[202526269320,\"JABO MAKOMA\",\"Rock\",\"Male\",2008,\"NOHELI Sam\",788635907,\"sambensolo@gmail.com\",\"TUYIZERE Petronille\",736107668,\"tuyipety@gmail.com\",\"Rwandan\",\"kigali city\",\"kicukiro\",\"Nyarugunga\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030024', NULL, NULL, NULL, NULL, NULL, NULL),
(93, '040030025', 3, 'KWIZERA NTWARI', 'Jyvan', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736107668', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269324,\"KWIZERA NTWARI\",\"Jyvan\",\"Male\",\"\",\"\",789387011,\"\",\"\",736107668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030025', NULL, NULL, NULL, NULL, NULL, NULL),
(94, '040030026', 3, 'MANZI', 'Benjamin', 'Male', 2008, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Ruhengeri', 'Muhe', 'MUNYANEZA Methode', '0785582700', NULL, 'MUTAMURIZA Liberatha', '0788415830', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269328,\"MANZI\",\"Benjamin\",\"Male\",2008,\"MUNYANEZA Methode\",785582700,\"\",\"MUTAMURIZA Liberatha\",788415830,\"\",\"Rwandan\",\"Nothern\",\"Musanze\",\"Muhoza\",\"Ruhengeri\",\"Muhe\"]', 'P3', 'DAY', '2025-2026', '040030026', NULL, NULL, NULL, NULL, NULL, NULL),
(95, '040030027', 3, 'MAOMBI', 'Patrick', 'Male', 2005, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Kivumu', 'Urumuri', 'Mbanziriza Aphrodis', '0788668288', NULL, 'Murekatete Meghan', '0783708041', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269332,\"MAOMBI\",\"Patrick\",\"Male\",2005,\"Mbanziriza Aphrodis\",788668288,\"\",\"Murekatete Meghan\",783708041,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Kivumu\",\"Urumuri\"]', 'P3', 'DAY', '2025-2026', '040030027', NULL, NULL, NULL, NULL, NULL, NULL),
(96, '040030028', 3, 'NIWEMUGENI', 'ISABELLE', 'Female', 2002, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Nengo', 'Urubyiruko', 'BAJENEZA JEAN PAUL', '0788451571', NULL, 'MUKABAGARA VEREN', '0783801088', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[20252666796,\"NIWEMUGENI\",\"ISABELLE\",\"F\",37338,\"BAJENEZA JEAN PAUL\",788451571,\"\",\"MUKABAGARA VEREN\",783801088,\"\",\"\",\"West\",\"Rubavu\",\"Gisenyi\",\"Nengo\",\"Urubyiruko\"]', 'P3', 'DAY', '2025-2026', '040030028', NULL, NULL, NULL, NULL, NULL, NULL),
(97, '040030029', 3, 'NIWEMUGENI', 'Isabelle', 'Female', 2004, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Ntengo', 'Urubyiruko', 'Bajeneza jean paul', '0788451571', NULL, 'Mukantagara verena', '0783801088', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269336,\"NIWEMUGENI\",\"Isabelle\",\"Female\",2004,\"Bajeneza jean paul\",788451571,\"\",\"Mukantagara verena\",783801088,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Ntengo\",\"Urubyiruko\"]', 'P3', 'DAY', '2025-2026', '040030029', NULL, NULL, NULL, NULL, NULL, NULL),
(98, '040030030', 3, 'NTWARI', 'Davis', 'Male', 2006, 'Rwandan', 'Kigali', 'Gasabo', 'Rusororo', NULL, NULL, 'NDATSIKIRA GILBERT', '0788550156', NULL, 'UWIMANA NATACHA', '0788623723', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Cell\",\"Village\"]', '[202526269340,\"NTWARI\",\"Davis\",\"Male\",2006,\"NDATSIKIRA GILBERT\",788550156,\"\",\"UWIMANA NATACHA\",788623723,\"\",\"Rwandan\",\"Kigali\",\"Gasabo\",\"Rusororo\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030030', NULL, NULL, NULL, NULL, NULL, NULL),
(99, '040030031', 3, 'NGIRABAKUNZI', 'Thierry', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736177668', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269388,\"NGIRABAKUNZI\",\"Thierry\",\"Male\",\"\",\"\",789387011,\"\",\"\",736177668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030031', NULL, NULL, NULL, NULL, NULL, NULL),
(100, '040030032', 3, 'NIZEYIMANA', 'Bertin', 'Male', 2006, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Cyabagarura', 'Gaturo', 'MUGIRANEZA Abrahum', '0788536153', NULL, 'MUTEGARUGORI Bernadette', '0789361318', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269392,\"NIZEYIMANA\",\"Bertin\",\"Male\",2006,\"MUGIRANEZA Abrahum\",788536153,\"\",\"MUTEGARUGORI Bernadette\",789361318,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Musanze\",\"Cyabagarura\",\"Gaturo\"]', 'P3', 'DAY', '2025-2026', '040030032', NULL, NULL, NULL, NULL, NULL, NULL),
(101, '040030033', 3, 'NIZEYIMENA', 'BERTIN', 'Male', 2005, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Cyabagarura', 'Bukane', 'MUGIRANEZA ABRAHAM', '0788536153', NULL, 'MUTEGARUGORI BERNADETTE', '0789361318', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[20252665816,\"NIZEYIMENA\",\"BERTIN\",\"M\",38358,\"MUGIRANEZA ABRAHAM\",788536153,\"\",\"MUTEGARUGORI BERNADETTE\",789361318,\"\",\"\",\"North\",\"Musanze\",\"Musanze\",\"Cyabagarura\",\"Bukane\"]', 'P3', 'DAY', '2025-2026', '040030033', NULL, NULL, NULL, NULL, NULL, NULL),
(102, '040030034', 3, 'UMURERWA', 'Agape', 'Female', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387012', NULL, NULL, NULL, NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269396,\"UMURERWA\",\"Agape\",\"Female\",\"\",\"\",789387012,\"\",\"\",7362376680,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P3', 'DAY', '2025-2026', '040030034', NULL, NULL, NULL, NULL, NULL, NULL),
(103, '040030035', 3, 'IMANISHIMWE', 'Xavio', 'Male', 2006, 'Rwandan', 'North', 'Musanze', 'Nyarubande', 'rwebeya', 'Nyarubande', 'BITONDERUBUSA Jean', '0788223827', NULL, 'MUKESHIMANA Beatha', '0785116318', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269368,\"IMANISHIMWE\",\"Xavio\",\"Male\",2006,\"BITONDERUBUSA Jean\",788223827,\"\",\"MUKESHIMANA Beatha\",785116318,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Nyarubande\",\"rwebeya\",\"Nyarubande\"]', 'P3', 'DAY', '2025-2026', '040030035', NULL, NULL, NULL, NULL, NULL, NULL),
(104, '040030036', 3, 'KANYANA', 'Kenia', 'Female', 2007, 'Rwandan', 'Kigali', 'kicukiro', 'Masaka', 'Kabuga', 'Kabeza', 'BIZIMANA Alphonse', '0789387011', 'bazimyaa@gmail.com', 'NYIRABEZA Perprtue', '0788258853', 'nyirabezaperpetua@gmail.com', '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269372,\"KANYANA\",\"Kenia\",\"Female\",2007,\"BIZIMANA Alphonse\",789387011,\"bazimyaa@gmail.com\",\"NYIRABEZA Perprtue\",788258853,\"nyirabezaperpetua@gmail.com\",\"Rwandan\",\"kigali city\",\"kicukiro\",\"Masaka\",\"Kabuga\",\"Kabeza\"]', 'P3', 'DAY', '2025-2026', '040030036', NULL, NULL, NULL, NULL, NULL, NULL),
(105, '040030037', 3, 'KANZIRA', 'Abigael', 'Female', 2005, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Mpenge', 'Gikwege', 'Matabaro Mporana Jonas', '0788539578', NULL, 'Nantebuka Anne', '0780321240', NULL, '2026-03-25 07:34:51', '2026-03-25 07:34:51', '[]', '[202526269376,\"KANZIRA\",\"Abigael\",\"Female\",2005,\"Matabaro Mporana Jonas\",788539578,\"\",\"Nantebuka Anne\",780321240,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Muhoza\",\"Mpenge\",\"Gikwege\"]', 'P3', 'DAY', '2025-2026', '040030037', NULL, NULL, NULL, NULL, NULL, NULL),
(106, '040030038', 3, 'IRADUKUNDA', 'Ange Pascaline', 'Female', 2007, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Ruhengeli', 'Burera', 'uwiragiye Clement', '0788823273', NULL, 'iyakaremye M. Faina', '0788478648', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526266468,\"IRADUKUNDA\",\"Ange Pascaline\",\"Female\",2007,\"uwiragiye Clement\",788823273,\"\",\"iyakaremye M. Faina\",788478648,\"\",\"Rwandan\",\"North\",\"Musanze\",\"Muhoza\",\"Ruhengeli\",\"Burera\"]', 'P6', 'DAY', '2025-2026', '040030038', NULL, NULL, NULL, NULL, NULL, NULL),
(107, '040030039', 3, 'MUGWANEZA', 'Iyabes', 'Female', 2004, 'Rwandan', 'South', 'NYANZA', 'KIGOMA', 'MURINJA', 'AKINTARE', 'BIZIMANA Jeadedie', '0722740517', NULL, 'NYICUMI Goltha', '0788275628', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269460,\"MUGWANEZA\",\"Iyabes\",\"Female\",2004,\"BIZIMANA Jeadedie\",722740517,\"\",\"NYICUMI Goltha\",788275628,\"\",\"Rwandan\",\"South\",\"NYANZA\",\"KIGOMA\",\"MURINJA\",\"AKINTARE\"]', 'P6', 'DAY', '2025-2026', '040030039', NULL, NULL, NULL, NULL, NULL, NULL),
(108, '040030040', 3, 'SHIMWA', 'Grace Graine', 'Female', 2007, 'Rwandan', 'Kigali', 'GASABO', 'JALI', NULL, NULL, 'CYPRIEN', '0783551793', NULL, 'PERPETURE', '0785131123', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Cell\",\"Village\"]', '[202526266476,\"SHIMWA\",\"Grace Graine\",\"FEMALE\",2007,\"CYPRIEN\",783551793,\"\",\"PERPETURE\",785131123,\"\",\"Rwandan\",\"KIGALI\",\"GASABO\",\"JALI\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030040', NULL, NULL, NULL, NULL, NULL, NULL),
(109, '040030041', 3, 'TUMUKUNDE', 'Linker', 'Female', 2008, 'Rwandan', 'Kigali', 'NYARUGENGE', 'KIGALI', 'RURIBA', NULL, 'ngamije', '0788457962', NULL, 'Gloria', '0788351921', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Village\"]', '[202526266480,\"TUMUKUNDE\",\"Linker\",\"Female\",2008,\"ngamije\",788457962,\"\",\"Gloria\",788351921,\"\",\"Rwandan\",\"KIGALI\",\"NYARUGENGE\",\"KIGALI\",\"RURIBA\",\"\"]', 'P6', 'DAY', '2025-2026', '040030041', NULL, NULL, NULL, NULL, NULL, NULL),
(110, '040030042', 3, 'UMUHOZA', 'Micheline', 'Female', 2005, 'Rwandan', 'North', 'Burera', 'kivuye', 'Bukwashuri', 'Buhita', 'Maniraguha micheli', '0789917958', NULL, 'Mukasafari marie luise', '0783162958', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526266488,\"UMUHOZA\",\"Micheline\",\"female\",2005,\"Maniraguha micheli\",789917958,\"\",\"Mukasafari marie luise\",783162958,\"\",\"Rwandan\",\"north\",\"Burera\",\"kivuye\",\"Bukwashuri\",\"Buhita\"]', 'P6', 'DAY', '2025-2026', '040030042', NULL, NULL, NULL, NULL, NULL, NULL),
(111, '040030043', 3, 'UWERA TUYISHIMIRE', 'Daniella', 'Female', 2006, 'Rwandan', 'North', 'Gakenke', 'Ruli', 'Gikingo', 'Rumasa', 'Nsanzimana Epa Phorodite', '0785700907', NULL, 'Uwera Mukareta Beatrice', '0785074193', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526266484,\"UWERA TUYISHIMIRE\",\"Daniella\",\"female\",2006,\"Nsanzimana Epa Phorodite\",785700907,\"\",\"Uwera Mukareta Beatrice\",785074193,\"\",\"Rwandan\",\"North\",\"Gakenke\",\"Ruli\",\"Gikingo\",\"Rumasa\"]', 'P6', 'DAY', '2025-2026', '040030043', NULL, NULL, NULL, NULL, NULL, NULL),
(112, '040030044', 3, 'UWIMANA', 'Marie Claire', 'Female', 2006, 'Rwandan', 'Kigali', 'kicukiro', 'NYARUGUNGA', 'kamashashi', 'uruhongore', NULL, NULL, NULL, 'UMWALI ROSE', '0798600056', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526266492,\"UWIMANA\",\"Marie Claire\",\"female\",2006,\"\",\"\",\"\",\"UMWALI ROSE\",798600056,\"\",\"Rwandan\",\"kigali\",\"kicukiro\",\"NYARUGUNGA\",\"kamashashi\",\"uruhongore\"]', 'P6', 'DAY', '2025-2026', '040030044', NULL, NULL, NULL, NULL, NULL, NULL),
(113, '040030045', 3, 'Cadette', 'Sandrine', 'Female', 2005, 'Rwandan', 'East', 'Bugesera', 'Mayange', 'Kabeza', 'Kibirizi', 'Twagirimana Theoneste', '0788633129', NULL, 'Tugirumurinda Therese', '0783088593', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269272,\"Cadette\",\"Sandrine\",\"Female\",2005,\"Twagirimana Theoneste\",788633129,\"\",\"Tugirumurinda Therese\",783088593,\"\",\"Rwandan\",\"Eastern\",\"Bugesera\",\"Mayange\",\"Kabeza\",\"Kibirizi\"]', 'P6', 'DAY', '2025-2026', '040030045', NULL, NULL, NULL, NULL, NULL, NULL),
(114, '040030046', 3, 'HIRWA UMUNYANA', 'Benita', 'Female', 2007, 'Rwandan', 'Kigali', 'Kicukiro', 'Kanombe', 'Rubirizi', 'Beninka', 'Twahirwa Theogene', '0782466295', 'tteo104@gmail.com', 'Niyonambaza Aline', '0788559621', 'niyonambaaline@', '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269276,\"HIRWA UMUNYANA\",\"Benita\",\"Female\",2007,\"Twahirwa Theogene\",782466295,\"tteo104@gmail.com\",\"Niyonambaza Aline\",788559621,\"niyonambaaline@\",\"Rwandan\",\"Kigali city\",\"Kicukiro\",\"Kanombe\",\"Rubirizi\",\"Beninka\"]', 'P6', 'DAY', '2025-2026', '040030046', NULL, NULL, NULL, NULL, NULL, NULL),
(115, '040030047', 3, 'MUSHIMIYIMANA', 'Jimmy', 'Male', 2008, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Kivumu', 'Ubukerarugendo', 'Mporwiki narcise', '0785719204', NULL, 'Uzamukunda Cartas', '0790027126', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269280,\"MUSHIMIYIMANA\",\"Jimmy\",\"Male\",2008,\"Mporwiki narcise\",785719204,\"\",\"Uzamukunda Cartas\",790027126,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Kivumu\",\"Ubukerarugendo\"]', 'P6', 'DAY', '2025-2026', '040030047', NULL, NULL, NULL, NULL, NULL, NULL),
(116, '040030048', 3, 'NIYOGISUBIZO', 'Gaston', 'Male', 2005, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Rwambogo', 'gakoro', 'HAKIZIMANA Anastase', '0783552273', NULL, 'NIYONSABA Emmaculee\'', '0782539558', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269284,\"NIYOGISUBIZO\",\"Gaston\",\"male\",2005,\"HAKIZIMANA Anastase\",783552273,\"\",\"NIYONSABA Emmaculee\'\",782539558,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Musanze\",\"Rwambogo\",\"gakoro\"]', 'P6', 'DAY', '2025-2026', '040030048', NULL, NULL, NULL, NULL, NULL, NULL),
(117, '040030049', 3, 'MURANGIRA', 'Adiru', 'Male', 2007, 'Rwandan', 'Kigali', 'kicukiro', 'kicukiro', 'kicukiro', 'Rwinanka', 'Murangira Fazil', '0788784098', NULL, 'Mukase Chadia', '0788784098', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269356,\"MURANGIRA\",\"Adiru\",\"Male\",2007,\"Murangira Fazil\",788784098,\"\",\"Mukase Chadia\",788784098,\"\",\"Rwandan\",\"Kigali city\",\"kicukiro\",\"kicukiro\",\"kicukiro\",\"Rwinanka\"]', 'P6', 'DAY', '2025-2026', '040030049', NULL, NULL, NULL, NULL, NULL, NULL),
(118, '040030050', 3, 'SHEMA', 'Charles', 'Male', 2007, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Amataba', 'bugoyi', 'Gasana damascene', '0788558382', NULL, 'Mukashyaka ngabo', '0788265818', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269360,\"SHEMA\",\"Charles\",\"Male\",2007,\"Gasana damascene\",788558382,\"\",\"Mukashyaka ngabo\",788265818,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Amataba\",\"bugoyi\"]', 'P6', 'DAY', '2025-2026', '040030050', NULL, NULL, NULL, NULL, NULL, NULL),
(119, '040030051', 3, 'ISANGE', 'Placide', 'Male', 2008, 'Rwandan', 'North', 'Burera', 'cyanika', 'nkiliza', 'cyidaho', 'NDABANANIYE Janvier', '0788424789', NULL, 'NDIMUBANDI Emmeraude', '0788606955', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269288,\"ISANGE\",\"Placide\",\"Male\",2008,\"NDABANANIYE Janvier\",788424789,\"\",\"NDIMUBANDI Emmeraude\",788606955,\"\",\"Rwandan\",\"Northern\",\"Burera\",\"cyanika\",\"nkiliza\",\"cyidaho\"]', 'P6', 'DAY', '2025-2026', '040030051', NULL, NULL, NULL, NULL, NULL, NULL),
(120, '040030052', 3, 'Mugisha', 'Kenny Frank', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736137668', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269292,\"Mugisha\",\"Kenny Frank\",\"Male\",\"\",\"\",789387011,\"\",\"\",736137668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030052', NULL, NULL, NULL, NULL, NULL, NULL),
(121, '040030053', 3, 'DUSENGIMANA', 'Olivier', 'Male', 2005, 'Rwandan', 'North', 'Burera', 'kinoni', 'nkenke', 'kigina', 'Turinumukiza john', '0789387012', 'olivierdusengimana31@gmail.com', 'nyirantungane candide', '0736276680', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269304,\"DUSENGIMANA\",\"Olivier\",\"Male\",2005,\"Turinumukiza john\",789387012,\"olivierdusengimana31@gmail.com\",\"nyirantungane candide\",736276680,\"\",\"Rwandan\",\"Northern\",\"Burera\",\"kinoni\",\"nkenke\",\"kigina\"]', 'P6', 'DAY', '2025-2026', '040030053', NULL, NULL, NULL, NULL, NULL, NULL),
(122, '040030054', 3, 'MUGISHA', 'Obed', 'Male', 2005, 'Rwandan', NULL, NULL, NULL, NULL, NULL, 'Gatera Pascal', NULL, NULL, 'Mukamurigo illumine', '0788411306', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269308,\"MUGISHA\",\"Obed\",\"Male\",2005,\"Gatera Pascal\",\"\",\"\",\"Mukamurigo illumine\",788411306,\"\",\"Rwandan\",\"\",\"\",\"\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030054', NULL, NULL, NULL, NULL, NULL, NULL),
(123, '040030055', 3, 'URAYENEZA', 'Nabil Saidi', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387012', NULL, NULL, NULL, NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269312,\"URAYENEZA\",\"Nabil Saidi\",\"Male\",\"\",\"\",789387012,\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030055', NULL, NULL, NULL, NULL, NULL, NULL),
(124, '040030056', 3, 'IYAKARE KALINDA', 'Liza', 'Female', 2006, 'Rwandan', 'Kigali', 'Gasabo', 'Kibagabaga', 'Kibagabaga', NULL, 'KALINDA Heritier', '0788617976', NULL, 'MUKASHYAKA Marie Claire', '0788759262', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Village\"]', '[202526269316,\"IYAKARE KALINDA\",\"Liza\",\"Female\",2006,\"KALINDA Heritier\",788617976,\"\",\"MUKASHYAKA Marie Claire\",788759262,\"\",\"Rwandan\",\"kigali city\",\"Gasabo\",\"Kibagabaga\",\"Kibagabaga\",\"\"]', 'P6', 'DAY', '2025-2026', '040030056', NULL, NULL, NULL, NULL, NULL, NULL),
(125, '040030057', 3, 'JABO MAKOMA', 'Rock', 'Male', 2008, 'Rwandan', 'Kigali', 'kicukiro', 'Nyarugunga', NULL, NULL, 'NOHELI Sam', '0788635907', 'sambensolo@gmail.com', 'TUYIZERE Petronille', '0736107668', 'tuyipety@gmail.com', '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Cell\",\"Village\"]', '[202526269320,\"JABO MAKOMA\",\"Rock\",\"Male\",2008,\"NOHELI Sam\",788635907,\"sambensolo@gmail.com\",\"TUYIZERE Petronille\",736107668,\"tuyipety@gmail.com\",\"Rwandan\",\"kigali city\",\"kicukiro\",\"Nyarugunga\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030057', NULL, NULL, NULL, NULL, NULL, NULL),
(126, '040030058', 3, 'KWIZERA NTWARI', 'Jyvan', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736107668', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269324,\"KWIZERA NTWARI\",\"Jyvan\",\"Male\",\"\",\"\",789387011,\"\",\"\",736107668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030058', NULL, NULL, NULL, NULL, NULL, NULL),
(127, '040030059', 3, 'MANZI', 'Benjamin', 'Male', 2008, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Ruhengeri', 'Muhe', 'MUNYANEZA Methode', '0785582700', NULL, 'MUTAMURIZA Liberatha', '0788415830', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269328,\"MANZI\",\"Benjamin\",\"Male\",2008,\"MUNYANEZA Methode\",785582700,\"\",\"MUTAMURIZA Liberatha\",788415830,\"\",\"Rwandan\",\"Nothern\",\"Musanze\",\"Muhoza\",\"Ruhengeri\",\"Muhe\"]', 'P6', 'DAY', '2025-2026', '040030059', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `students` (`id`, `student_uid`, `school_id`, `first_name`, `last_name`, `gender`, `birth_year`, `nationality`, `province`, `district`, `sector`, `cell`, `village`, `father_full_name`, `father_phone`, `father_email`, `mother_full_name`, `mother_phone`, `mother_email`, `created_at`, `updated_at`, `import_missing_fields`, `source_row_json`, `class_name`, `residency_status`, `academic_year`, `student_code`, `sdm_code`, `student_photo`, `rfid_uid`, `fingerprint_id`, `identity_remarks`, `class_id`) VALUES
(128, '040030060', 3, 'MAOMBI', 'Patrick', 'Male', 2005, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Kivumu', 'Urumuri', 'Mbanziriza Aphrodis', '0788668288', NULL, 'Murekatete Meghan', '0783708041', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269332,\"MAOMBI\",\"Patrick\",\"Male\",2005,\"Mbanziriza Aphrodis\",788668288,\"\",\"Murekatete Meghan\",783708041,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Kivumu\",\"Urumuri\"]', 'P6', 'DAY', '2025-2026', '040030060', NULL, NULL, NULL, NULL, NULL, NULL),
(129, '040030061', 3, 'NIWEMUGENI', 'ISABELLE', 'Female', 2002, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Nengo', 'Urubyiruko', 'BAJENEZA JEAN PAUL', '0788451571', NULL, 'MUKABAGARA VEREN', '0783801088', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[20252666796,\"NIWEMUGENI\",\"ISABELLE\",\"F\",37338,\"BAJENEZA JEAN PAUL\",788451571,\"\",\"MUKABAGARA VEREN\",783801088,\"\",\"\",\"West\",\"Rubavu\",\"Gisenyi\",\"Nengo\",\"Urubyiruko\"]', 'P6', 'DAY', '2025-2026', '040030061', NULL, NULL, NULL, NULL, NULL, NULL),
(130, '040030062', 3, 'NIWEMUGENI', 'Isabelle', 'Female', 2004, 'Rwandan', 'West', 'Rubavu', 'Gisenyi', 'Ntengo', 'Urubyiruko', 'Bajeneza jean paul', '0788451571', NULL, 'Mukantagara verena', '0783801088', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269336,\"NIWEMUGENI\",\"Isabelle\",\"Female\",2004,\"Bajeneza jean paul\",788451571,\"\",\"Mukantagara verena\",783801088,\"\",\"Rwandan\",\"Western\",\"Rubavu\",\"Gisenyi\",\"Ntengo\",\"Urubyiruko\"]', 'P6', 'DAY', '2025-2026', '040030062', NULL, NULL, NULL, NULL, NULL, NULL),
(131, '040030063', 3, 'NTWARI', 'Davis', 'Male', 2006, 'Rwandan', 'Kigali', 'Gasabo', 'Rusororo', NULL, NULL, 'NDATSIKIRA GILBERT', '0788550156', NULL, 'UWIMANA NATACHA', '0788623723', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Cell\",\"Village\"]', '[202526269340,\"NTWARI\",\"Davis\",\"Male\",2006,\"NDATSIKIRA GILBERT\",788550156,\"\",\"UWIMANA NATACHA\",788623723,\"\",\"Rwandan\",\"Kigali\",\"Gasabo\",\"Rusororo\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030063', NULL, NULL, NULL, NULL, NULL, NULL),
(132, '040030064', 3, 'NGIRABAKUNZI', 'Thierry', 'Male', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387011', NULL, NULL, '0736177668', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269388,\"NGIRABAKUNZI\",\"Thierry\",\"Male\",\"\",\"\",789387011,\"\",\"\",736177668,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030064', NULL, NULL, NULL, NULL, NULL, NULL),
(133, '040030065', 3, 'NIZEYIMANA', 'Bertin', 'Male', 2006, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Cyabagarura', 'Gaturo', 'MUGIRANEZA Abrahum', '0788536153', NULL, 'MUTEGARUGORI Bernadette', '0789361318', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269392,\"NIZEYIMANA\",\"Bertin\",\"Male\",2006,\"MUGIRANEZA Abrahum\",788536153,\"\",\"MUTEGARUGORI Bernadette\",789361318,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Musanze\",\"Cyabagarura\",\"Gaturo\"]', 'P6', 'DAY', '2025-2026', '040030065', NULL, NULL, NULL, NULL, NULL, NULL),
(134, '040030066', 3, 'NIZEYIMENA', 'BERTIN', 'Male', 2005, 'Rwandan', 'North', 'Musanze', 'Musanze', 'Cyabagarura', 'Bukane', 'MUGIRANEZA ABRAHAM', '0788536153', NULL, 'MUTEGARUGORI BERNADETTE', '0789361318', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[20252665816,\"NIZEYIMENA\",\"BERTIN\",\"M\",38358,\"MUGIRANEZA ABRAHAM\",788536153,\"\",\"MUTEGARUGORI BERNADETTE\",789361318,\"\",\"\",\"North\",\"Musanze\",\"Musanze\",\"Cyabagarura\",\"Bukane\"]', 'P6', 'DAY', '2025-2026', '040030066', NULL, NULL, NULL, NULL, NULL, NULL),
(135, '040030067', 3, 'UMURERWA', 'Agape', 'Female', NULL, 'Rwandan', NULL, NULL, NULL, NULL, NULL, NULL, '0789387012', NULL, NULL, NULL, NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[\"Province\",\"District\",\"Sector\",\"Cell\",\"Village\"]', '[202526269396,\"UMURERWA\",\"Agape\",\"Female\",\"\",\"\",789387012,\"\",\"\",7362376680,\"\",\"\",\"\",\"\",\"\",\"\",\"\"]', 'P6', 'DAY', '2025-2026', '040030067', NULL, NULL, NULL, NULL, NULL, NULL),
(136, '040030068', 3, 'IMANISHIMWE', 'Xavio', 'Male', 2006, 'Rwandan', 'North', 'Musanze', 'Nyarubande', 'rwebeya', 'Nyarubande', 'BITONDERUBUSA Jean', '0788223827', NULL, 'MUKESHIMANA Beatha', '0785116318', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269368,\"IMANISHIMWE\",\"Xavio\",\"Male\",2006,\"BITONDERUBUSA Jean\",788223827,\"\",\"MUKESHIMANA Beatha\",785116318,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Nyarubande\",\"rwebeya\",\"Nyarubande\"]', 'P6', 'DAY', '2025-2026', '040030068', NULL, NULL, NULL, NULL, NULL, NULL),
(137, '040030069', 3, 'KANYANA', 'Kenia', 'Female', 2007, 'Rwandan', 'Kigali', 'kicukiro', 'Masaka', 'Kabuga', 'Kabeza', 'BIZIMANA Alphonse', '0789387011', 'bazimyaa@gmail.com', 'NYIRABEZA Perprtue', '0788258853', 'nyirabezaperpetua@gmail.com', '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269372,\"KANYANA\",\"Kenia\",\"Female\",2007,\"BIZIMANA Alphonse\",789387011,\"bazimyaa@gmail.com\",\"NYIRABEZA Perprtue\",788258853,\"nyirabezaperpetua@gmail.com\",\"Rwandan\",\"kigali city\",\"kicukiro\",\"Masaka\",\"Kabuga\",\"Kabeza\"]', 'P6', 'DAY', '2025-2026', '040030069', NULL, NULL, NULL, NULL, NULL, NULL),
(138, '040030070', 3, 'KANZIRA', 'Abigael', 'Female', 2005, 'Rwandan', 'North', 'Musanze', 'Muhoza', 'Mpenge', 'Gikwege', 'Matabaro Mporana Jonas', '0788539578', NULL, 'Nantebuka Anne', '0780321240', NULL, '2026-03-25 12:23:35', '2026-03-25 12:23:35', '[]', '[202526269376,\"KANZIRA\",\"Abigael\",\"Female\",2005,\"Matabaro Mporana Jonas\",788539578,\"\",\"Nantebuka Anne\",780321240,\"\",\"Rwandan\",\"Northern\",\"Musanze\",\"Muhoza\",\"Mpenge\",\"Gikwege\"]', 'P6', 'DAY', '2025-2026', '040030070', NULL, NULL, NULL, NULL, NULL, NULL),
(139, '040060001', 6, 'CYIZA', 'Robert', 'Male', 2013, 'Rwandan', 'Eastern Province', 'Kayonza', 'Rukara', 'Rwimishinya', 'Karagari I', 'KARISA Claude', '0793245365', NULL, 'MUGENI Anisa', '0785463765', NULL, '2026-03-25 13:04:27', '2026-03-25 13:04:27', NULL, NULL, 'P6', 'DAY', '2025-2026', '040060001', NULL, NULL, NULL, NULL, NULL, NULL),
(140, '040030071', 3, 'Maneza', 'Alice', 'Female', 2005, 'Rwandan', 'Southern Province', 'Gisagara', 'Ndora', 'Bweya', 'Mirayi', 'BUGINGO Yvan', '0796580991', NULL, NULL, NULL, NULL, '2026-03-27 13:21:20', '2026-03-27 13:30:03', NULL, NULL, 'P4', 'DAY', '2025-2026', '040030071', NULL, NULL, NULL, NULL, NULL, NULL),
(141, '040030072', 3, 'Cyizere', 'Leo', 'Male', NULL, 'Rwandan', 'Kigali City', 'Gasabo', 'Kimihurura', 'Rugando', 'Rugando I', NULL, '0780428835', NULL, NULL, '0791393175', NULL, '2026-03-28 14:52:03', '2026-03-28 14:52:03', NULL, NULL, 'P1', 'DAY', '2025-2026', '040030072', NULL, NULL, NULL, NULL, NULL, NULL),
(142, '040030073', 3, 'John', 'Doe', 'Male', NULL, 'Rwandan', 'Kigali City', 'Gasabo', 'Kimihurura', 'Rugando', 'Rugando I', NULL, '0780428835', NULL, NULL, '0791393175', NULL, '2026-03-29 14:49:09', '2026-03-29 14:49:09', NULL, NULL, 'P1', 'DAY', '2025-2026', '040030073', NULL, NULL, NULL, NULL, NULL, NULL),
(163, '202599900001', 11, 'Amina', 'Mugisha', 'Female', 2007, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Amina', '0725419202', 'parent_1_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(164, '202599900002', 11, 'Chloe', 'Uwase', 'Male', 2008, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Chloe', '0744544838', 'parent_2_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(165, '202599900003', 11, 'Daniel', 'Nkurunziza', 'Female', 2009, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Daniel', '0764585964', 'parent_3_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(166, '202599900004', 11, 'Diane', 'Habimana', 'Male', 2010, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Diane', '0752531632', 'parent_4_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(167, '202599900005', 11, 'Emmanuel', 'Iradukunda', 'Female', 2006, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Emmanuel', '0737199240', 'parent_5_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(168, '202599900006', 11, 'Fatima', 'Kamana', 'Male', 2007, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Fatima', '0738411132', 'parent_6_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(169, '202599900007', 11, 'Grace', 'Ntirenganya', 'Female', 2008, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Grace', '0748028638', 'parent_7_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(170, '202599900008', 11, 'Ivan', 'Uwineza', 'Male', 2009, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Ivan', '0756260928', 'parent_8_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(171, '202599900009', 11, 'Jean', 'Bizimana', 'Female', 2010, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Jean', '0742283534', 'parent_9_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(172, '202599900010', 11, 'Kevin', 'Gakwaya', 'Male', 2006, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Kevin', '0768673234', 'parent_10_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 3A', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(173, '202599900011', 11, 'Liliane', 'Hirwa', 'Female', 2007, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Liliane', '0766658883', 'parent_11_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(174, '202599900012', 11, 'Manon', 'Ingabire', 'Male', 2008, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Manon', '0736959371', 'parent_12_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(175, '202599900013', 11, 'Noel', 'Juru', 'Female', 2009, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Noel', '0722742214', 'parent_13_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(176, '202599900014', 11, 'Olivia', 'Kayitesi', 'Male', 2010, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Olivia', '0756851526', 'parent_14_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(177, '202599900015', 11, 'Patrick', 'Muhoza', 'Female', 2006, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Patrick', '0736356127', 'parent_15_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(178, '202599900016', 11, 'Queen', 'Neza', 'Male', 2007, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Queen', '0726953530', 'parent_16_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(179, '202599900017', 11, 'Richard', 'Onyango', 'Female', 2008, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Richard', '0765185137', 'parent_17_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(180, '202599900018', 11, 'Sandra', 'Rukundo', 'Male', 2009, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Sandra', '0746030667', 'parent_18_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(181, '202599900019', 11, 'Thomas', 'Sibomana', 'Female', 2010, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Thomas', '0758767885', 'parent_19_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(182, '202599900020', 11, 'Uwimana', 'Tuyishime', 'Male', 2006, 'Rwandan', 'Kigali City', 'Kicukiro', 'Niboye', NULL, NULL, 'Parent of Uwimana', '0728098630', 'parent_20_999@seed.local', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-08 12:42:16', NULL, NULL, 'Senior 5 Sci', 'DAY', '2025-2026', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(183, 'ST843341173', 11, 'Chantal', 'Umutoni', 'Female', 2007, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 1', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 368),
(184, 'ST281356311', 11, 'Chantal', 'Ishimwe', 'Male', 2008, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 2', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 374),
(185, 'ST776611896', 11, 'Aline', 'Mugisha', 'Male', 2010, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 3', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 371),
(186, 'ST631287982', 11, 'Divine', 'Ishimwe', 'Male', 2010, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 4', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 366),
(187, 'ST224274280', 11, 'Eric', 'Ishimwe', 'Male', 2011, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 5', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 372),
(188, 'ST345089192', 11, 'Chantal', 'Gasana', 'Male', 2005, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 6', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 372),
(189, 'ST21458840', 11, 'Bosco', 'Ishimwe', 'Female', 2007, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 7', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 377),
(190, 'ST950090002', 11, 'Divine', 'Habimana', 'Female', 2012, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 8', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 372),
(191, 'ST775018135', 11, 'Marie', 'Niyonzima', 'Female', 2012, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 9', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 364),
(192, 'ST120052427', 11, 'Aline', 'Umutoni', 'Female', 2012, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 10', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 363),
(193, 'ST895040575', 11, 'Jean', 'Umutoni', 'Male', 2012, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 11', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 375),
(194, 'ST82547847', 11, 'Solange', 'Mugisha', 'Male', 2014, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 12', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 368),
(195, 'ST723192100', 11, 'Marie', 'Ishimwe', 'Female', 2011, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 13', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 363),
(196, 'ST814457249', 11, 'Chantal', 'Habimana', 'Male', 2008, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 14', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 363),
(197, 'ST142608340', 11, 'Solange', 'Mugisha', 'Male', 2009, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 15', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 364),
(198, 'ST957734981', 11, 'Aline', 'Gasana', 'Female', 2006, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 16', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 373),
(199, 'ST125394791', 11, 'Chantal', 'Gasana', 'Female', 2012, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 17', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 364),
(200, 'ST76196146', 11, 'Samuel', 'Habimana', 'Male', 2007, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 18', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 373),
(201, 'ST271569227', 11, 'Bosco', 'Habimana', 'Female', 2007, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 19', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 373),
(202, 'ST696485640', 11, 'Bosco', 'Tuyisenge', 'Female', 2005, NULL, 'Kigali City', 'Gasabo', 'Kimironko', 'Bibare', 'Village 20', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 10:14:21', '2026-04-10 10:14:21', NULL, NULL, NULL, 'DAY', '2024', NULL, NULL, NULL, NULL, NULL, NULL, 373),
(203, '129990001', 11, 'yakin', 'nsanzumuhire', 'Male', 2010, 'Rwandan', 'Kigali City', 'Nyarugenge', 'Nyamirambo', 'Cyivugiza', 'Muhabura', 'uzabakiriho isaac', '0783880984', 'uzabakirihoisaac@gmail.com', 'mukantabana petronile', '0780332216', 'petronile@gmail.com', '2026-04-10 12:16:02', '2026-04-10 12:16:02', NULL, NULL, 'S4 A PCB', 'DAY', NULL, '129990001', NULL, NULL, NULL, NULL, NULL, 373);
...
INSERT INTO `student_permissions` (`id`, `school_id`, `student_id`, `starts_at`, `ends_at`, `reason`, `permission_type`, `status`, `requested_by_user_id`, `approved_by_user_id`, `created_at`, `updated_at`) VALUES
(1, 11, 163, '2026-04-02 01:55:00', '2026-04-14 01:55:00', NULL, 'MEDICAL', 'APPROVED', 59, 59, '2026-04-13 01:55:29', '2026-04-13 01:55:29');
...
--
-- Table structure for table `teacher_ai_logs`
--

CREATE TABLE `teacher_ai_logs` (
  `id` int(10) UNSIGNED NOT NULL,
  `teacher_user_id` int(10) UNSIGNED NOT NULL,
  `prompt` text NOT NULL,
  `response` text NOT NULL,
  `context_tag` varchar(100) DEFAULT NULL COMMENT 'e.g., lesson_planning, translation',
...
--
-- Table structure for table `teacher_loan_requests`
--

CREATE TABLE `teacher_loan_requests` (
  `id` int(10) UNSIGNED NOT NULL,
  `teacher_user_id` int(10) UNSIGNED NOT NULL,
  `amount_requested` decimal(12,2) NOT NULL DEFAULT 0.00,
  `purpose` varchar(300) DEFAULT NULL,
  `repayment_term_months` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
  `status` enum('pending','reviewed','approved','disbursed','rejected','cancelled') NOT NULL DEFAULT 'pending',
...
--
-- Table structure for table `teacher_services`
--
...
CREATE TABLE `teacher_services` (
  ...
  `service_code` varchar(64) NOT NULL,
  `name` varchar(255) NOT NULL,
  `type` enum('financial','professional','welfare','other') NOT NULL DEFAULT 'financial',
  `description` text DEFAULT NULL,
  `icon_url` varchar(512) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
...
--
-- Dumping data for table `teacher_services`
--

INSERT INTO `teacher_services` (`id`, `service_code`, `name`, `type`, `description`, `icon_url`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'SHULE_AVANCE', 'ShuleAvance', 'financial', 'A professional loan service specifically for Rwandan teachers.', '/icons/shuleavance.png', 1, '2026-04-06 12:55:05', '2026-04-06 12:55:05'),
(2, 'TICHA_AI', 'TichaAI', 'professional', 'A smart GPT-based AI for lesson planning and academic support.', '/icons/tichaai.png', 1, '2026-04-06 12:55:05', '2026-04-06 12:55:05'),
(3, 'ENGLISH_CLUB', 'English Club', 'professional', 'Collaborative community for English language proficiency and resources.', '/icons/englishclub.png', 1, '2026-04-06 12:55:05', '2026-04-06 12:55:05');
...
(1, 'SA-706896305', 'ishimwetheo488@gmail.com', NULL, '+250798699601', '$2b$10$HBOIRb/fyVghQrzqSpIeIeFrcXRLfM3WI/zVKJgvD2b2ni6S0wyG2', 'Ishimwe', 'Theoneste', NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-03-28 22:07:17', '::1', NULL, NULL, NULL, '2026-03-06 06:18:26', '2026-03-28 22:07:17', NULL, NULL),
...
(12, 'SM-618177009', 'kacyiru@gmail.com', 'kacyiru', NULL, '$2b$12$vhSF6CwiebGhGsXc39vvIeq5qLsIs6EyR.XcKGCte8ZmdVO7C.H/u', 'Ishimwe', 'Theoneste', NULL, NULL, 2, 9, 'Gasabo', 'Kigali City', 'Kacyiru', 1, 1, 0, NULL, 0, 1, '2026-03-17 22:52:11', '::1', NULL, NULL, NULL, '2026-03-17 22:50:18', '2026-03-28 21:47:26', NULL, NULL),
...
(14, 'SM-722345717', 'kinyinya@gmail.com', 'kinyinya', NULL, '$2b$12$P3PL60b3U6/m6H03pZ0/TeOsOFJJEvLe01XQuWJs7eoAV/YL3IOX.', 'Jeal', 'Paul Habineza', NULL, '/uploads/school_assets/school_11_asset_1773812289515.png', 2, 11, 'Gasabo', 'Kigali City', 'Kinyinya', 1, 1, 0, NULL, 0, 1, '2026-03-18 07:35:10', '::1', NULL, NULL, NULL, '2026-03-17 23:25:22', '2026-03-28 21:47:26', NULL, NULL),
...
(28, 'SM-947204499', 'ishimwetheonest937@gmail.com', 'ishimwetheonest937_sm3', NULL, '$2b$10$Y1XneVm/DqTlCKKQSOPAKeQysb57phsflZMVQZcDmFifTOH8aFuVi', 'UWAMAHORO', 'Claudine', NULL, NULL, 2, 3, 'Gasabo', 'Kigali City', 'Remera', 1, 1, 0, NULL, 0, 0, '2026-04-08 11:21:31', '::1', NULL, NULL, NULL, '2026-03-22 19:35:47', '2026-04-08 11:21:31', NULL, NULL),
...
(31, 'ST-663298971', 'notredanedos@gmail.com', 'notredanedos', '0798675654', '$2b$12$6Cp4w53HliJnveiOKjpK.eqr7fv1vOScJdNXvNA0E3hLoruvWFhsa', 'JEAN', 'UWIRINGIYIMANA', NULL, NULL, 11, 3, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-08 09:54:24', '::1', NULL, NULL, NULL, '2026-03-25 12:14:23', '2026-04-08 09:54:24', NULL, NULL),
...
(34, 'T-1001', 'teacher@babyeyi.com', NULL, NULL, '$2a$10$zKoIT0YkVbf0bod8MpfvOuqQDaBQ9cLf9vs7r78RHtjB3fq9hsDXq', 'Main', 'Test', NULL, NULL, 4, 3, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-14 06:32:58', '::1', NULL, NULL, NULL, '2026-04-05 16:51:04', '2026-04-14 06:32:58', NULL, NULL),
(36, 'T-1002', 'jean.paul@gskimironko.rw', NULL, NULL, '$2a$10$zKoIT0YkVbf0bod8MpfvOuqQDaBQ9cLf9vs7r78RHtjB3fq9hsDXq', 'Jean', 'Paul', NULL, NULL, 4, 1, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '2026-04-05 17:05:29', '2026-04-06 19:29:32', NULL, NULL),
(37, 'T-1003', 'alice.mutoni@sana.rw', NULL, NULL, '$2a$10$zKoIT0YkVbf0bod8MpfvOuqQDaBQ9cLf9vs7r78RHtjB3fq9hsDXq', 'Alice', 'Mutoni', NULL, NULL, 4, 6, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '2026-04-05 17:05:29', '2026-04-06 19:29:32', NULL, NULL),
(38, 'T-1004', 'claude.haguma@apaper.rw', NULL, NULL, '$2a$10$zKoIT0YkVbf0bod8MpfvOuqQDaBQ9cLf9vs7r78RHtjB3fq9hsDXq', 'Claude', 'Haguma', NULL, NULL, 4, 8, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '2026-04-05 17:05:29', '2026-04-06 19:29:32', NULL, NULL),
(55, 'SC-934616676', 'manager_999@seed.local', 'manager_999', NULL, '$2b$10$nW4AUdM7GufidBVmd0fK9.4WewWdcqZHhOdaWMOP8OAz0xl/NKlY.', 'School', 'Manager', NULL, NULL, 2, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-16 09:20:45', '::1', NULL, NULL, NULL, '2026-04-08 12:42:14', '2026-04-16 09:20:45', NULL, NULL),
(56, 'DO-934770612', 'dos_999@seed.local', 'dos_999', NULL, '$2b$10$7v.nMRNluFfXjzkBdUF.yehSceEdkzTN2G5kdobikbDGrKkLN4TNq', 'Director', 'Studies', NULL, NULL, 11, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-14 02:03:22', '::1', NULL, NULL, NULL, '2026-04-08 12:42:14', '2026-04-14 02:03:22', NULL, NULL),
(57, 'TE-935408799', 'teacher_999@seed.local', 'teacher_999', NULL, '$2b$10$gxWrUvY3kajIsEtgZplpdesFPeVojBQ3YdXM8icsNQ87A6dP3w8T6', 'Alice', 'Uwase', NULL, NULL, 4, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-16 08:57:45', '::1', NULL, NULL, NULL, '2026-04-08 12:42:15', '2026-04-16 08:57:45', NULL, NULL),
(58, 'TE-936076638', 'teacher2_999@seed.local', 'teacher2_999', NULL, '$2b$10$VWAJd4AhqUQhgWxPdrZkf.EHj5dNd1zB/9TKxij.LU6rMQRakYda.', 'Bob', 'Mugisha', NULL, NULL, 4, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-14 09:39:53', '::1', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-14 09:39:53', NULL, NULL),
(59, 'HO-936224327', 'hod_999@seed.local', 'hod_999', NULL, '$2b$10$eYAE1VIl6rIxvfmh.cLrR.T.e5KITVDYMKEuZknq0UUJ6H5.azDJe', 'Head', 'Department', NULL, NULL, 3, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-14 07:05:28', '::1', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-14 07:05:28', NULL, NULL),
(60, 'AC-936492665', 'accountant_999@seed.local', 'accountant_999', NULL, '$2b$10$KvQg.4UhG0Jzsa/gCiG4yeCCgcVwrsLWQMJRHcaIhzTsM2nc96kHu', 'Finance', 'Officer', NULL, NULL, 8, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, '2026-04-15 16:43:51', '::1', NULL, NULL, NULL, '2026-04-08 12:42:16', '2026-04-15 16:43:51', NULL, NULL),
(61, 'ST-318152747', 'lanari.rw@gmail.com', 'hozanadusabimana', '0791724884', '$2b$12$C0vo08C.i34tiDGrPCuox.sKv87of0ZmuvUzekLUK0EamRn9kcDQG', 'Hozana', 'Dusabimana', '/uploads/staff-photos/staff-1775829659239-ba68ba05421d.png', NULL, 4, 11, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 1, '2026-04-10 09:38:42', '::1', NULL, NULL, NULL, '2026-04-10 08:41:58', '2026-04-10 16:00:59', NULL, NULL),
(62, 'ST-TEST001', 'test.teacher@test.local', 'test.teacher', NULL, '$2b$12$Viqw44Q2Pkt/Jh5UNM82xOD.Qwx1m3X5aKzb/svsFfkq/OGiEwbpe', 'Test', 'Teacher', NULL, NULL, 4, 1, NULL, NULL, NULL, 1, 1, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '2026-04-10 08:59:27', '2026-04-10 08:59:27', NULL, NULL);
...
ALTER TABLE `attendance_events`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_event_school` (`school_id`);
...
--
-- Indexes for table `biometric_logs_raw`
--
ALTER TABLE `biometric_logs_raw`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_raw_school_rfid` (`school_id`,`rfid_uid`),
  ADD KEY `idx_raw_processed` (`is_processed`);

--
-- Indexes for table `class_subject_configuration`
--
ALTER TABLE `class_subject_configuration`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_class_subject` (`school_id`,`class_name`,`subject_id`),
  ADD KEY `idx_class_config` (`school_id`,`class_name`);
...
ALTER TABLE `daily_attendance_summary`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_person_date` (`school_id`,`person_id`,`person_type`,`attendance_date`),
  ADD KEY `idx_date_school` (`school_id`,`attendance_date`);
...
--
-- Indexes for table `english_club_resources`
--
ALTER TABLE `english_club_resources`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `school_active_academic_context`
--
ALTER TABLE `school_active_academic_context`
...
ALTER TABLE `school_expenses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_se_school` (`school_id`),
  ADD KEY `idx_se_date` (`expense_date`);

--
-- Indexes for table `school_expense_payments`
--
ALTER TABLE `school_expense_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_sep_school` (`school_id`),
  ADD KEY `idx_sep_expense` (`expense_id`);
...
--
-- Indexes for table `school_finance_pay_methods`
--
ALTER TABLE `school_finance_pay_methods`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_sfpm_school` (`school_id`),
  ADD KEY `idx_sfpm_sort` (`school_id`,`sort_order`);
...
ALTER TABLE `school_holidays`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_s` (`school_id`);

--
-- Indexes for table `school_iot_devices`
--
ALTER TABLE `school_iot_devices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_dev_school` (`school_id`,`device_uid`),
  ADD KEY `idx_dev_school` (`school_id`);
...
--
-- Indexes for table `school_payroll_rates`
--
ALTER TABLE `school_payroll_rates`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_spr_school_role` (`school_id`,`role_label`),
  ADD KEY `idx_spr_school` (`school_id`);

--
-- Indexes for table `school_payroll_runs`
--
ALTER TABLE `school_payroll_runs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_sprun_code` (`school_id`,`run_code`),
  ADD KEY `idx_sprun_school` (`school_id`),
  ADD KEY `idx_sprun_period` (`school_id`,`period_key`);

--
-- Indexes for table `school_payroll_run_lines`
--
ALTER TABLE `school_payroll_run_lines`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_sprl_run` (`run_id`),
  ADD KEY `idx_sprl_school` (`school_id`);

--
-- Indexes for table `school_payroll_staff_assignments`
--
ALTER TABLE `school_payroll_staff_assignments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_spsa_staff` (`school_id`,`staff_user_id`),
  ADD KEY `idx_spsa_school` (`school_id`),
  ADD KEY `idx_spsa_rate` (`rate_id`);
...
--
-- Indexes for table `school_requisitions`
--
ALTER TABLE `school_requisitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_sr_school` (`school_id`),
  ADD KEY `idx_sr_status` (`status`);

--
-- Indexes for table `school_store_items`
--
ALTER TABLE `school_store_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ssi_school` (`school_id`),
  ADD KEY `idx_ssi_name` (`school_id`,`name`);

--
-- Indexes for table `school_store_movements`
--
ALTER TABLE `school_store_movements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_ssm_school` (`school_id`),
  ADD KEY `idx_ssm_item` (`item_id`),
  ADD KEY `idx_ssm_created` (`created_at`);

--
-- Indexes for table `school_store_suppliers`
--
ALTER TABLE `school_store_suppliers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_sss_school` (`school_id`),
  ADD KEY `idx_sss_name` (`school_id`,`name`);
...
ALTER TABLE `school_subjects`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_sub` (`school_id`,`name`),
  ADD KEY `idx_subj_school` (`school_id`);
...
ALTER TABLE `school_terms`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_term` (`school_id`,`name`),
  ADD KEY `idx_school_year` (`school_id`,`academic_year`);

--
-- Indexes for table `school_term_milestones`
--
ALTER TABLE `school_term_milestones`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `staff`
  ...
  ADD UNIQUE KEY `idx_staff_rfid` (`rfid_uid`),
  ADD UNIQUE KEY `idx_staff_fingerprint` (`fingerprint_id`),
...
--
-- Indexes for table `teacher_ai_logs`
--
ALTER TABLE `teacher_ai_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_tai_teacher` (`teacher_user_id`);

--
-- Indexes for table `teacher_loan_requests`
--
ALTER TABLE `teacher_loan_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_tlr_teacher` (`teacher_user_id`),
  ADD KEY `idx_tlr_status` (`status`);
...
ALTER TABLE `teacher_services`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_t_service_code` (`service_code`);
...
--
-- AUTO_INCREMENT for table `biometric_logs_raw`
--
ALTER TABLE `biometric_logs_raw`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `class_subject_configuration`
--
ALTER TABLE `class_subject_configuration`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `english_club_resources`
--
ALTER TABLE `english_club_resources`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `school_expense_payments`
--
ALTER TABLE `school_expense_payments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `school_finance_pay_methods`
--
ALTER TABLE `school_finance_pay_methods`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `school_iot_devices`
--
ALTER TABLE `school_iot_devices`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `school_payroll_rates`
--
ALTER TABLE `school_payroll_rates`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `school_payroll_runs`
--
ALTER TABLE `school_payroll_runs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `school_payroll_run_lines`
--
ALTER TABLE `school_payroll_run_lines`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `school_payroll_staff_assignments`
--
ALTER TABLE `school_payroll_staff_assignments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `school_requisitions`
--
ALTER TABLE `school_requisitions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `school_store_items`
--
ALTER TABLE `school_store_items`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `school_store_movements`
--
ALTER TABLE `school_store_movements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `school_store_suppliers`
--
ALTER TABLE `school_store_suppliers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `school_term_milestones`
--
ALTER TABLE `school_term_milestones`
...
--
-- AUTO_INCREMENT for table `teacher_ai_logs`
--
ALTER TABLE `teacher_ai_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `teacher_loan_requests`
--
ALTER TABLE `teacher_loan_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `teacher_services`
--
ALTER TABLE `teacher_services`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

...
const SCHOOL_ROLES = ['SCHOOL_ADMIN', 'SCHOOL_MANAGER', 'DOS', 'REGISTRAR', 'HOD', 'TEACHER', 'ACCOUNTANT'];
/** HoD approves leave / exit requests and can grant permissions like other school leads. */
const APPROVAL_ROLES = ['SCHOOL_ADMIN', 'SCHOOL_MANAGER', 'DOS', 'REGISTRAR', 'HOD', 'ACCOUNTANT'];

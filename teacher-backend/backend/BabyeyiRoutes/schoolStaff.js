...
//
// Allowed creators: SCHOOL_ADMIN, SCHOOL_MANAGER, DOS, HOD
...
/** Create/update staff accounts (DOS / HoD can add teachers from the DOS portal). */
const STAFF_CREATOR_ROLES = ['SCHOOL_ADMIN', 'SCHOOL_MANAGER', 'DOS', 'HOD'];
/** Same school staff directory (read-only in DOS portal for DOS / teachers / HoD). */
const STAFF_LIST_ROLES = ['SCHOOL_ADMIN', 'SCHOOL_MANAGER', 'DOS', 'TEACHER', 'HOD'];
...
// ════════════════════════════════════════════════════════════════
router.get('/school/staff', requireRole(STAFF_LIST_ROLES), async (req, res) => {
  try {
...
router.post('/school/staff',
  requireRole(STAFF_CREATOR_ROLES),
...
// ════════════════════════════════════════════════════════════════
router.post('/school/staff/:id/resend-invite', requireRole(STAFF_CREATOR_ROLES), async (req, res) => {
  try {
    const schoolId = resolveSchoolId(req);
...
// ════════════════════════════════════════════════════════════════
router.put('/school/staff/:id', requireRole(STAFF_CREATOR_ROLES), async (req, res) => {
  const conn = await promisePool.getConnection();
  try {
    const schoolId = resolveSchoolId(req);

    ...
    <div style={{ fontFamily:"'Montserrat',sans-serif", background:"#f4f6fb", minHeight:"100vh", color:"#0f172a" }}>
      ...
      <div style={{ background:"#c87800", padding:"28px 24px 40px", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:1400, margin:"0 auto", display:"flex", alignItems:"center", gap:16 }}>
          ...
          <div>
            <p style={{ fontSize:9, fontWeight:700, color:"rgba(255,255,255,.6)", textTransform:"uppercase", letterSpacing:"0.25em", marginBottom:2 }}>Library Management</p>
            <h1 style={{ fontSize:"clamp(20px,3vw,28px)", fontWeight:600, color:"#fff", letterSpacing:"-0.5px", margin:0 }}>Library Reports</h1>
            <p style={{ fontSize:10, fontWeight:500, color:"rgba(255,255,255,.6)", textTransform:"uppercase", letterSpacing:"0.2em", margin:0 }}>Books, borrowings &amp; overdue tracking</p>
          </div>

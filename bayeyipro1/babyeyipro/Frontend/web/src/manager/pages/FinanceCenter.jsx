...
export default function FinanceCenter() {
  ...
  return (
    <div className="animate-in fade-in duration-500 bg-re-bg min-h-screen pb-20">
      ...
      />
      <section className="relative min-h-[220px] overflow-hidden bg-[#c87800]">
        ...
        <div className="relative z-20 max-w-[1500px] mx-auto px-4 md:px-8 py-12 text-white">
          ...
          <h1 className="text-2xl md:text-3xl text-center font-semibold text-white uppercase tracking-tight mt-2" style={{ fontFamily: "'Montserrat', sans-serif" }}>Finance approvals & reports</h1>

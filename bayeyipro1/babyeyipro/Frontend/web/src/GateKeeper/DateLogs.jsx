  ...
  return (
    <div className="p-4 sm:p-6 space-y-5 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
        <div>
          <h1 className="text-xl sm:text-2xl font-black text-[#000435] tracking-tight">Date Logs</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#000435] text-white text-[12px] font-black px-4 py-2.5 rounded-xl hover:bg-[#000c6e] transition-colors shadow-md shadow-[#000435]/20 shrink-0"
        >
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 space-y-3">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border text-[12px] font-black transition-all ${
              ...
              {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                ...
                return (
                  <button
                    key={p}
                    onClick={() => setPage(p)}
                    className={`w-8 h-8 flex items-center justify-center rounded-xl text-[12px] font-black border transition-all ${
                      p === page
                        ? 'bg-[#000435] text-white border-[#000435] shadow-md'

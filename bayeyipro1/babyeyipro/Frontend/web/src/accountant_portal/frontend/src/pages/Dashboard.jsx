...
export default function Dashboard() {
  ...
  return (
    <div className="relative w-full min-h-[85vh] bg-gradient-to-b from-[#f7f9ff] via-white to-[#f8f9fa]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;800;900&display=swap" rel="stylesheet" />

      {/* ── Hero banner ── */}
      <section className="relative p-7 md:p-10 text-white overflow-hidden min-h-[240px] flex items-center bg-gradient-to-r from-[#000435] via-[#000856] to-[#000435] rounded-b-[30px]">
          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-amber-300/40 bg-white/10 px-4 py-2.5 text-[10px] font-black capitalize tracking-widest text-white backdrop-blur-sm hover:bg-white/20 hover:border-amber-300/70 transition-all active:scale-95 disabled:opacity-60"
                title="Refresh"
                disabled={refreshing}
              >
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-10 -mt-10 md:-mt-12 relative z-20 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-[24px] border border-[#000435]/10 overflow-hidden h-full flex flex-col shadow-[0_22px_50px_-38px_rgba(0,4,53,0.75)] transition-all hover:-translate-y-0.5">
              {/* column header */}
        ...
        <div className="mt-5 bg-white rounded-[24px] border border-[#000435]/10 overflow-hidden shadow-[0_22px_50px_-38px_rgba(0,4,53,0.75)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
          ...
          <div className="bg-white border border-[#000435]/10 rounded-[24px] p-5 md:p-6 lg:col-span-2 shadow-[0_22px_50px_-38px_rgba(0,4,53,0.75)]">
          ...
          {/* Top debtors: 1 col */}
          <div className="bg-white border border-[#000435]/10 rounded-[24px] p-5 md:p-6 shadow-[0_22px_50px_-38px_rgba(0,4,53,0.75)]">
            <div className="flex items-center justify-between gap-3 mb-4">
              <div className="flex items-center gap-2">

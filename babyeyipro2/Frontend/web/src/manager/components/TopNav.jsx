...
const TopNav = ({ title, onMenuClick }) => {
    ...
    return (
        <header className="h-14 sm:h-[3.75rem] flex items-center gap-3 sm:gap-4 px-3 sm:px-5 md:px-7 bg-white border-b border-slate-200/90 shadow-[0_1px_0_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.12)] sticky top-0 z-20 font-sans transition-all duration-300">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
                <button
                    type="button"
                    onClick={onMenuClick}
                    className="flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-xl bg-re-gold text-re-navy shadow-[0_4px_14px_rgba(254,191,16,0.35)] hover:bg-re-gold-light active:scale-[0.97] transition-all lg:hidden"
                ...
                <div className="relative" ref={userRef}>
                    ...
                    >
                        <div className="relative">
                            <div
                                className="w-9 h-9 rounded-full bg-gradient-to-br from-re-navy to-re-navy-dark text-re-gold flex items-center justify-center font-bold text-xs border-2 border-white shadow-md group-hover:scale-[1.02] transition-transform"
                            >
                                {initials}
                            </div>
                        ...
                        <div className="hidden sm:block text-left max-w-[160px] md:max-w-[220px]">
                            <p className="text-xs font-bold text-slate-800 leading-tight uppercase tracking-tight truncate">
                                {manager?.first_name || 'Manager'}
                            </p>
                            <p className="text-[10px] text-slate-500 font-semibold leading-tight uppercase tracking-wide truncate">
                        ...
                        <div className="absolute right-0 mt-1.5 w-52 bg-white rounded-2xl shadow-2xl border border-black/5 z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
                            ...
                            <div className="px-4 py-3 border-b border-black/5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-black text-re-navy uppercase tracking-tight">

                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[9px] font-black uppercase tracking-[0.3em] text-[#FEBF10]">Morning Roll Call</span>
                            </div>
            ...
            <div className="relative z-30 max-w-[1600px] mx-auto px-2 md:px-6 -mt-14">
                <div className="bg-white rounded-t-[2.5rem] shadow-2xl border border-black/5 overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-black/5 border-b border-black/5">
                        {[
                            ...
                            <div key={i} className="p-4 sm:p-6 flex flex-col items-center justify-center text-center group hover:bg-slate-50 transition-all">
                                ...
                                <div className="text-lg sm:text-2xl font-black text-slate-800 tracking-tighter group-hover:text-[#1E3A5F]">{s.value}</div>
                                <div className="text-[8px] font-black text-slate-400 uppercase tracking-[0.18em] mt-0.5">{s.label}</div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="px-4 py-3 border-b border-black/5 bg-slate-50/60 flex flex-col lg:flex-row items-center gap-3">
                        ...
                        <div className="relative w-full lg:w-52">
                            ...
                            <select
                                ...
                                className="w-full pl-9 pr-8 h-10 bg-white border border-black/8 rounded-xl text-[11px] font-black text-slate-700 appearance-none focus:outline-none focus:border-[#1E3A5F]/30 shadow-sm"
                            >
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            <button onClick={() => markAll('On time')} className="h-10 px-3 bg-emerald-50 text-emerald-700 text-[9px] font-black uppercase tracking-wider rounded-xl border border-emerald-100 hover:bg-emerald-100 transition-colors">All On Time</button>
                            <button onClick={() => markAll('Absent')}  className="h-10 px-3 bg-red-50 text-red-600 text-[9px] font-black uppercase tracking-wider rounded-xl border border-red-100 hover:bg-red-100 transition-colors">All Absent</button>
                        </div>
                        ...
                        <table className="w-full text-left border-collapse min-w-[680px]">
                            <thead>
                                <tr className="bg-slate-50 border-b border-black/5">
                                    ...
                                    <th className="px-4 py-3 text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] border-r border-black/5">Student</th>
                                    <th className="hidden sm:table-cell px-4 py-3 text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] border-r border-black/5">Class</th>
                                    <th className="px-4 py-3 text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Morning Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                {loading ? (
                                    <tr>
                                        <td colSpan={4} className="py-16 text-center">
                                            ...
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2">Loading students…</p>
                                        </td>
                                    </tr>
                                ) : filtered.length === 0 ? (
                                    <tr>
                                    ...
                                    <tr key={s.student_id} className="hover:bg-slate-50/80 transition-colors border-b border-black/4 group">
                                        ...
                                        <td className="hidden sm:table-cell px-4 py-3 border-r border-black/5">
                                            <span className="text-[10px] font-black text-slate-600 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">{s.class_name || '—'}</span>
                                        </td>
                    ...
                    <div className="px-6 py-4 bg-slate-50/60 border-t border-black/5 flex items-center justify-between">
                        ...
                        <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{filtered.length} shown</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="px-5 py-4 border-b border-black/5 bg-gradient-to-r from-slate-50 to-white">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex items-center gap-3 shrink-0">
                    ...
                    <div>
                        <p className="text-[11px] font-black text-slate-800 uppercase tracking-tight">{termLabel} Attendance</p>
                ...
                <div className="flex-1 space-y-2.5 min-w-0">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1">
                            <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Attendance Rate</span>

            ...
            <div className="mb-3">
                <div className="flex flex-wrap gap-2">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-[#1E3A5F] px-4 py-2 text-[11px] font-black uppercase tracking-widest text-[#FEBF10] transition hover:bg-[#0d2644]"
                    >
                        <Sun size={14} />
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-white border border-slate-300 px-4 py-2 text-[11px] font-black uppercase tracking-widest text-[#1E3A5F] transition hover:bg-slate-50"
                    >
                        <Briefcase size={14} />
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24">
                    <div className="space-y-1">
                        ...
                        <p className="text-[9px] md:text-xs text-white/55 font-semibold max-w-2xl leading-relaxed mt-3 border-l-2 border-white/20 pl-3">
                            ...
                            when Student Permissions approves leave for a date, those learners default to Excused until you change them.
                        </p>
                    </div>

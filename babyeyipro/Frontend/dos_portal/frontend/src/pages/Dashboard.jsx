        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="space-y-5 lg:sticky lg:top-20 h-fit">
            ...
            <div className="relative rounded-[24px] p-6 text-white shadow-re-premium-purple overflow-hidden group active:scale-[0.99] transition-all bg-re-grad-purple">
              ...
              <Link to="/marks/view" className="relative z-10 flex flex-col gap-4 block">
                <div className="w-9 h-9 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-md shadow-inner">
                  <Users size={18} className="text-white" />
                </div>
                <div>
                  <h4 className="font-black text-xs tracking-widest uppercase leading-none opacity-90">Academic pulse</h4>

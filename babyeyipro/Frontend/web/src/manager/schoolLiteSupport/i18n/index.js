...
export function getLegacyBabyeyiUI(lang) {
  ...
  return {
    ...
    duplicateBtn: t("list.duplicateBtn"),
    printBtn: t("list.printBtn"),
    moreActions: t("list.moreActions"),
    ...
    secTotalPayments: t("doc.secTotalPayments"),
    secTotalPaymentsHint: t("doc.secTotalPaymentsHint"),
    thTotalPayAtSchool: t("doc.thTotalPayAtSchool"),
    paidAtSchoolFeeTag: t("doc.paidAtSchoolFeeTag"),
    paidAtSchoolReqTag: t("doc.paidAtSchoolReqTag"),

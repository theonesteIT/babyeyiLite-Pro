...
export const operationsInnerSelectCls = `${SELECT_CHEVRON} w-full min-h-[2.75rem] h-11 rounded-xl pl-4 pr-10 outline-none transition-all border border-black/[0.07] bg-re-bg text-[#1E3A5F] font-semibold uppercase tracking-wide text-[10px] shadow-[inset_0_2px_8px_rgba(15,23,42,0.11),inset_0_-1px_0_rgba(255,255,255,0.55)] focus:border-[#1E3A5F]/30 focus:bg-white focus:ring-2 focus:ring-[#1E3A5F]/12`;

/** Modal — text, number, date, time */
export const operationsInnerInputCls =
  'w-full min-h-[2.75rem] h-11 rounded-xl px-4 outline-none transition-all border border-black/[0.07] bg-re-bg text-[#1E3A5F] font-semibold uppercase text-[11px] shadow-[inset_0_2px_8px_rgba(15,23,42,0.11),inset_0_-1px_0_rgba(255,255,255,0.55)] focus:border-[#1E3A5F]/30 focus:bg-white focus:ring-2 focus:ring-[#1E3A5F]/12';
...
export const operationsInnerTimeCls = `${operationsInnerInputCls} !px-2 !normal-case text-[10px] font-semibold tabular-nums`;

    ...
    return (
        <div className="animate-in fade-in duration-700 bg-re-bg min-h-screen">
            ...
            <div className="relative w-full min-h-[220px] overflow-hidden">
                ...
                <img src={import.meta.env.BASE_URL + "teacher.jpg"} alt="Hero Background" className="absolute inset-0 w-full h-full object-cover scale-105 opacity-40 mix-blend-overlay z-0" />
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                {["Public", "Government-Aided", "Private", "Faith-Based"].map(type => (
                                                    <button
                                                        ...
                                                        className={`p-3 rounded-xl border text-[9px] font-black uppercase tracking-widest transition-all text-center ${
                                                            profile.ownership_type === type 
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                {["Day School", "Boarding School", "Mixed"].map(format => (
                                                    <button
                                                        ...
                                                        className={`p-3 rounded-xl border text-[8px] font-black uppercase tracking-widest transition-all text-center ${
                                                            profile.boarding_type === format 
                                                                ? 'bg-[#1E3A5F] text-[#FEBF10] border-transparent shadow-md' 
                                                                : 'bg-white text-re-text-muted border-black/[0.05] hover:border-[#1E3A5F]/20'
                                                        }`}
                                                    >

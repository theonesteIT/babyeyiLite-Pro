    ...
    return (
        <div className="animate-in fade-in duration-700 bg-re-bg min-h-screen pb-12 font-sans lowercase">
            ...
            <div className="relative w-full min-h-[220px] overflow-hidden" style={{ backgroundImage: `url(${heroImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-12 pb-16 flex items-center gap-6 text-white text-center">
                    <div className="hidden md:flex shrink-0 w-20 h-20 rounded-3xl border border-white/10 bg-white/5 items-center justify-center backdrop-blur-xl shadow-sm relative overflow-hidden group">
                        ...
                        <Settings size={40} style={{ color: "#FEBF10" }} className="" />
                    </div>

                    <div className="space-y-1 w-full md:w-auto">
                        <div className="flex items-center justify-center md:justify-start gap-2 mb-1.5">
                            <span className="w-5 h-1 rounded-full animate-pulse" style={{ background: "#FEBF10" }}></span>
                            <p className="text-[9px] font-semibold uppercase tracking-[0.2em]" style={{ color: "#FEBF10" }}>Robust Institutional Setup</p>
                        </div>
                        <h1 className="text-2xl md:text-3xl font-semibold text-white tracking-tight leading-none mb-1.5 uppercase" style={{ fontFamily: "'Montserrat', sans-serif" }}>School Operations</h1>
                        <p className="text-[10px] font-medium text-white/60 max-w-lg leading-relaxed uppercase tracking-widest mx-auto md:mx-0" style={{ fontFamily: "'Montserrat', sans-serif" }}>Manage the technical heart of the institution: Calendar, periods, NESA subjects, and IoT pulses</p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-[1600px] mx-auto px-6 md:px-12 -mt-16 relative z-30 pb-16">
                <div className="bg-white rounded-t-3xl shadow-sm border border-black/10 flex flex-col md:flex-row min-h-[600px] overflow-hidden">
                        ...
                        <div className="px-3 space-y-1">
                            {[
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-[10px] uppercase tracking-widest transition-all ${activeTab === tab.id ? 'bg-white shadow-sm text-[#1E3A5F]' : 'text-[#1E3A5F]/40 hover:text-[#1E3A5F] hover:bg-white/50'}`}
                                >
                    ...
                    <div className="flex-1 p-6 md:p-10 animate-in fade-in zoom-in-95 duration-500">
                        {loading ? (
                            <div className="h-[400px] flex flex-col items-center justify-center gap-4">
                                ...
                                <p className="text-[10px] font-semibold uppercase tracking-widest text-[#1E3A5F]/40 italic">Syncing Departmental Repository...</p>
                            </div>
                        ) : activeTab === 'subjects' ? (
                            <div className="space-y-8">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h2 className="text-base font-semibold text-[#1E3A5F] uppercase tracking-tight">NESA Subject Registry</h2>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="h-8 px-4 bg-white text-[#1E3A5F] border border-[#1E3A5F]/10 rounded-lg font-medium text-[8px] uppercase tracking-widest flex items-center gap-2 hover:bg-re-bg transition-all"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="h-8 px-4 bg-[#1E3A5F] text-white rounded-lg font-medium text-[8px] uppercase tracking-widest flex items-center gap-2 shadow-sm active:scale-95 transition-all"
                                        >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {subjects.map(s => (
                                        <div key={s.id} className="bg-white p-5 rounded-2xl border border-black/5 hover:border-[#FEBF10]/30 transition-all group shadow-sm flex flex-col">
                                            ...
                                            <h3 className="text-sm font-semibold text-[#1E3A5F] uppercase tracking-tight">{s.name}</h3>
                                            <div className="flex items-center gap-2 mt-2">
                                                <span className="text-[8px] font-semibold uppercase px-2 py-0.5 rounded bg-emerald-50 text-emerald-600 ring-1 ring-emerald-500/10">{s.category}</span>
                                                <span className="text-[8px] font-semibold uppercase px-2 py-0.5 rounded bg-blue-50 text-blue-600 ring-1 ring-blue-500/10">{s.subject_code || 'UNSET'}</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="space-y-8">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h2 className="text-xl font-semibold text-[#1E3A5F] uppercase tracking-tight">Academic Calendar</h2>
                                    ...
                                    <button
                                        ...
                                        className="h-10 px-6 bg-[#1E3A5F] text-white rounded-xl font-medium text-[9px] uppercase tracking-widest flex items-center gap-2"
                                    >
                                        ...
                                        <div key={term.id} className="bg-white border border-black/5 rounded-2xl overflow-hidden shadow-sm">
                                            <div className="px-6 py-4 bg-re-bg/20 flex items-center justify-between border-b border-black/5">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h4 className="text-xs font-semibold text-[#1E3A5F] uppercase tracking-widest">{term.name}</h4>
                                                        <p className="text-[9px] font-bold text-re-text-muted uppercase tracking-widest">{term.start_date} → {term.end_date}</p>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-3">
                                                    {term.is_active ? (
                                                        <span className="text-[8px] font-semibold uppercase px-2 py-0.5 rounded bg-emerald-100 text-emerald-700 tracking-widest flex items-center gap-1">
                                                            <CheckCircle size={10} /> CURRENT ACTIVE
                                                        </span>
                                                    ) : <span className="text-[8px] font-semibold uppercase px-2 py-0.5 rounded bg-gray-100 text-gray-400 tracking-widest">In-Active</span>}
                                                </div>
                                            </div>
                                            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                                                {term.breakdowns?.map(b => (
                                                    <div key={b.id} className="p-4 rounded-xl border border-black/5 bg-white hover:border-[#FEBF10]/30 transition-all flex items-center justify-between group">
                                                        <div>
                                                            <p className="text-[9px] font-semibold text-[#1E3A5F] uppercase tracking-tight">{b.name}</p>
                                                ...
                                                <button
                                                    ...
                                                    className="p-4 rounded-xl border-2 border-dashed border-black/5 flex items-center justify-center gap-2 text-[9px] font-semibold uppercase text-re-text-muted hover:bg-re-bg/50 transition-all"
                                                >
                            ...
                            <div className="space-y-8">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h2 className="text-xl font-semibold text-[#1E3A5F] uppercase tracking-tight">School Day Periods</h2>
                                    ...
                                    {periods.map(p => (
                                        <div key={p.id} className={`p-5 rounded-2xl border flex items-center justify-between ${p.is_break ? 'bg-amber-50 border-amber-500/10' : 'bg-white border-black/5'} shadow-sm group`}>
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-[11px] font-semibold text-[#1E3A5F] uppercase tracking-widest">{p.period_name}</p>
                            ...
                            <div className="space-y-8">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h2 className="text-xl font-semibold text-[#1E3A5F] uppercase tracking-tight">Robust Operational Pulses</h2>
                                    ...
                                    <button
                                        ...
                                        className="h-10 px-6 bg-[#1E3A5F] text-white rounded-xl font-medium text-[9px] uppercase tracking-widest flex items-center gap-2 shadow-re-glow"
                                    >
                                        ...
                                        <div key={pulse.id} className="bg-white p-6 rounded-3xl border border-black/5 hover:border-[#FEBF10]/30 transition-all shadow-sm flex flex-col gap-4 relative overflow-hidden group">
                                            <div className="flex items-center justify-between relative z-10">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h3 className="text-sm font-semibold text-[#1E3A5F] uppercase tracking-tight">{pulse.event_name}</h3>
                                            ...
                                            <div className="flex items-center gap-1.5 flex-wrap relative z-10">
                                                {daysOfWeek.map(d => (
                                                    <span key={d} className={`text-[8px] font-semibold uppercase px-2 py-0.5 rounded-lg border transition-all ${pulse.days_active.includes(d) ? 'bg-[#1E3A5F] text-[#FEBF10] border-[#1E3A5F]' : 'bg-re-bg text-re-text-muted border-transparent'}`}>
                                                        {d}
                                                    </span>
                                                ))}
                                            </div>
                                            ...
                                            <div className="flex items-center justify-between border-t border-black/5 pt-4 mt-2">
                                                <div className="flex gap-2">
                                                    <span className="text-[8px] font-semibold uppercase px-2 py-1 bg-blue-50 text-blue-600 rounded-md tracking-widest">{pulse.target_group}</span>
                                                    <span className="text-[8px] font-semibold uppercase px-2 py-1 bg-gray-50 text-gray-500 rounded-md tracking-widest">{pulse.residency_filter} RESIDENCY</span>
                                                </div>
                                                <button onClick={() => { setEditingItem(pulse); setPulseForm({ event_name: pulse.event_name, start_time: pulse.start_time, end_time: pulse.end_time, late_threshold: pulse.late_threshold, target_group: pulse.target_group, residency_filter: pulse.residency_filter, days_active: pulse.days_active }); setActiveModal('pulse'); }} className="text-[9px] font-semibold uppercase tracking-widest text-[#1E3A5F] opacity-30 hover:opacity-100 hover:text-[#FEBF10] transition-all">Edit Logic</button>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 backdrop-blur-md bg-[#0a192f]/40 animate-in fade-in duration-300">
                    <div className="bg-white w-full max-w-lg rounded-3xl shadow-[0_32px_128px_-15px_rgba(30,58,95,0.4)] overflow-hidden animate-in zoom-in-95 duration-300 border border-white/20">
                        ...
                        <div className="px-6 py-5 bg-[#1E3A5F] text-white flex items-center justify-between uppercase">
                            <h3 className="font-semibold text-[10px] tracking-widest">
                            ...
                            {activeModal === 'new_subject' ? (
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Subject Name</label>
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Subject Category</label>
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Universal Subject Code</label>
                                    ...
                                    <button onClick={handleSaveNewSubject} disabled={saving} className="w-full h-12 bg-[#1E3A5F] text-white rounded-xl font-medium text-[10px] uppercase tracking-widest shadow-sm flex items-center justify-center gap-2 mt-4">
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Focus Subject</label>
                                            <select className={operationsInnerSelectCls}
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Target Class</label>
                                            <select className={operationsInnerSelectCls}
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Subject Registry Code</label>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Periods / Week</label>
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Subject Credits</label>
                                            <input type="number" className={`${operationsInnerInputCls} !normal-case tabular-nums`}
                                                value={subjectConfig.credits} onChange={e => setSubjectConfig({ ...subjectConfig, credits: e.target.value })} />
                                        </div>
                                    </div>
                                    <button onClick={handleSaveSubjectConfig} disabled={saving} className="w-full h-12 bg-[#1E3A5F] text-white rounded-xl font-medium text-[10px] uppercase tracking-widest shadow-sm flex items-center justify-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Pulse Trigger Name</label>
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Start</label>
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">End</label>
                                            <input type="time" className={operationsInnerTimeCls}
                                                value={pulseForm.end_time} onChange={e => setPulseForm({ ...pulseForm, end_time: e.target.value })} />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1 text-orange-500">Late</label>
                                            <input type="time" className={operationsInnerTimeCls}
                                                value={pulseForm.late_threshold} onChange={e => setPulseForm({ ...pulseForm, late_threshold: e.target.value })} />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Active Days (Pinpoint)</label>
                                        <div className="flex flex-wrap gap-2">
                                            {daysOfWeek.map(d => (
                                                <button key={d} onClick={() => toggleDay(d)} className={`px-4 py-2 rounded-xl text-[9px] font-semibold uppercase transition-all shadow-sm ${pulseForm.days_active.includes(d) ? 'bg-[#1E3A5F] text-[#FEBF10] shadow-[#1E3A5F]/30' : 'bg-re-bg text-re-text-muted hover:bg-white'}`}>
                                                    {d}
                                                </button>
                                            ))}
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Target</label>
                                            <select className={operationsInnerSelectCls}
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Residency</label>
                                            <select className={operationsInnerSelectCls}
                                    ...
                                    <button onClick={handleSavePulse} disabled={saving} className="w-full h-12 bg-[#FEBF10] text-[#1E3A5F] rounded-xl font-medium text-[10px] uppercase tracking-widest shadow-sm flex items-center justify-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Period Identity</label>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Start Time</label>
                                            <input type="time" className={operationsInnerTimeCls}
                                                value={periodForm.start_time} onChange={e => setPeriodForm({ ...periodForm, start_time: e.target.value })} />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">End Time</label>
                                            <input type="time" className={operationsInnerTimeCls}
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-re-bg/20 rounded-xl cursor-pointer" onClick={() => setPeriodForm({ ...periodForm, is_break: periodForm.is_break ? 0 : 1 })}>
                                        ...
                                        <span className="text-[10px] font-semibold uppercase text-[#1E3A5F] tracking-widest">Mark as Institutional Break</span>
                                    </div>
                                    <button onClick={handleSavePeriod} disabled={saving} className="w-full h-12 bg-[#1E3A5F] text-white rounded-xl font-medium text-[10px] uppercase tracking-widest shadow-sm flex items-center justify-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Milestone Name</label>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Timing / Period</label>
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Display Order</label>
                                            <input type="number" className={`${operationsInnerInputCls} !normal-case tabular-nums`}
                                                value={milestoneForm.sort_order} onChange={e => setMilestoneForm({ ...milestoneForm, sort_order: e.target.value })} />
                                        </div>
                                    </div>
                                    <button onClick={handleSaveMilestone} disabled={saving} className="w-full h-12 bg-[#1E3A5F] text-white rounded-xl font-medium text-[10px] uppercase tracking-widest shadow-sm flex items-center justify-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Term Name</label>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">Start Date</label>
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[8px] font-semibold uppercase text-[#1E3A5F]/40 tracking-widest ml-1">End Date</label>
                                            <input type="date" className={`${operationsInnerInputCls} !normal-case tabular-nums`}
                                                value={termForm.end_date} onChange={e => setTermForm({ ...termForm, end_date: e.target.value })} />
                                        </div>
                                    </div>
                                    <button onClick={handleSaveTerm} disabled={saving} className="w-full h-12 bg-[#1E3A5F] text-white rounded-xl font-medium text-[10px] uppercase tracking-widest shadow-sm flex items-center justify-center gap-2">

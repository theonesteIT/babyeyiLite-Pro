                ...
                <div className="flex items-center justify-between px-8 py-6 border-b border-black/5 bg-white shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0">
                            <h3 className="font-black text-re-text text-base leading-tight uppercase tracking-tight truncate">{student.name}</h3>
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.3em]" style={{ color: "#FEBF10" }}>Institutional Repository</p>
                        </div>
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-white tracking-tighter leading-none mb-2 mt-2 uppercase">Students <span style={{ color: "#FEBF10" }}>List</span></h1>
                ...
                <div className="bg-white rounded-t-[32px] shadow-2xl border border-black/5 overflow-hidden flex flex-col">
                    ...
                    <div className={`${!isClassSelected ? 'hidden md:flex' : 'flex'} p-6 md:px-8 border-b border-black/5 flex-col md:flex-row items-center gap-4 bg-white/50`}>
                        ...
                        <div className="flex items-center gap-2 w-full md:w-auto">
                            ...
                            <div className="relative">
                                ...
                                {showYearFilter && (
                                    <>
                                        ...
                                        <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-black/5 shadow-2xl rounded-2xl overflow-hidden py-1 z-[50] animate-in slide-in-from-top-2 duration-200">
                                            {['All Years', '2023', '2023-2024', '2024', '2024-2025', '2025', '2025-2026', '2026', '2026-2027', '2027'].map(year => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest transition-colors ${selectedYear === year ? 'bg-re-navy text-white' : 'text-re-text hover:bg-re-bg'}`}
                                                >
                                                    {year}
                                                </button>
                                            ))}
                                        ...
                                        <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-black/5 shadow-2xl rounded-2xl overflow-hidden py-1 z-[50] animate-in slide-in-from-top-2 duration-200">
                                            {['All', 'DAY', 'BOARDING'].map(res => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest transition-colors ${selectedResidency === res ? 'bg-re-navy text-white' : 'text-re-text hover:bg-re-bg'}`}
                                                >
                            ...
                            <button
                                ...
                                className="h-10 sm:h-11 flex-1 md:flex-none px-3 sm:px-6 bg-re-bg border border-black/5 rounded-xl text-re-text font-black text-[8px] sm:text-[9px] uppercase tracking-widest hover:bg-white hover:border-[#1E3A5F]/20 transition-all shadow-sm group flex items-center gap-1.5 sm:gap-2 whitespace-nowrap"
                            >
                                ...
                                {classes.map(cls => (
                                    ...
                                    >
                                        <div className="flex flex-col items-center gap-0.5">
                                            <span className="text-[9px] sm:text-[10px] font-black text-re-text group-hover:text-[#1E3A5F] uppercase">{cls}</span>
                    ...
                    <div className={`${!isClassSelected ? 'hidden md:flex' : 'flex'} px-4 sm:px-8 py-5 bg-re-bg/20 border-t border-black/5 flex flex-row items-center justify-between gap-4`}>
                        ...
                        <div className="flex items-center gap-1 sm:gap-1.5">
                            ...
                            <button
                                className="h-7 sm:h-8 px-3 sm:px-4 rounded-lg text-white text-[7px] sm:text-[9px] font-black shadow-xl tracking-tighter"
                                style={{ background: "linear-gradient(135deg, #1E3A5F 0%, #0D2644 100%)" }}
                            >
                                Next_set
                            </button>

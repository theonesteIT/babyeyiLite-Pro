      ...
      try {
        ...
        const constraints =
          deviceId && String(deviceId).trim()
            ? { video: { deviceId: { exact: String(deviceId).trim() } }, audio: false }
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-3 sm:p-4">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="min-w-0">
            <p className="text-sm font-black text-slate-900">Assign staff photo</p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-3">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <div className="w-24 h-24 rounded-2xl overflow-hidden bg-slate-100 border border-slate-200 shrink-0">
                    <img src={uploadPreviewUrl} alt="" className="w-full h-full object-cover" />
                  </div>
                  <button
                    type="button"
            ...
            {approvedPreviewUrl && photoTab === 'camera' && !cameraOpen && (
              <div className="rounded-2xl border border-slate-200 bg-white p-3">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <div className="w-24 h-24 rounded-2xl overflow-hidden bg-slate-100 border border-slate-200 shrink-0">
                    {approvedPreviewUrl ? (
                      <img src={approvedPreviewUrl} alt="" className="w-full h-full object-cover" />
                    ) : null}
                  </div>
                  <div className="flex-1">
                    <p className="text-xs text-slate-600 font-semibold">Confirm the photo. You can retake if it&apos;s not clear.</p>

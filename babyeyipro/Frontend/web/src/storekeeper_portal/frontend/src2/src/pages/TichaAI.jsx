  ...
  return (
    <div className="relative w-full bg-re-bg min-h-screen">
      <StorekeeperOchreHero
        eyebrow="Cognitive core · Store"
        titleLine="Ticha"
        titleAccent="AI"
        subtitle={`Draft summaries, stock notes & comms for ${PORTAL.brandLine}`}
        icon={Sparkles}
      />
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 -mt-4 sm:-mt-5 pt-2 relative z-20 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col h-[calc(100vh-260px)] md:h-[calc(100vh-320px)] min-h-[450px] bg-white rounded-t-[28px] md:rounded-[24px] shadow-sm border border-black/10 overflow-hidden relative">
            <header className="px-5 py-3 md:py-4 border-b border-black/5 bg-white/80 backdrop-blur-md flex items-center justify-between sticky top-0 z-30">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 md:w-9 md:h-9 bg-re-grad-purple rounded-lg flex items-center justify-center text-white shadow-sm border border-white/20">
            ...
            {showHistoryMob && (
              <div className="lg:hidden absolute top-[56px] md:top-[68px] inset-x-0 z-40 bg-white/95 backdrop-blur-xl border-b border-black/10 shadow-md max-h-[350px] overflow-y-auto animate-in slide-in-from-top duration-300">
              ...
              {messages.length === 0 ? (
                <div className="max-w-2xl mx-auto pt-8 md:pt-10 text-center space-y-5">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-white shadow-re-soft rounded-2xl flex items-center justify-center mx-auto ring-1 ring-black/5 relative">
                    ...
                    <div className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-[#FEBF10] rounded-full border-2 md:border-4 border-white"></div>
                  </div>
            ...
            <div className="p-3.5 md:p-5 border-t border-black/5 bg-white/50 backdrop-blur-md">
              <form className="max-w-4xl mx-auto relative group flex gap-1.5" onSubmit={handleSend}>
                ...
                <button
                  ...
                  className="w-11 h-11 md:w-12 md:h-12 bg-re-grad-purple rounded-xl flex items-center justify-center text-white shadow-sm border border-white/20 active:scale-95 transition-all shrink-0"
                >
                  <Send size={16} />
                </button>
              </form>
          ...
          <div className="hidden lg:flex flex-col space-y-6 lg:sticky lg:top-8 h-fit">
            ...
            <div className="relative rounded-[24px] p-5 text-white shadow-sm border border-white/15 overflow-hidden group cursor-pointer bg-re-grad-orange">

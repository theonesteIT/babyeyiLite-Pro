...
const FeaturePlaceholders = ({ feature = 'Module', icon = '🚀' }) => {
  return (
    <div className="relative w-full bg-re-bg min-h-[85vh]">
        ...
        <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-8 md:pt-12 pb-10 md:pb-16">
          <div className="space-y-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
              ...
              <p className="text-[9px] font-semibold text-white/40 uppercase tracking-[0.3em]">Conduct portal</p>
            </div>
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight leading-none mb-1 mt-1 uppercase">
      ...
      {/* ── Overlapping Card ── */}
      <div className="max-w-[1600px] mx-auto px-4 md:px-12 -mt-4 md:-mt-6 pt-2 relative z-20 pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-[24px] shadow-sm border border-black/10 overflow-hidden flex flex-col items-center p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 w-full justify-center">
              <Link
                to="/"
                className="flex items-center gap-2 px-10 py-4 bg-re-grad-purple rounded-xl text-white font-semibold text-[10px] uppercase tracking-widest shadow-sm border border-white/10 active:scale-95 transition-all"
              >
                <ArrowLeft size={14} />
                Back to Dashboard
              </Link>

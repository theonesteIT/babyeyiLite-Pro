...
import PromotionDataBanner from './PromotionDataBanner';
import { StudentPromotionDataProvider } from '../context/StudentPromotionDataContext';
import '../studentPromotion.css';

export default function StudentPromotionLayout() {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);

  return (
    <StudentPromotionDataProvider>
      <div className="student-promotion-module flex h-screen bg-white font-sans overflow-hidden">
        ...
        <div className="flex flex-1 flex-col min-w-0 overflow-hidden relative">
          ...
          <PromotionDataBanner />
          <main className="flex-1 overflow-y-auto relative bg-re-bg">

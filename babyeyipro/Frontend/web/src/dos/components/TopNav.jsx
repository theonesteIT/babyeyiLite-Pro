    ...
    return (
        <header className="h-14 flex items-center justify-between px-4 md:px-6 bg-white/80 backdrop-blur-xl border-b border-black/5 sticky top-0 z-20 gap-3 font-sans">
            ...
            <div className="flex items-center gap-2 shrink-0">
                ...
                {/* Notification bell */}
                <button className="relative p-2 text-re-text-muted hover:bg-orange-50 hover:text-re-orange rounded-xl transition-all group">
                    <Bell size={17} />
                ...
                <div className="relative" ref={userRef}>
                    <button
                        ...
                        className="flex items-center gap-2.5 hover:bg-orange-50 rounded-xl px-2 py-1.5 transition-all group"
                    >
                        ...
                        <div className="hidden sm:block text-left">
                            <p className="text-xs font-black text-re-text leading-tight group-hover:text-re-orange transition-colors uppercase tracking-tight">

                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/80">Academic Grading</span>
                        </div>
                            ...
                            <table className="w-full text-left border-collapse min-w-full sm:min-w-[800px]">
                                <thead>
                                    <tr>
                                        ...
                                        {columns.map((c) => (
                                            <th
                                                key={c.slug}
                                                className="bg-re-bg/50 border-b border-r border-black/5 px-1 sm:px-4 py-4 text-[7px] sm:text-[9px] font-black uppercase tracking-widest text-re-text-muted w-16 sm:w-24 text-center"
                                                title={c.default_max_score != null ? `Max ${c.default_max_score}` : undefined}
                                            >
                                                <span className="block">{c.label}</span>
                                                {c.default_max_score != null && (
                                                    <span className="block text-[6px] font-bold opacity-50 normal-case">max {c.default_max_score}</span>
                                                )}
                                            </th>
                                        ))}
                                ...
                                <tbody className="divide-y divide-black/5">
                                    {loading ? (
                                        ...
                                        <tr>
                                            <td colSpan={4} className="p-10 text-center text-[10px] font-bold text-re-text-muted uppercase tracking-widest">
                                        ...
                                        <tr>
                                            <td colSpan={4 + columns.length} className="p-10 text-center">
                                                <p className="text-[11px] font-black text-re-text uppercase tracking-tight mb-1">No students to display</p>
                        ...
                        <div className="px-6 py-5 bg-re-bg/10 border-t border-black/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto order-1 sm:order-2">
                                <div className="flex items-center gap-3 w-full sm:w-auto">
                                    <button className="flex-1 sm:flex-none h-12 sm:h-9 px-4 bg-white border border-black/5 text-re-text font-black text-[9px] uppercase tracking-widest rounded-2xl hover:bg-re-bg transition-all flex items-center justify-center gap-2">
                                ...
                                <button
                                    type="button"
                                    onClick={handleSaveColumn}
                                    className="lg:hidden w-full h-14 bg-re-grad-orange text-white font-black text-xs uppercase tracking-[0.2em] rounded-2xl shadow-re-glow flex items-center justify-center gap-3 active:scale-95 transition-all"
                                >

  ...
  return (
    <div className="relative w-full bg-re-bg min-h-screen">
      <DisciplineOchreHero
        ...
        titleLine="Ticha"
        titleAccent="AI"
        subtitle="Empowering educators with intelligent design in a cleaner manager-style shell."
        icon={Sparkles}
      />
          ...
          <div className="hidden lg:flex flex-col space-y-6 lg:sticky lg:top-8 h-fit">
            ...
            <div className="relative rounded-[24px] p-5 text-white shadow-re-premium-purple overflow-hidden group cursor-pointer bg-re-grad-orange">
              <div className="relative z-10 flex flex-col gap-3">
                ...
                <div>
                  <h4 className="font-black text-[10px] tracking-widest uppercase opacity-90">Auto-Lesson Plan</h4>
                  <p className="text-[9px] text-white font-bold leading-snug mt-1 opacity-80 uppercase tracking-tight">Generate structured lesson plans in seconds with AI.</p>
                </div>
              </div>

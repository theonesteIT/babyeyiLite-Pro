...
export default function ShuleAvance() {
  return (
    <div className="min-h-screen bg-re-bg p-6 md:p-10 space-y-6">
      <div>
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#1E3A5F]">Accountant Portal</p>
        <h1 className="text-2xl md:text-3xl font-black text-[#1E3A5F] tracking-tight">ShuleAvance Review Desk</h1>

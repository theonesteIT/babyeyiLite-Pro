                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-medium uppercase tracking-[0.2em] text-white/80">Marks entry</span>
                        </div>
                ...
                <div className="bg-white rounded-t-[2.5rem] shadow-sm border border-black/5 overflow-hidden flex flex-col">
                    ...
                    <div className={`${!isClassSelected ? 'hidden lg:flex' : 'flex'} px-4 py-4 border-b border-black/5 flex flex-col lg:flex-row items-center justify-between gap-4 bg-re-bg/20`}>
                        ...
                        <div className={`${showMobileFilters ? 'flex' : 'hidden lg:flex'} flex-col lg:flex-row items-center gap-3 w-full lg:w-auto animate-in slide-in-from-top-2 duration-300`}>
                            ...
                            <button 
                                onClick={handleSave}
                                className="hidden lg:flex h-10 px-6 bg-re-grad-orange text-white text-nowrap     font-medium text-[9px] uppercase tracking-widest rounded-xl hover:shadow-re-glow transition-all items-center gap-2 active:scale-95"
                            >
                    ...
                    {!isClassSelected && (
                        <div className="lg:hidden p-6 bg-re-bg/20 flex flex-col items-center justify-center text-center py-12 animate-in fade-in zoom-in-95 duration-500">
                            ...
                            <p className="text-[10px] text-re-text-muted font-medium uppercase tracking-widest leading-relaxed mb-8 max-w-[240px]">Choose a class to start recording academic marks.</p>
                                ...
                                {['Senior 1A', 'Senior 2B', 'Senior 3A', 'Senior 5 Sci'].map(cls => (
                                    ...
                                    >
                                        <div className="flex flex-col items-center gap-0.5">
                                            ...
                                            <span className="text-[7px] font-medium text-re-text-muted uppercase tracking-widest opacity-40 italic">Registry</span>
                                        </div>
                    ...
                    <div className={`${!isClassSelected ? 'hidden lg:block' : 'block'} w-full overflow-hidden`}>
                        ...
                        {isClassSelected && (
                            <div className="lg:hidden px-6 py-3 bg-white border-b border-black/5 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[9px] font-medium text-re-text uppercase tracking-widest">{selectedClass} Registry</span>
                                </div>
                                <button
                        ...
                        <div className="overflow-x-auto custom-scrollbar">
                            <table className="w-full text-left border-collapse min-w-full sm:min-w-[800px]">
                                <thead>
                                    <tr>
                                        <th className="bg-re-bg/50 border-b border-r border-black/5 px-2 sm:px-4 py-4 text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-10 text-center">#</th>
                                        ...
                                        <th className="bg-re-bg/50 border-b border-r border-black/5 px-1 sm:px-4 py-4 text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-16 sm:w-20 text-center">CAT 1</th>
                                        <th className="bg-re-bg/50 border-b border-r border-black/5 px-1 sm:px-4 py-4 text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-16 sm:w-20 text-center">CAT 2</th>
                                        <th className="bg-re-bg/50 border-b border-r border-black/5 px-1 sm:px-4 py-4 text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-16 sm:w-20 text-center">Exam</th>
                                        <th className="bg-re-bg/50 border-b border-r border-black/5 px-1 sm:px-4 py-4 text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-12 sm:w-16 text-center">Total</th>
                                        <th className="bg-re-bg/50 border-b border-black/5 px-1 sm:px-4 py-4 text-[7px] sm:text-[9px] font-medium uppercase tracking-widest text-re-text-muted w-12 sm:w-16 text-center">Grade</th>
                                    </tr>
                                </thead>
                                    ...
                                    {loading ? (
                                        <tr>
                                            <td colSpan="7" className="p-12 text-center">
                                                ...
                                                <p className="text-[10px] font-medium text-re-text-muted uppercase tracking-widest">Fetching Central Records...</p>
                                            </td>
                                        </tr>
                                    ) : (
                                        ...
                                        return (
                                            <tr key={m.id} className="hover:bg-re-bg/30 transition-colors group">
                                                <td className="border-r border-b border-black/5 px-2 sm:px-4 py-4 text-center text-[10px] font-medium text-[#000435]">
                                                    {idx + 1}
                                                </td>
                                                ...
                                                <td className="border-r border-b border-black/5 px-1 sm:px-4 py-4">
                                                    <input
                                                        ...
                                                        className="w-full min-w-[50px] h-10 bg-re-bg/50 border border-transparent rounded-xl text-center font-medium text-sm text-re-text focus:bg-white focus:border-re-orange/30 focus:shadow-re-glow transition-all px-1"
                                                    />
                                                </td>
                                                <td className="border-r border-b border-black/5 px-1 sm:px-4 py-4">
                                                    <input
                                                ...
                                                <td className="border-b border-black/5 px-1 sm:px-4 py-4 text-center">
                                                    <div className={`inline-flex h-7 w-7 flex items-center justify-center px-1 py-1 rounded-full text-[9px] font-medium uppercase tracking-widest ring-1 ring-inset ${grade.color}`}>
                                                        {grade.label}
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div className="px-6 py-5 bg-re-bg/10 border-t border-black/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="flex items-center gap-4 text-[8px] font-medium text-re-text-muted uppercase tracking-[0.2em] opacity-40 italic order-2 sm:order-1">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto order-1 sm:order-2">
                                <div className="flex items-center gap-3 w-full sm:w-auto">
                                    <button
                                        ...
                                        className="flex-1 sm:flex-none h-12 sm:h-9 px-4 bg-white border border-black/5 text-re-text font-medium text-[9px] uppercase tracking-widest rounded-2xl hover:bg-re-bg transition-all flex items-center justify-center gap-2"
                                    >
                                ...
                                <button className="lg:hidden w-full h-14 bg-re-grad-orange text-white font-medium text-xs uppercase tracking-[0.2em] rounded-2xl shadow-re-glow flex items-center justify-center gap-3 active:scale-95 transition-all">

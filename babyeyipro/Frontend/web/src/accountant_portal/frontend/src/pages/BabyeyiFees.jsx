  ...
  return (
    <div className="animate-in fade-in duration-700 bg-re-bg min-h-[85vh] w-full" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <AccountantOchreHero
        ...
        titleAccent="Cards"
        subtitle="Accountant-only setup for standard tuition structures"
        icon={LayoutTemplate}
      />
            ...
            <div className="flex-1 overflow-y-auto bg-white/20">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center h-full gap-3 text-[#000435]/40 p-8 text-center">
                  ...
                  <span className="text-[9px] font-medium uppercase tracking-widest">No fee cards discovered</span>
                </div>
              ) : (
                    ...
                    <li key={r.id}>
                      ...
                      >
                        <div className="flex justify-between items-start w-full">
                          <p className={`text-[12px] font-medium uppercase tracking-tight truncate ${selectedId === r.id ? 'text-[#000435]' : 'text-[#000435]/80'}`}>
                            {r.class_name || 'Class'}
                          </p>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-5 sm:p-8 bg-white/20">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      <label className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#000435]/60 pl-1">Primary Class Name</label>
                      <input
                        className={inp}
                        placeholder="e.g. S1"
                    ...
                    <div>
                      <label className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#000435]/60 pl-1">Applicable Classes (Comma-sep)</label>
                      <input
                        className={inp}
                    ...
                    <div className="md:col-span-2 mt-4 pt-6 border-t border-black/5">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                          <label className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#000435]/60 pl-1">Paid at School Total (RWF)</label>
                          <input
                            type="number"
                            min="0"
                            step="1000"
                  ...
                  <div className="mt-6 sm:mt-8 rounded-[20px] bg-white border border-black/5 p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="bg-emerald-50 border border-emerald-100 rounded-xl px-4 sm:px-6 py-3 sm:py-4 text-right shrink-0 min-w-[200px]">
                      <p className="text-2xl sm:text-3xl font-medium text-emerald-600 tracking-tighter">

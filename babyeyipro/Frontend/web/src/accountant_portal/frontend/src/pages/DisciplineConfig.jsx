        ...
        <div className="animate-in fade-in duration-700 bg-re-bg min-h-screen">
            ...
            <div className="relative w-full min-h-[160px] overflow-hidden">
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-10 pt-10 pb-12 flex items-center gap-5 text-white">
                    <div className="hidden md:flex shrink-0 w-14 h-14 rounded-xl border border-white/10 bg-white/5 items-center justify-center backdrop-blur-xl shadow-sm relative overflow-hidden group">
                    ...
                    <div className="space-y-0.5">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-[8px] font-medium uppercase tracking-[0.2em]" style={{ color: "#FEBF10" }}>System Control Panel</p>
                        </div>
                        <h1 className="text-xl md:text-2xl font-medium text-white tracking-tighter leading-none uppercase">
                            Discipline <span style={{ color: "#FEBF10" }}>Configuration</span>
                        </h1>
                        <p className="text-[9px] md:text-[10px] font-medium text-white/50 max-w-lg leading-relaxed uppercase tracking-widest italic opacity-60">
            ...
            <div className="max-w-[1600px] mx-auto px-6 md:px-12 -mt-10 relative z-20 pb-16">
                <div className="bg-white rounded-t-3xl shadow-sm border border-black/5 overflow-hidden flex flex-col md:flex-row min-h-[550px]">

                    {/* Left Sidebar Layout */}
                    <div className="w-full md:w-56 lg:w-64 bg-re-bg/30 border-r border-black/5 flex flex-col pt-5 shrink-0 relative">
                        <div className="px-5 mb-4">
                            <h3 className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#000435]/50 flex items-center gap-1.5">
                        ...
                        <div className="flex flex-col space-y-0.5 px-3 mb-6 font-sans">
                            <button 
                                ...
                                className={`flex items-center gap-3 px-4 py-2.5 rounded-xl font-medium text-[10px] uppercase tracking-widest transition-all ${
                    ...
                    <div className="flex-1 p-6 md:p-10">
                        {isLoading ? (
                            <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
                                ...
                                <p className="text-[8px] font-medium text-re-text-muted uppercase tracking-widest">Deciphering configurations...</p>
                            </div>
                        ) : (
                            <form onSubmit={handleSave} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500 max-w-2xl">
                                ...
                                {error && (
                                    <div className="flex items-center gap-2.5 p-3.5 bg-red-50 border border-red-100 rounded-xl text-red-600">
                                        <AlertCircle size={16} />
                                        <p className="text-[10px] font-medium uppercase tracking-wide">{error}</p>
                                    </div>
                                )}
                                ...
                                {success && (
                                    <div className="flex items-center gap-2.5 p-3.5 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-600">
                                        <CheckCircle size={16} />
                                        <p className="text-[10px] font-medium uppercase tracking-wide">{success}</p>
                                    </div>
                                )}
                                {activeTab === 'conduct' && (
                                    <div className="space-y-5">
                                        <div>
                                            <h2 className="text-lg font-medium text-[#000435] uppercase tracking-tighter">Conduct Scale</h2>
                                            <p className="text-[9px] font-medium text-re-text-muted uppercase tracking-widest mt-0.5">Manage disciplinary points and starting marks</p>
                                        </div>

                                        <div className="grid md:grid-cols-2 gap-5">
                                            {/* Max Scale Cap Input */}
                                            <div className="space-y-2">
                                                <label className="text-[9px] font-medium text-[#000435]/60 uppercase tracking-widest ml-1">Maximum Scale Cap</label>
                                                <div className="flex items-center bg-white border border-black/5 rounded-xl overflow-hidden shadow-inner focus-within:ring-2 focus-within:ring-[#FEBF10]/30 transition-all">
                                                    ...
                                                    <input 
                                                        type="number" 
                                                        className="flex-1 h-12 bg-transparent outline-none text-xs font-medium text-re-text py-1"
                                                        value={settings.total_marks}
                                                        onChange={e => setSettings({...settings, total_marks: e.target.value})}
                                                    />
                                                </div>
                                                <p className="text-[9px] font-medium text-re-text-muted uppercase tracking-wider ml-1 opacity-60">Baseline total conduct points</p>
                                            </div>

                                            {/* Entry Starting Marks Input */}
                                            <div className="space-y-2">
                                                <label className="text-[9px] font-medium text-[#000435]/60 uppercase tracking-widest ml-1">Entry Starting Marks</label>
                                                <div className="flex items-center bg-white border border-black/5 rounded-xl overflow-hidden shadow-inner focus-within:ring-2 focus-within:ring-[#FEBF10]/30 transition-all">
                                                ...
                                                <p className="text-[9px] font-medium text-re-text-muted uppercase tracking-wider ml-1 opacity-60">Marks assigned at term commencement</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {activeTab === 'permissions' && (
                                    <div className="space-y-5">
                                        <div>
                                            <h2 className="text-lg font-medium text-[#000435] uppercase tracking-tighter">Student Permissions</h2>
                                            <p className="text-[9px] font-medium text-re-text-muted uppercase tracking-widest mt-0.5">Manage out-pass and excusal protocols</p>
                                        </div>
                                        ...
                                        <div className="bg-re-bg/50 p-6 rounded-[2rem] border border-black/5 space-y-4">
                                            <div className="flex items-center justify-between group p-5 bg-white rounded-[1.5rem] shadow-sm border border-black/5">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h3 className="text-[10px] font-medium text-[#000435] uppercase tracking-tight">Permissions &amp; Excusals</h3>
                                                        <p className="text-[8px] font-medium text-re-text-muted uppercase tracking-widest">Enable digital out-pass issuance</p>
                                                    </div>
                                                </div>
                                                <button 
                                                    type="button"
                                ...
                                {activeTab === 'registry' && (
                                    <div className="space-y-6">
                                        <div>
                                            <h2 className="text-lg md:text-xl font-medium text-[#000435] uppercase tracking-tighter">Incident Registry</h2>
                                            <p className="text-[10px] font-medium text-re-text-muted uppercase tracking-widest mt-1">Manage disciplinary logging and archival</p>
                                        </div>

                                        <div className="grid md:grid-cols-2 gap-5">
                                            <div className="space-y-2">
                                                <label className="text-[9px] font-medium text-[#000435]/60 uppercase tracking-widest ml-1">Registry Mode</label>
                                                <div className="flex items-center bg-white border border-black/5 rounded-xl overflow-hidden shadow-inner focus-within:ring-2 focus-within:ring-[#FEBF10]/30 transition-all">
                                                    ...
                                                    <select 
                                                        className="flex-1 h-12 bg-transparent outline-none text-[9px] font-medium text-re-text uppercase tracking-widest cursor-pointer pr-4"
                                ...
                                <div className="pt-8 border-t border-black/5 flex items-center justify-end">
                                    <button 
                                        type="submit"
                                        disabled={isSaving}
                                        className="h-12 px-8 rounded-xl text-white font-medium text-[10px] uppercase tracking-[0.2em] shadow-sm active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-50 group overflow-hidden relative"

    ...
    return (
      ...
      >
        {createElement(ItemIcon, {
          size: 18,
          strokeWidth: 1.75,
          className: 'text-white/45 group-hover:text-white/85 shrink-0 transition-colors',
        })}
...
export default function SchoolBudgetSidebar({ activePage, onSelectPage, onClose, periodLabel }) {
  return (
    <div
    ...
    >
      <div className="p-4 pb-3 shrink-0 border-b border-white/[0.06]">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white shadow-sm overflow-hidden">
            <img src={babyeyiIcon} alt="Babyeyi icon" className="h-10 w-10 object-contain" />
          </div>
      ...
      <nav
        ...
        aria-label="School budget navigation"
      >
        {SCHOOL_BUDGET_NAV.map((section) => (

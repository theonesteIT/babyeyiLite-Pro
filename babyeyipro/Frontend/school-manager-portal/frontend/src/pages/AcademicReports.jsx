            ...
            <div className="relative w-full min-h-[280px] overflow-hidden">
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24 flex items-center gap-8">
                    ...
                    <div className="space-y-1">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-white tracking-tighter leading-none mb-2 mt-2 uppercase">Academic <span style={{ color: "#FEBF10" }}>Reports</span></h1>
                        <p className="text-[8px] sm:text-[10px] md:text-xs font-bold text-white/40 max-w-lg leading-relaxed uppercase tracking-widest italic opacity-60">Scholastic Performance & Actionable Data Analytics</p>
                    </div>
                </div>
            </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-black/5">
                                {loading ? (
                                    ...
                                    <tr
                                        key={cls.id}
                                        onClick={() => navigate(`/reports/academic/class/${encodeURIComponent(cls.class)}`)}
                                    ...
                                    >
                                        ...
                                        <td className="px-4 sm:px-8 py-3 sm:py-5 text-right">
                                            <button
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    navigate(`/reports/academic/class/${encodeURIComponent(cls.class)}`);
                                                }}

...
export const teacherInnerSelectCls = `${TEACHER_SELECT_CHEVRON} pr-10 lg:pr-9 w-full outline-none transition-all text-re-text font-black uppercase border border-black/[0.07] bg-re-bg shadow-[inset_0_2px_8px_rgba(15,23,42,0.11),inset_0_-1px_0_rgba(255,255,255,0.55)] focus:border-[#1E3A5F]/30 focus:bg-white focus:ring-2 focus:ring-[#1E3A5F]/12 h-10 lg:h-8 pl-9 lg:pl-7 rounded-xl lg:rounded-lg text-[10px] lg:text-[8px] tracking-widest lg:tracking-wide`;

/** Search field — same inset “well” as wizard-style forms */
export const teacherInnerSearchCls =
  'w-full outline-none transition-all text-re-text font-bold border border-black/[0.07] bg-re-bg shadow-[inset_0_2px_8px_rgba(15,23,42,0.11),inset_0_-1px_0_rgba(255,255,255,0.55)] focus:border-[#1E3A5F]/30 focus:bg-white focus:ring-2 focus:ring-[#1E3A5F]/12 h-10 lg:h-8 pl-10 lg:pl-8 pr-3 rounded-xl lg:rounded-lg text-[10px] lg:text-[8px]';

/** Gradebook score cell — recessed numeric well */
export const teacherInnerScoreCls =
  'w-full min-h-[40px] h-10 lg:h-9 min-w-[3rem] text-center tabular-nums outline-none text-re-text text-[11px] font-black tracking-tight rounded-lg border border-black/[0.07] bg-white/95 shadow-[inset_0_2px_10px_rgba(15,23,42,0.11),inset_0_-1px_0_rgba(255,255,255,0.65)] focus:border-[#1E3A5F]/28 focus:ring-2 focus:ring-[#1E3A5F]/12 focus:bg-white placeholder:text-re-text-muted/35 transition-all';

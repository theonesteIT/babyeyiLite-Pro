...
export const REQN_STATUSES = {
  pending: { label: 'Pending Approval', color: 'bg-amber-50 text-amber-700', dot: '🟡' },
  approved: { label: 'Approved', color: 'bg-emerald-50 text-emerald-700', dot: '🟢' },
  rejected: { label: 'Rejected', color: 'bg-red-50 text-red-700', dot: '🔴' },
};

export const PO_STATUSES = {
  draft: { label: 'Draft', color: 'bg-slate-100 text-slate-700', dot: '⚫' },
  issued: { label: 'Issued', color: 'bg-emerald-50 text-emerald-700', dot: '🟢' },
};

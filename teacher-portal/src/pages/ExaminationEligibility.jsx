...
/** Match first/last name, UID, or student code (partial, case-insensitive). */
...
export default function ExaminationEligibility() {
    ...
    const filteredStudents = useMemo(
        () => sortedStudents.filter((row) => studentMatchesSearch(row, studentSearch)),
                ...
                <div className="relative mx-auto max-w-3xl">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <h1 className="mt-1 text-2xl font-black tracking-tight text-white">Examination list</h1>
                            <p className="mt-2 text-sm font-medium text-white/70 leading-relaxed">
                                Published by finance — see who may sit exams for this class (fees + overrides).
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <label className="block">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="off"
                                    className="w-full rounded-xl border border-black/10 bg-white py-2.5 pl-10 pr-3 text-sm font-semibold text-[#000435] placeholder:text-slate-400 focus:ring-2 focus:ring-[#f59e0b]/40"
                                />
                            </div>
                            {studentSearch.trim() ? (
                                <p className="mt-1.5 text-[11px] font-medium text-slate-500">
                                    Showing {filteredStudents.length} of {sortedStudents.length} learners
                                </p>
                            ) : null}
                        </label>

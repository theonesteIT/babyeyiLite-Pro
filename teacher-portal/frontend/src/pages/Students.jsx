            ...
            <div className="fixed inset-y-0 right-0 z-[110] w-full md:w-[420px] bg-white shadow-[-20px_0_60px_-15px_rgba(0,0,0,0.1)] flex flex-col animate-in slide-in-from-right duration-500 ease-out">
                ...
                <div className="flex-1 overflow-y-auto px-8 py-8 space-y-8 custom-scrollbar">
                    ...
                    <div className={`flex items-center gap-3 px-4 py-3 rounded-2xl border ${student.status === 'On leave' ? 'bg-blue-50 border-blue-100/50' : 'bg-re-orange/5 border-re-orange/10'}`}>
                        ...
                        <div>
                            <p className="text-[10px] font-black text-re-text uppercase tracking-widest">{student.status}</p>
                            <p className="text-[9px] text-re-text/40 font-bold uppercase tracking-tight leading-none mt-0.5">Registry: {student.grade}{student.stream ? ` · ${student.stream}` : ''}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-re-bg rounded-3xl p-5 border border-black/5 shadow-inner relative overflow-hidden group">
                            ...
                            <p className="text-[8px] text-re-text-muted uppercase tracking-[0.2em] font-black mb-1 relative z-10 opacity-60">Avg marks</p>
                            <div className="flex items-baseline gap-1 relative z-10">
                                <span className="text-2xl font-black text-re-text tracking-tighter">
                        ...
                        <div className="bg-re-bg rounded-3xl p-5 border border-black/5 shadow-inner relative overflow-hidden group text-right">
                            ...
                            <p className="text-[8px] text-re-text-muted uppercase tracking-[0.2em] font-black mb-1 relative z-10 opacity-60">Roll-call presence (120d)</p>
        ...
        <div className="animate-in fade-in duration-700 bg-re-bg min-h-screen">
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-6 md:px-12 pt-16 pb-24">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[10px] font-black text-white/70 uppercase tracking-[0.3em]">Institutional Repository</p>
                        </div>
                        ...
                        <p className="text-[8px] sm:text-[10px] md:text-sm font-bold text-white/55 max-w-lg leading-relaxed uppercase tracking-widest italic">Professional Academic & Behavioral Analytics View</p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-[1600px] mx-auto px-6 md:px-12 -mt-24 relative z-20 pb-20">
                <div className="bg-white rounded-t-[32px] shadow-2xl border border-black/5 overflow-hidden flex flex-col">
                    ...
                    <div className={`${!isClassSelected ? 'hidden md:flex' : 'flex'} px-4 py-4 lg:px-3 lg:py-2 border-b border-black/5 flex-col lg:flex-row lg:flex-nowrap lg:items-center lg:justify-start gap-4 lg:gap-2 bg-re-bg/20`}>
                        <div className="flex items-center gap-3 lg:gap-2 w-full lg:w-auto lg:shrink-0">
                            <button
                                onClick={() => setShowMobileFilters(!showMobileFilters)}
                                className="md:hidden w-full flex justify-between items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all"
                            >
                                <div className="flex items-center gap-2">
                        ...
                        <div className={`${showMobileFilters ? 'flex' : 'hidden md:flex'} flex-col lg:flex-row lg:flex-nowrap lg:items-center gap-3 lg:gap-2 w-full lg:flex-1 lg:min-w-0 animate-in slide-in-from-top-2 duration-300`}>
                            <div className="relative w-full lg:flex-1 lg:min-w-[7rem] lg:max-w-[12rem] group">
                                <Search size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-re-text-muted/50 group-focus-within:text-re-orange transition-colors md:hidden z-[1] pointer-events-none" />
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 lg:gap-1.5 w-full lg:w-auto lg:items-center lg:shrink-0">
                                <button
                                    ...
                                    className="h-10 lg:h-8 px-3 bg-white border border-black/[0.07] rounded-xl lg:rounded-lg flex items-center justify-center gap-2 text-re-text font-black text-[9px] lg:text-[7px] uppercase tracking-widest hover:bg-re-bg transition-all shadow-sm whitespace-nowrap"
                                >
                                ...
                                <button
                                    ...
                                    className="h-10 lg:h-8 px-3 bg-re-grad-orange text-white rounded-xl lg:rounded-lg font-black text-[9px] lg:text-[7px] uppercase tracking-tight shadow-re-glow hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
                                >
                                    <Activity size={12} />
                                    Conduct Marks
                                </button>
                    ...
                    {showClassFilter && (
                        <div className={`${!isClassSelected ? 'hidden md:flex' : 'flex'} px-4 lg:px-3 py-3 bg-re-bg/20 border-b border-black/5 items-center overflow-x-auto gap-2 custom-scrollbar animate-in slide-in-from-top-2 fade-in duration-300`}>
                            ...
                            <button
                                ...
                                className={`flex items-center justify-center gap-1.5 shrink-0 h-8 lg:h-7 px-3 lg:px-4 rounded-xl lg:rounded-lg border font-black text-[8px] lg:text-[7px] uppercase tracking-widest transition-all whitespace-nowrap ${selectedClass === 'View All'
                            ...
                            {classes.map((cls, idx) => (
                                <button
                                    ...
                                    className={`flex items-center justify-center gap-1.5 shrink-0 h-8 lg:h-7 px-3 lg:px-4 rounded-xl lg:rounded-lg border font-black text-[8px] lg:text-[7px] uppercase tracking-widest transition-all whitespace-nowrap ${idx > 1 ? 'hidden md:flex' : ''} ${selectedClass === cls
                                        ? 'bg-re-orange border-re-orange text-white shadow-re-glow hover:scale-105'
                                        : 'bg-white border-black/5 text-re-text-muted hover:bg-re-bg hover:text-re-text'
                                        }`}
                                >
                                        ...
                                        {filteredStudents.map((s, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="hidden md:table-cell px-8 py-5">
                                                        <div className={`inline-flex px-3 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest ring-1 ring-inset ${s.status === 'On leave' ? 'bg-blue-50 text-blue-600 ring-blue-500/20' :
